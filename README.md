...
* [:octocat: p](https://github.com/qw3rtman/p) - :star: 624 :fork_and_knife: 31 - Dead simple interactive Python version management.
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - :star: 5604 :fork_and_knife: 450 - Simple Python version management.
* [:earth_americas: PyRun](https://www.egenix.com/products/python/PyRun/) - A one-file, no-installation-needed version of Python.
* [:octocat: Vex](https://github.com/sashahart/vex) - :star: 306 :fork_and_knife: 18 - Run a command in the named virtualenv.
...
* [:octocat: conda](https://github.com/conda/conda/) - :star: 929 :fork_and_knife: 315 - Cross-platform, Python-agnostic binary package manager.
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - :star: 799 :fork_and_knife: 168 - Next generation Python Package Repository (PyPI).
...
* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - :star: 2159 :fork_and_knife: 522 - Converts Python programs into stand-alone executables (cross-platform).
...
* [:octocat: PlatformIO](https://github.com/ivankravets/platformio) - :star: 1331 :fork_and_knife: 199 - A console tool to build code with different development platforms.
* [:octocat: PyBuilder](https://github.com/pybuilder/pybuilder) - :star: 752 :fork_and_knife: 154 - A continuous build tool written in pure Python.
...
* [:octocat: IPython](https://github.com/ipython/ipython) - :star: 10393 :fork_and_knife: 3065 - A rich toolkit to help you make the most out of using Python interactively.
* [:earth_americas: bpython](http://bpython-interpreter.org) – A fancy interface to the Python interpreter.
* [:octocat: ptpython](https://github.com/jonathanslenders/ptpython) - :star: 1655 :fork_and_knife: 66 - Advanced Python REPL built on top of the [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - :star: 663 :fork_and_knife: 88 - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html).
...
* [:octocat: python-magic](https://github.com/ahupp/python-magic) - :star: 730 :fork_and_knife: 113 - A Python interface to the libmagic file type identification library.
* [:octocat: Unipath](https://github.com/mikeorr/Unipath) - :star: 390 :fork_and_knife: 32 - An object-oriented approach to file/directory operations.
* [:octocat: watchdog](https://github.com/gorakhargosh/watchdog) - :star: 2267 :fork_and_knife: 303 - API and shell utilities to monitor file system events.

## Date and Time

*Libraries for working with dates and times.*

* [:octocat: arrow](https://github.com/crsmithdev/arrow) - :star: 3374 :fork_and_knife: 289 - Better dates & times for Python.
...
* [:octocat: moment](https://github.com/zachwill/moment) - :star: 337 :fork_and_knife: 20 - A Python library for dealing with dates/times. Inspired by [Moment.js](http://momentjs.com/).
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 611 :fork_and_knife: 88 - Python 2/3 compatible character encoding detector.
    ...
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 1554 :fork_and_knife: 54 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 2752 :fork_and_knife: 289 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 253 :fork_and_knife: 50 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 52 :fork_and_knife: 7 - Spacing texts for CJK and alphanumerics.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 179 :fork_and_knife: 20 - An implementation of figlet written in Python.
    * [:octocat: shortuuid](https://github.com/stochastic-technologies/shortuuid) - :star: 663 :fork_and_knife: 51 - A generator library for concise, unambiguous and URL-safe UUIDs.
    ...
    * [:octocat: xpinyin](https://github.com/lxneng/xpinyin) - :star: 374 :fork_and_knife: 102 - A library to translate Chinese hanzi (漢字) to pinyin (拼音).
* Slugify
...
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 1330 :fork_and_knife: 174 - Parsing, formatting, storing and validating international phone numbers.
    ...
    * [:octocat: python-nameparser](https://github.com/derek73/python-nameparser) - :star: 167 :fork_and_knife: 26 - Parsing human names into their individual components.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 412 :fork_and_knife: 91 - Browser user agent parser.
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - :star: 2136 :fork_and_knife: 310 - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
    ...
    * [:octocat: python-docx](https://github.com/python-openxml/python-docx) - :star: 643 :fork_and_knife: 252 - Reads, queries and modifies Microsoft Word 2007/2008 docx files.
    * [:octocat: unoconv](https://github.com/dagwieers/unoconv) - :star: 817 :fork_and_knife: 232 - Convert between any document format supported by LibreOffice/OpenOffice.
    ...
    * [:octocat: xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - :star: 559 :fork_and_knife: 193 - Writing and reading data and formatting information from Excel files.
* PDF
    * [:octocat: PDFMiner](https://github.com/euske/pdfminer) - :star: 1761 :fork_and_knife: 485 - A tool for extracting information from PDF documents.
    * [:octocat: PyPDF2](https://github.com/mstamy2/PyPDF2) - :star: 1113 :fork_and_knife: 350 - A library capable of splitting, merging and transforming PDF pages.
    * [:earth_americas: ReportLab](http://www.reportlab.com/opensource/) - Allowing Rapid creation of rich PDF documents.
* Markdown
    * [:octocat: Mistune](https://github.com/lepture/mistune) - :star: 761 :fork_and_knife: 75 - Fastest and full featured pure Python parsers of Markdown.
    * [:octocat: Python-Markdown](https://github.com/waylan/Python-Markdown) - :star: 952 :fork_and_knife: 269 - A Python implementation of John Gruber’s Markdown.
* YAML
    * [:earth_americas: PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [:octocat: csvkit](https://github.com/onyxfish/csvkit) - :star: 2361 :fork_and_knife: 340 - Utilities for converting to and working with CSV.
* Archive
...
* [:octocat: jieba](https://github.com/fxsjy/jieba) - :star: 6405 :fork_and_knife: 2007 - Chinese Words Segmentation Utilities.
* [:octocat: langid.py](https://github.com/saffsd/langid.py) - :star: 644 :fork_and_knife: 119 - Stand-alone language identification system.
* [:earth_americas: Pattern](http://www.clips.ua.ac.be/pattern) - A web mining module for the Python.
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - :star: 1543 :fork_and_knife: 447 - A library for processing Chinese text.
...
* Command-line Application Development
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - :star: 2091 :fork_and_knife: 197 - Python Command-line Application Tools.
    ...
    * [:octocat: Gooey](https://github.com/chriskiehl/Gooey) - :star: 4303 :fork_and_knife: 226 - Turn command line programs into a full GUI application with one line
    ...
    * [:octocat: python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) - :star: 3068 :fork_and_knife: 182 - A Library for building powerful interactive command lines.
* Productivity Tools
    * [:octocat: bashplotlib](https://github.com/glamp/bashplotlib) - :star: 639 :fork_and_knife: 50 - Making basic plots in the terminal. It's a quick way to visualize data without GUI.
    * [:octocat: caniusepython3](https://github.com/brettcannon/caniusepython3) - :star: 251 :fork_and_knife: 32 - Determine what projects are blocking you from porting to Python 3.
    * [:octocat: cookiecutter](https://github.com/audreyr/cookiecutter) - :star: 3994 :fork_and_knife: 478 - A command-line utility that creates projects from cookiecutters (project templates). E.g. Python package projects, jQuery plugin projects.
    ...
    * [:octocat: httpie](https://github.com/jakubroztocil/httpie) - :star: 26664 :fork_and_knife: 1702 - A command line HTTP client, a user-friendly cURL replacement.
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 3054 :fork_and_knife: 186 - Select files out of bash output.
    * [:octocat: percol](https://github.com/mooz/percol) - :star: 2172 :fork_and_knife: 99 - Adds flavor of interactive selection to the traditional pipe concept on UNIX.
    * [:earth_americas: RainbowStream](http://www.rainbowstream.org/) - Smart and nice Twitter client on terminal.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - :star: 22447 :fork_and_knife: 1078 - Correcting your previous console command.

## Downloader

*Libraries for downloading.*

* [:octocat: coursera](https://github.com/coursera-dl/coursera) - :star: 4521 :fork_and_knife: 1267 - Script for downloading Coursera.org videos and naming them.
* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - :star: 2020 :fork_and_knife: 616 - A command line tool for managing Amazon S3 and CloudFront.
* [:octocat: s4cmd](https://github.com/bloomreach/s4cmd) - :star: 497 :fork_and_knife: 100 - Super S3 command line tool, good for higher performance.
* [:octocat: subliminal](https://github.com/Diaoul/subliminal) - :star: 1081 :fork_and_knife: 210 - Library and command line tool to search and download subtitles.
...
* [:octocat: nude.py](https://github.com/hhatto/nude.py) - :star: 407 :fork_and_knife: 63 - Nudity detection.
* [:earth_americas: pyBarcode](https://pythonhosted.org/pyBarcode/) - Create barcodes in Python without needing PIL.
* [:octocat: pygram](https://github.com/ajkumar25/pygram) - :star: 47 :fork_and_knife: 9 - Instagram-like image filters.
* [:octocat: python-qrcode](https://github.com/lincolnloop/python-qrcode) - :star: 971 :fork_and_knife: 221 - A pure Python QR Code generator.
* [:octocat: Quads](https://github.com/fogleman/Quads) - :star: 585 :fork_and_knife: 53 - Computer art based on quadtrees.
* [:earth_americas: scikit-image](http://scikit-image.org/) - A Python library for (scientific) image processing.
* [:octocat: thumbor](https://github.com/thumbor/thumbor) - :star: 4222 :fork_and_knife: 433 - A smart imaging service. It enables on-demand crop, re-sizing and flipping of images.
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 619 :fork_and_knife: 137 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.

## OCR

*Libraries for Optical Character Recognition.*

* [:octocat: pyocr](https://github.com/jflesch/pyocr) - :star: 373 :fork_and_knife: 73 - A wrapper for Tesseract and Cuneiform.
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - :star: 552 :fork_and_knife: 113 - Another wrapper for Google Tesseract OCR.
...
* [:octocat: audioread](https://github.com/sampsyo/audioread) - :star: 110 :fork_and_knife: 39 - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding.
* [:earth_americas: beets](http://beets.radbox.org/) - A music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - :star: 2641 :fork_and_knife: 482 - Audio fingerprinting and recognition.
...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 214 :fork_and_knife: 88 - A module for parsing m3u8 file.
* [:earth_americas: mutagen](https://bitbucket.org/lazka/mutagen) - A Python module to handle audio metadata.
* [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 1558 :fork_and_knife: 167 - Manipulate audio with a simple and easy high level interface.
* [:octocat: pyechonest](https://github.com/echonest/pyechonest) - :star: 581 :fork_and_knife: 1121 - Python client for the [Echo Nest](http://developer.echonest.com/docs/) API.
...
* [:octocat: scikit-video](https://github.com/aizvorski/scikit-video) - :star: 45 :fork_and_knife: 6 - Video processing routines for SciPy.
...
* [:octocat: GeoIP](https://github.com/maxmind/geoip-api-python) - :star: 144 :fork_and_knife: 35 - Python API for MaxMind GeoIP Legacy Database.
* [:octocat: geojson](https://github.com/frewsxcv/python-geojson) - :star: 228 :fork_and_knife: 33 - Python bindings and utilities for GeoJSON.
* [:octocat: geopy](https://github.com/geopy/geopy) - :star: 1248 :fork_and_knife: 302 - Python Geocoding Toolbox.
* [:octocat: pygeoip](https://github.com/appliedsec/pygeoip) - :star: 436 :fork_and_knife: 92 - Pure Python GeoIP API.
* [:octocat: django-countries](https://github.com/SmileyChris/django-countries) - :star: 293 :fork_and_knife: 93 - A Django app that provides country choices for use with forms, flag icons static files, and a country field for models.
...
* [:octocat: grequests](https://github.com/kennethreitz/grequests) - :star: 1664 :fork_and_knife: 195 - requests + gevent for asynchronous HTTP requests.
...
* [:octocat: urllib3](https://github.com/shazow/urllib3) - :star: 1147 :fork_and_knife: 387 - A HTTP library with thread-safe connection pooling, file post support, sanity friendly.
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - :star: 1274 :fork_and_knife: 91 - A tiny, document-oriented database.
...
* Relational Databases
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 2512 :fork_and_knife: 144 - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL.
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - :star: 435 :fork_and_knife: 65 - mysql-python fork supporting Python 3.
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - :star: 2092 :fork_and_knife: 480 - Pure Python MySQL driver compatible to mysql-python.
...
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - :star: 587 :fork_and_knife: 270 - Python driver for Cassandra.
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - :star: 4530 :fork_and_knife: 1145 - The Redis Python Client.
...
* Relational Databases
    ...
    * [:earth_americas: SQLAlchemy](http://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
        * [:octocat: awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) - :star: 1216 :fork_and_knife: 81
    * [:octocat: peewee](https://github.com/coleifer/peewee) - :star: 3250 :fork_and_knife: 610 - A small, expressive ORM.
    * [:earth_americas: PonyORM](http://ponyorm.com) - ORM that provides a generator-oriented interface to SQL.
* NoSQL Databases
    * [:octocat: django-mongodb-engine](https://github.com/django-nonrel/mongodb-engine) - :star: 673 :fork_and_knife: 193 - Django MongoDB Backend.
    * [:octocat: PynamoDB](https://github.com/jlafon/PynamoDB) - :star: 264 :fork_and_knife: 73 - A Pythonic interface for [Amazon DynamoDB](https://aws.amazon.com/dynamodb/).
    * [:octocat: flywheel](https://github.com/mathcamp/flywheel) - :star: 74 :fork_and_knife: 12 - Object mapper for Amazon DynamoDB.
    ...
    * [:octocat: redisco](https://github.com/kiddouk/redisco) - :star: 329 :fork_and_knife: 61 - A Python Library for Simple Models and Containers Persisted in Redis.
* Others
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 4449 :fork_and_knife: 787
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 3089 :fork_and_knife: 492
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/ITCase/awesome-pyramid) - :star: 295 :fork_and_knife: 34
...
* [:octocat: django-guardian](https://github.com/lukaszb/django-guardian) - :star: 1253 :fork_and_knife: 332 - Implementation of per object permissions for Django 1.2+
* [:octocat: django-rules](https://github.com/dfunckt/django-rules) - :star: 345 :fork_and_knife: 24 - A tiny but powerful app providing object-level permissions to Django, without requiring a database.
...
* [:octocat: Cartridge](https://github.com/stephenmcd/cartridge) - :star: 489 :fork_and_knife: 236 - A shopping cart app built using the Mezzanine.
* [:earth_americas: shoop](https://www.shoop.io/) - An open source E-Commerce platform based on Django.
* [:octocat: alipay](https://github.com/lxneng/alipay) - :star: 171 :fork_and_knife: 53 - Unofficial Alipay API for Python.
* [:octocat: merchant](https://github.com/agiliq/merchant) - :star: 843 :fork_and_knife: 149 - A Django app to accept payments from various payment processors.
...
* [:octocat: eve](https://github.com/nicolaiarocci/eve) - :star: 3554 :fork_and_knife: 475 - REST API framework powered by Flask, MongoDB and good intentions.
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - :star: 2625 :fork_and_knife: 960 - Authentication app for Django that "just works."
    * [:octocat: django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) - :star: 856 :fork_and_knife: 261 - OAuth2 goodies for the Djangonauts.
    ...
    * [:octocat: Flask-OAuthlib](https://github.com/lepture/flask-oauthlib) - :star: 805 :fork_and_knife: 233 - OAuth 1.0/a, 2.0 implementation of client and provider for Flask.
    * [:octocat: OAuthLib](https://github.com/idan/oauthlib) - :star: 1246 :fork_and_knife: 270 - A generic and thorough implementation of the OAuth request-signing logic.
    * [:octocat: python-oauth2](https://github.com/simplegeo/python-oauth2) - :star: 2502 :fork_and_knife: 973 - A fully tested, abstract interface to creating OAuth clients and servers.
    * [:octocat: python-social-auth](https://github.com/omab/python-social-auth) - :star: 2522 :fork_and_knife: 1104 - An easy-to-setup social authentication mechanism.
    * [:octocat: rauth](https://github.com/litl/rauth) - :star: 1451 :fork_and_knife: 149 - A Python library for OAuth 1.0/a, 2.0, and Ofly.
...
* Others
    ...
    * [:octocat: PyJWT](https://github.com/progrium/pyjwt) - :star: 970 :fork_and_knife: 142 - Implementation of the JSON Web Token draft 01.
...
* [:octocat: Jinja2](https://github.com/mitsuhiko/jinja2) - :star: 3667 :fork_and_knife: 726 - A modern and designer friendly templating language.
...
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 1035 :fork_and_knife: 110 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 450 :fork_and_knife: 39 - Mr. Queue - A distributed worker task queue in Python using Redis & gevent.
...
* [:octocat: django-haystack](https://github.com/toastdriven/django-haystack) - :star: 2064 :fork_and_knife: 933 - Modular search for Django.
...
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - :star: 984 :fork_and_knife: 235 - The official high-level Python client for Elasticsearch.
...
* [:octocat: django-activity-stream](https://github.com/justquick/django-activity-stream) - :star: 1094 :fork_and_knife: 327 - Generate generic activity streams from the actions on your site.
* [:octocat: Feedly](https://github.com/tschellenbach/Feedly) - :star: 2520 :fork_and_knife: 309 - A library to build newsfeed and notification systems using Cassandra and Redis.

## Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 1757 :fork_and_knife: 492 - Compresses linked and inline JavaScript or CSS into a single cached file.
...
* [:octocat: jinja-assets-compressor](https://github.com/jaysonsantos/jinja-assets-compressor) - :star: 56 :fork_and_knife: 9 - A Jinja extension to compile and compress your assets.
...
* [:octocat: django-cache-machine](https://github.com/jbalogh/django-cache-machine) - :star: 647 :fork_and_knife: 129 - Automatic caching and invalidation for Django models.
* [:octocat: django-cacheops](https://github.com/Suor/django-cacheops) - :star: 594 :fork_and_knife: 98 - A slick ORM cache with automatic granular event-driven invalidation.
...
* [:octocat: pylibmc](https://github.com/lericson/pylibmc) - :star: 331 :fork_and_knife: 109 - A Python wrapper around the [libmemcached](http://libmemcached.org/libMemcached.html) interface.
...
* [:octocat: flanker](https://github.com/mailgun/flanker) - :star: 980 :fork_and_knife: 99 - A email address and Mime parsing library.
...
* [:octocat: inbox](https://github.com/inboxapp/inbox) - :star: 3161 :fork_and_knife: 314 - The open source email toolkit.
...
* [:octocat: modoboa](https://github.com/tonioo/modoboa) - :star: 617 :fork_and_knife: 92 - A mail hosting and management platform including a modern and simplified Web UI.
* [:earth_americas: pyzmail](http://www.magiksys.net/pyzmail/) - Compose, send and parse emails.
* [:octocat: Talon](https://github.com/mailgun/talon) - :star: 598 :fork_and_knife: 91 - Mailgun library to extract message quotations and signatures.
...
* [:octocat: furl](https://github.com/gruns/furl) - :star: 955 :fork_and_knife: 62 - A small Python library that makes manipulating URLs simple.
...
* [:octocat: short_url](https://github.com/Alir3z4/python-short_url) - :star: 61 :fork_and_knife: 12 - Python implementation for generating Tiny URL and bit.ly-like URLs.
* [:octocat: webargs](https://github.com/sloria/webargs) - :star: 371 :fork_and_knife: 50 - A friendly library for parsing HTTP request arguments, with built-in support for popular web frameworks, including Flask, Django, Bottle, Tornado, and Pyramid.
...
* [:octocat: html5lib](https://github.com/html5lib/html5lib-python) - :star: 528 :fork_and_knife: 115 - A standards-compliant library for parsing and serializing HTML documents and fragments.
...
* [:octocat: pyquery](https://github.com/gawel/pyquery) - :star: 1049 :fork_and_knife: 97 - A jQuery-like library for parsing HTML.
...
* [:octocat: xhtml2pdf](https://github.com/chrisglass/xhtml2pdf) - :star: 1159 :fork_and_knife: 420 - HTML/CSS to PDF converter.
* [:octocat: xmltodict](https://github.com/martinblech/xmltodict) - :star: 2172 :fork_and_knife: 212 - Working with XML feel like you are working with JSON.
...
* [:octocat: cola](https://github.com/chineking/cola) - :star: 1005 :fork_and_knife: 474 - A distributed crawling framework.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 1436 :fork_and_knife: 76 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 4573 :fork_and_knife: 679 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 7686 :fork_and_knife: 1993 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 2586 :fork_and_knife: 181 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 297 :fork_and_knife: 62 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 317 :fork_and_knife: 20 - Web Content Retrieval for Humans.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 3644 :fork_and_knife: 533 - News extraction, article extraction and content curation in Python.
* [:octocat: opengraph](https://github.com/erikriver/opengraph) - :star: 77 :fork_and_knife: 45 - A Python module to parse the Open Graph Protocol
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 2158 :fork_and_knife: 518 - HTML Content/Article Extractor.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1039 :fork_and_knife: 203 - Fast Python port of arc90's readability tool.
* [:octocat: sanitize](https://github.com/Alir3z4/sanitize) - :star: 28 :fork_and_knife: 2 - Bringing sanity to world of messed-up data.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 695 :fork_and_knife: 142 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 1766 :fork_and_knife: 167 - Extract text from any document, Word, PowerPoint, PDFs, etc.
...
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - :star: 1551 :fork_and_knife: 517 - Bootstrap 3 integration with Django.
...
* [:octocat: schema](https://github.com/halst/schema) - :star: 932 :fork_and_knife: 85 - A library for validating Python data structures.
* [:octocat: Schematics](https://github.com/schematics/schematics) - :star: 1661 :fork_and_knife: 212 - Data Structure Validation.
...
* [:octocat: voluptuous](https://github.com/alecthomas/voluptuous) - :star: 690 :fork_and_knife: 106 - A Python data validation library. It is primarily intended for validating data coming into Python as JSON, YAML, etc.

## Anti-spam

*Libraries for fighting spam.*

* [:octocat: django-simple-captcha](https://github.com/mbi/django-simple-captcha) - :star: 392 :fork_and_knife: 158 - A simple and highly customizable Django app to add captcha images to any Django form.
...
* [:octocat: django-taggit](https://github.com/alex/django-taggit) - :star: 1526 :fork_and_knife: 415 - Simple tagging for Django.
...
* [:octocat: django-xadmin](https://github.com/sshwsfc/django-xadmin) - :star: 1736 :fork_and_knife: 548 - Drop-in replacement of Django admin comes with lots of goodies.
* [:octocat: flask-admin](https://github.com/mrjoes/flask-admin) - :star: 67 :fork_and_knife: 32 - Simple and extensible administrative interface framework for Flask.
* [:octocat: flower](https://github.com/mher/flower) - :star: 1932 :fork_and_knife: 357 - Real-time monitor and web admin for Celery.
* [:earth_americas: Grappelli](http://grappelliproject.com) – A jazzy skin for the Django Admin-Interface.
* [:octocat: Wooey](https://github.com/wooey/wooey) - :star: 733 :fork_and_knife: 62 - A Django app which creates automatic web UIs for Python scripts.
...
* [:octocat: envoy](https://github.com/kennethreitz/envoy) - :star: 1832 :fork_and_knife: 148 - Python [subprocess](https://docs.python.org/2/library/subprocess.html) for Humans™.
* [:earth_americas: sarge](http://sarge.readthedocs.org/) - Yet another wrapper for subprocess.
* [:octocat: sh](https://github.com/amoffat/sh) - :star: 3477 :fork_and_knife: 305 - A full-fledged subprocess replacement for Python.
...
* [:octocat: gevent](http://www.gevent.org/) - :star: 688 :fork_and_knife: 128 - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
* [:octocat: Tomorrow](https://github.com/madisonmay/Tomorrow) - :star: 1178 :fork_and_knife: 67 - Magic decorator syntax for asynchronous code.
...
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - :star: 1341 :fork_and_knife: 95 - Event-driven concurrent framework for Python.
...
* [:octocat: txZMQ](https://github.com/smira/txZMQ) - :star: 127 :fork_and_knife: 38 - Twisted based wrapper for the ZeroMQ message library.

## WebSocket

*Libraries for working with WebSocket.*

* [:octocat: AutobahnPython](https://github.com/tavendo/AutobahnPython) - :star: 1270 :fork_and_knife: 402 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 1060 :fork_and_knife: 141 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 933 :fork_and_knife: 194 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 732 :fork_and_knife: 184 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* [:octocat: netius](https://github.com/hivesolutions/netius) - :star: 42 :fork_and_knife: 3 - Asynchronous, very fast.
...
* [:octocat: zeroRPC](https://github.com/dotcloud/zerorpc-python) - :star: 1808 :fork_and_knife: 219 - zerorpc is a flexible RPC implementation based on [ZeroMQ](http://zeromq.org/) and [MessagePack](http://msgpack.org/).
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 498 :fork_and_knife: 41 - Implementation of [hashids](http://hashids.org) in Python.
...
* [:octocat: Toga](https://github.com/pybee/toga) - :star: 945 :fork_and_knife: 72 - A Python native, OS native GUI toolkit.
...
* Testing Frameworks
    ...
    * [:octocat: hypothesis](https://github.com/DRMacIver/hypothesis) - :star: 1593 :fork_and_knife: 146 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 639 :fork_and_knife: 98 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    ...
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 1192 :fork_and_knife: 449 - A generic test automation framework.
* Web Testing
    ...
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 4164 :fork_and_knife: 600 - Scalable user load testing tool written in Python.
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1176 :fork_and_knife: 118 - A language-agnostic A/B Testing framework.
...
* Mock
    ...
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 845 :fork_and_knife: 89 - Travel through time by mocking the datetime module.
    ...
    * [:octocat: responses](https://github.com/dropbox/responses) - :star: 1343 :fork_and_knife: 123 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 758 :fork_and_knife: 117 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - :star: 1008 :fork_and_knife: 142 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 352 :fork_and_knife: 36 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
    * [:octocat: model_mommy](https://github.com/vandersonmota/model_mommy) - :star: 605 :fork_and_knife: 137 - Creating random fixtures for testing in Django.
* Code Coverage
...
* Error Handler
    * [:octocat: FuckIt.py](https://github.com/ajalt/fuckitpy) - :star: 2147 :fork_and_knife: 89 - FuckIt.py uses state-of-the-art technology to make sure your Python code runs whether it has any right to or not.
...
* Code Analysis
    * [:octocat: code2flow](https://github.com/scottrogowski/code2flow) - :star: 295 :fork_and_knife: 39 - Turn your Python and JavaScript code into DOT flowcharts.
    * [:octocat: pycallgraph](https://github.com/gak/pycallgraph) - :star: 708 :fork_and_knife: 114 - A library that visualises the flow (call graph) of your Python application.
    * [:octocat: pysonar2](https://github.com/yinwang0/pysonar2) - :star: 2292 :fork_and_knife: 628 - A type inferencer and indexer for Python.
* Linter
...
* Debugger
    ...
    * [:octocat: wdb](https://github.com/Kozea/wdb) - :star: 1073 :fork_and_knife: 56 - An improbable web debugger through WebSockets.
    ...
    * [:octocat: django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) - :star: 3864 :fork_and_knife: 700 - Display various debug information about the current request/response.
    * [:octocat: django-devserver](https://github.com/dcramer/django-devserver) - :star: 1162 :fork_and_knife: 150 - A drop-in replacement for Django's runserver.
    * [:octocat: flask-debugtoolbar](https://github.com/mgood/flask-debugtoolbar) - :star: 498 :fork_and_knife: 81 - A port of the django-debug-toolbar to flask.
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - :star: 999 :fork_and_knife: 78 - Line-by-line profiling.
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 856 :fork_and_knife: 117 - Monitor Memory usage of Python code.
    * [:octocat: profiling](https://github.com/what-studio/profiling) - :star: 2452 :fork_and_knife: 86 - An interactive Python profiler.
* Others
    * [:octocat: pyelftools](https://github.com/eliben/pyelftools) - :star: 381 :fork_and_knife: 149 - A pure-Python library for parsing and analyzing ELF files and DWARF debugging information.
...
* [:octocat: bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) - :star: 357 :fork_and_knife: 179 - A toolkit providing best-practice pipelines for fully automated high throughput sequencing analysis.
...
* [:octocat: Open Mining](https://github.com/avelino/mining) - :star: 648 :fork_and_knife: 104 - Business Intelligence (BI) in Python (Pandas web interface)
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - :star: 1693 :fork_and_knife: 399 - Markov Chain Monte Carlo sampling toolkit.
...
* [:octocat: statsmodels](https://github.com/statsmodels/statsmodels) - :star: 1693 :fork_and_knife: 828 - Statistical modeling and econometrics in Python.
* [:octocat: SymPy](https://github.com/sympy/sympy) - :star: 3267 :fork_and_knife: 1630 - A Python library for symbolic mathematics.
* [:octocat: zipline](https://github.com/quantopian/zipline) - :star: 3868 :fork_and_knife: 1212 - A Pythonic algorithmic trading library.
...
* [:octocat: bokeh](https://github.com/ContinuumIO/bokeh) - :star: 4758 :fork_and_knife: 1094 - Interactive Web Plotting for Python.
* [:octocat: ggplot](https://github.com/yhat/ggplot) - :star: 2767 :fork_and_knife: 387 - Same API as ggplot2 for R.
...
* [:octocat: vincent](https://github.com/wrobstory/vincent) - :star: 1931 :fork_and_knife: 205 - A Python to Vega translator.
...
* [:octocat: Crab](https://github.com/muricoca/crab) - :star: 742 :fork_and_knife: 283 - A ﬂexible, fast recommender engine.
* [:octocat: gensim](https://github.com/piskvorky/gensim) - :star: 3155 :fork_and_knife: 1180 - Topic Modelling for Humans.
* [:octocat: hebel](https://github.com/hannes-brt/hebel) - :star: 1147 :fork_and_knife: 109 - GPU-Accelerated Deep Learning Library in Python.
* [:octocat: NuPIC](https://github.com/numenta/nupic) - :star: 4530 :fork_and_knife: 1281 - Numenta Platform for Intelligent Computing.
* [:octocat: pattern](https://github.com/clips/pattern) - :star: 4875 :fork_and_knife: 895 - Web mining module for Python.
* [:octocat: PyBrain](https://github.com/pybrain/pybrain) - :star: 2064 :fork_and_knife: 638 - Another Python Machine Learning Library.
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - :star: 2207 :fork_and_knife: 906 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano).
* [:octocat: python-recsys](https://github.com/ocelma/python-recsys) - :star: 690 :fork_and_knife: 303 - A Python library for implementing a Recommender System.
...
* [:octocat: dpark](https://github.com/douban/dpark) - :star: 1949 :fork_and_knife: 448 - Python clone of Spark, a MapReduce alike framework in Python.
* [:octocat: dumbo](https://github.com/klbostee/dumbo) - :star: 982 :fork_and_knife: 159 - Python module that allows one to easily write and run Hadoop programs.
* [:octocat: luigi](https://github.com/spotify/luigi) - :star: 5618 :fork_and_knife: 1070 - A module that helps you build complex pipelines of batch jobs.
* [:octocat: mrjob](https://github.com/Yelp/mrjob) - :star: 1911 :fork_and_knife: 486 - Run MapReduce jobs on Hadoop or Amazon Web Services.
* [:earth_americas: PySpark](http://spark.apache.org/docs/latest/programming-guide.html) - The Spark Python API.
* [:octocat: streamparse](https://github.com/Parsely/streamparse) - :star: 1054 :fork_and_knife: 157 - Run Python code against real-time streams of data. Integrates with [Apache Storm](https://storm.incubator.apache.org/).

## Functional Programming

*Functional Programming with Python.*

* [:octocat: CyToolz](https://github.com/pytoolz/cytoolz/) - :star: 300 :fork_and_knife: 27 - Cython implementation of Toolz: High performance functional utilities.
* [:octocat: fn.py](https://github.com/kachayev/fn.py) - :star: 2096 :fork_and_knife: 133 - Functional programming in Python: implementation of missing features to enjoy FP.
* [:octocat: funcy](https://github.com/Suor/funcy) - :star: 1346 :fork_and_knife: 66 - A fancy and practical functional tools.
* [:octocat: Toolz](https://github.com/pytoolz/toolz) - :star: 1231 :fork_and_knife: 102 - A collection of functional utilities for iterators, functions, and dictionaries.
...
* [:octocat: boto](https://github.com/boto/boto) - :star: 5674 :fork_and_knife: 2075 - Python interface to Amazon Web Services.
* [:octocat: django-wordpress](https://github.com/sunlightlabs/django-wordpress/) - :star: 222 :fork_and_knife: 51 - WordPress models and views for Django.
* [:octocat: facebook-sdk](https://github.com/pythonforfacebook/facebook-sdk) - :star: 1793 :fork_and_knife: 681 - Facebook Platform Python SDK.
...
* [:octocat: gmail](https://github.com/charlierguo/gmail) - :star: 1314 :fork_and_knife: 251 - A Pythonic interface for Gmail.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 1211 :fork_and_knife: 560 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 1890 :fork_and_knife: 352 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1248 :fork_and_knife: 318 - A Python wrapper for the Twitter API.

## DevOps Tools

*Software and libraries for DevOps.*

* [:octocat: Ansible](https://github.com/ansible/ansible) - :star: 19474 :fork_and_knife: 5921 - A radically simple IT automation platform.
* [:octocat: SaltStack](https://github.com/saltstack/salt) - :star: 6994 :fork_and_knife: 3198 - Infrastructure automation and management system.
...
* [:octocat: Fabtools](https://github.com/ronnix/fabtools) - :star: 1043 :fork_and_knife: 203 - Tools for writing awesome Fabric files.
...
* [:octocat: honcho](https://github.com/nickstenning/honcho) - :star: 862 :fork_and_knife: 98 - A Python port of [Foreman](https://github.com/ddollar/foreman), a tool for managing Procfile-based applications.
* [:earth_americas: OpenStack](http://www.openstack.org/) - Open source software for building private and public clouds.
* [:octocat: pexpect](https://github.com/pexpect/pexpect) - :star: 722 :fork_and_knife: 195 - Controlling interactive programs in a pseudo-terminal like GNU expect.
...
* [:octocat: psutil](https://github.com/giampaolo/psutil) - :star: 1997 :fork_and_knife: 341 - A cross-platform process and system utilities module.
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - :star: 2836 :fork_and_knife: 573 - Supervisor process control system for UNIX.
...
* [:octocat: Plan](https://github.com/fengsp/plan) - :star: 932 :fork_and_knife: 67 - Writing crontab file in Python like a charm.
* [:octocat: schedule](https://github.com/dbader/schedule) - :star: 2520 :fork_and_knife: 250 - Python job scheduling for humans.
* [:octocat: Spiff](https://github.com/knipknap/SpiffWorkflow) - :star: 383 :fork_and_knife: 94 - A powerful workflow engine implemented in pure Python.
...
* [:octocat: Pyston](https://github.com/dropbox/pyston) - :star: 4039 :fork_and_knife: 278 - A Python implementation built using LLVM and modern JIT techniques with the goal of achieving good performance.
...
* [:octocat: PythonNet](https://github.com/pythonnet/pythonnet) - :star: 258 :fork_and_knife: 83 - Python Integration with the .NET Common Language Runtime (CLR).
...
* [:octocat: PyUserInput](https://github.com/SavinaRoja/PyUserInput) - :star: 468 :fork_and_knife: 118 - A module for cross-platform control of the mouse and keyboard.
...
* [:octocat: Python-Modernize](https://github.com/mitsuhiko/python-modernize) - :star: 421 :fork_and_knife: 33 - Modernizes Python code for eventual Python 3 migration.
...
* [:octocat: blinker](https://github.com/jek/blinker) - :star: 444 :fork_and_knife: 58 - A fast Python in-process signal/event dispatching system.
* [:octocat: itsdangerous](https://github.com/mitsuhiko/itsdangerous) - :star: 1019 :fork_and_knife: 86 - Various helpers to pass trusted data to untrusted environments.
* [:octocat: pluginbase](https://github.com/mitsuhiko/pluginbase) - :star: 428 :fork_and_knife: 45 - A simple but flexible plugin system for Python.
...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - :star: 1736 :fork_and_knife: 446 - A module of algorithms for Python.
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - :star: 9626 :fork_and_knife: 2296 - A collection of design patterns in Python.
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - :star: 818 :fork_and_knife: 117 - Emacs Python Development Environment.
* Sublime Text
    ...
    * [:octocat: Anaconda](https://github.com/DamnWidget/anaconda) - :star: 1225 :fork_and_knife: 133 - Anaconda turns your Sublime Text 3 in a full featured Python development IDE.
* Vim
    * [:octocat: YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - :star: 12126 :fork_and_knife: 1416 - Includes [Jedi](https://github.com/davidhalter/jedi)-based completion engine for Python.
    * [:octocat: Jedi-vim](https://github.com/davidhalter/jedi-vim) - :star: 2546 :fork_and_knife: 219 - Vim bindings for the Jedi auto-completion library for Python.
    * [:octocat: Python-mode](https://github.com/klen/python-mode) - :star: 3197 :fork_and_knife: 657 - An all in one plugin for turning Vim into a Python IDE.
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - :star: 1307 :fork_and_knife: 345 - Python Tools for Visual Studio.
...
* [:octocat: Spyder](https://github.com/spyder-ide/spyder) - :star: 1510 :fork_and_knife: 363 - Open Source Python IDE.
...
* Python
    ...
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 282 :fork_and_knife: 52
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 1682 :fork_and_knife: 349
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 421 :fork_and_knife: 80
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 45446 :fork_and_knife: 5411
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 3948 :fork_and_knife: 301
