...
* [:octocat: wooey](https://github.com/wooey/wooey) - :star: 1541 :fork_and_knife: 171 - A Django app which creates automatic web UIs for Python scripts.
...
* Audio
    ...
    * [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 5172 :fork_and_knife: 708 - Manipulate audio with a simple and easy high level interface.
...
* CLI Enhancements
    ...
    * [:octocat: litecli](https://github.com/dbcli/litecli) - :star: 1332 :fork_and_knife: 40 - SQLite CLI with autocompletion and syntax highlighting.
...
* NoSQL Databases
    * [:octocat: cassandra-driver](https://github.com/datastax/python-driver) - :star: 1223 :fork_and_knife: 455 - The Python Driver for Apache Cassandra.
...
* Tracing
    ...
    * [:octocat: python-hunter](https://github.com/ionelmc/python-hunter) - :star: 599 :fork_and_knife: 28 - A flexible code tracing toolkit.
* Profiler
...
* Office
    ...
    * [:octocat: unoconv](https://github.com/unoconv/unoconv) - :star: 2075 :fork_and_knife: 388 - Convert between any document format supported by LibreOffice/OpenOffice.
...
* [:octocat: daramatiq](https://github.com/Bogdanp/dramatiq) - :star: 2469 :fork_and_knife: 176 - A fast and reliable background task processing library for Python 3.
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 3406 :fork_and_knife: 303 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 840 :fork_and_knife: 113 - A distributed worker task queue in Python using Redis & gevent.
* [:octocat: rq](https://github.com/rq/rq) - :star: 7582 :fork_and_knife: 1209 - Simple job queues for Python.
...
* [:octocat: Jinja2](https://github.com/pallets/jinja) - :star: 7605 :fork_and_knife: 1383 - A modern and designer friendly templating language.
...
* Testing Frameworks
    * [:octocat: hypothesis](https://github.com/HypothesisWorks/hypothesis) - :star: 5015 :fork_and_knife: 454 - Hypothesis is an advanced Quickcheck style property based testing library.
    * [:octocat: nose2](https://github.com/nose-devs/nose2) - :star: 663 :fork_and_knife: 132 - The successor to `nose`, based on `unittest2.
    * [:earth_americas: pytest](https://docs.pytest.org/en/latest/) - A mature full-featured Python testing tool.
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 5662 :fork_and_knife: 1625 - A generic test automation framework.
    * [:earth_americas: unittest](https://docs.python.org/3/library/unittest.html) - (Python standard library) Unit testing framework.
* Test Runners
    * [:octocat: green](https://github.com/CleanCut/green) - :star: 692 :fork_and_knife: 74 - A clean, colorful test runner.
...
* GUI / Web Testing
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 15587 :fork_and_knife: 2070 - Scalable user load testing tool written in Python.
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 4877 :fork_and_knife: 676 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    * [:octocat: Schemathesis](https://github.com/kiwicom/schemathesis) - :star: 765 :fork_and_knife: 58 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
    * [:earth_americas: Selenium](https://pypi.org/project/selenium/) - Python bindings for [Selenium](http://www.seleniumhq.org/) WebDriver.
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1678 :fork_and_knife: 184 - A language-agnostic A/B Testing framework.
    * [:octocat: splinter](https://github.com/cobrateam/splinter) - :star: 2357 :fork_and_knife: 488 - Open source tool for testing web applications.
* Mock
    * [:earth_americas: doublex](https://pypi.org/project/doublex/) - Powerful test doubles framework for Python.
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 2807 :fork_and_knife: 196 - Travel through time by mocking the datetime module.
    * [:octocat: httmock](https://github.com/patrys/httmock) - :star: 420 :fork_and_knife: 52 - A mocking library for requests for Python 2.6+ and 3.2+.
    * [:octocat: httpretty](https://github.com/gabrielfalcao/HTTPretty) - :star: 1854 :fork_and_knife: 247 - HTTP request mock tool for Python.
    ...
    * [:octocat: mocket](https://github.com/mindflayer/python-mocket) - :star: 209 :fork_and_knife: 33 - A socket mock framework with gevent/asyncio/SSL support.
    * [:octocat: responses](https://github.com/getsentry/responses) - :star: 3134 :fork_and_knife: 258 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 1916 :fork_and_knife: 268 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/FactoryBoy/factory_boy) - :star: 2436 :fork_and_knife: 313 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 743 :fork_and_knife: 87 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
...
* Fake Data
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 2055 :fork_and_knife: 116 - Fake database generator.
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 12236 :fork_and_knife: 1392 - A Python package that generates fake data.
    * [:octocat: mimesis](https://github.com/lk-geimfari/mimesis) - :star: 3244 :fork_and_knife: 271 - is a Python library that help you generate fake data.
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 1462 :fork_and_knife: 194 - Python 2/3 compatible character encoding detector.
    * [:earth_americas: difflib](https://docs.python.org/3/library/difflib.html) - (Python standard library) Helpers for computing deltas.
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 2903 :fork_and_knife: 103 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 7916 :fork_and_knife: 817 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 946 :fork_and_knife: 127 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 163 :fork_and_knife: 22 - Paranoid text spacing.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 781 :fork_and_knife: 88 - An implementation of figlet written in Python.
    * [:octocat: pypinyin](https://github.com/mozillazg/python-pinyin) - :star: 3157 :fork_and_knife: 488 - Convert Chinese hanzi (漢字) to pinyin (拼音).
    * [:octocat: textdistance](https://github.com/orsinium/textdistance) - :star: 1930 :fork_and_knife: 166 - Compute distance between sequences with 30+ algorithms.
    * [:earth_americas: unidecode](https://pypi.org/project/Unidecode/) - ASCII transliterations of Unicode text.
* Slugify
    * [:octocat: awesome-slugify](https://github.com/dimka665/awesome-slugify) - :star: 457 :fork_and_knife: 41 - A Python slugify library that can preserve unicode.
    * [:octocat: python-slugify](https://github.com/un33k/python-slugify) - :star: 1005 :fork_and_knife: 81 - A Python slugify library that translates unicode to ASCII.
...
* Unique identifiers
    * [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 1180 :fork_and_knife: 86 - Implementation of [hashids](http://hashids.org) in Python.
    * [:octocat: shortuuid](https://github.com/skorokithakis/shortuuid) - :star: 1431 :fork_and_knife: 90 - A generator library for concise, unambiguous and URL-safe UUIDs.
* Parser
    * [:octocat: ply](https://github.com/dabeaz/ply) - :star: 1870 :fork_and_knife: 320 - Implementation of lex and yacc parsing tools for Python.
    * [:earth_americas: pygments](http://pygments.org/) - A generic syntax highlighter.
    * [:octocat: pyparsing](https://github.com/pyparsing/pyparsing) - :star: 1049 :fork_and_knife: 166 - A general purpose framework for generating parsers.
    * [:octocat: python-nameparser](https://github.com/derek73/python-nameparser) - :star: 461 :fork_and_knife: 78 - Parsing human names into their individual components.
    * [:octocat: python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 2651 :fork_and_knife: 335 - Parsing, formatting, storing and validating international phone numbers.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 1132 :fork_and_knife: 182 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 2358 :fork_and_knife: 489 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 6209 :fork_and_knife: 1330 - Python interface to Amazon Web Services.
* [:octocat: django-wordpress](https://github.com/istrategylabs/django-wordpress) - :star: 318 :fork_and_knife: 86 - WordPress models and views for Django.
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 2585 :fork_and_knife: 943 - Facebook Platform Python SDK.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 4541 :fork_and_knife: 1853 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 5228 :fork_and_knife: 793 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1772 :fork_and_knife: 398 - A Python wrapper for the Twitter API.

## URL Manipulation

*Libraries for parsing URLs.*

* [:octocat: furl](https://github.com/gruns/furl) - :star: 1979 :fork_and_knife: 121 - A small Python library that makes parsing and manipulating URLs easy.
* [:octocat: purl](https://github.com/codeinthehole/purl) - :star: 250 :fork_and_knife: 33 - A simple, immutable URL class with a clean API for interrogation and manipulation.
* [:octocat: pyshorteners](https://github.com/ellisonleao/pyshorteners) - :star: 290 :fork_and_knife: 53 - A pure Python URL shortening lib.
* [:octocat: webargs](https://github.com/marshmallow-code/webargs) - :star: 1144 :fork_and_knife: 141 - A friendly library for parsing HTTP request arguments with built-in support for popular web frameworks.
...
* [:octocat: vidgear](https://github.com/abhiTronix/vidgear) - :star: 1671 :fork_and_knife: 117 - Most Powerful multi-threaded Video Processing framework.

## Web Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 2436 :fork_and_knife: 564 - Compresses linked and inline JavaScript or CSS into a single cached file.
* [:octocat: django-pipeline](https://github.com/jazzband/django-pipeline) - :star: 1390 :fork_and_knife: 359 - An asset packaging library for Django.
* [:octocat: django-storages](https://github.com/jschneier/django-storages) - :star: 1848 :fork_and_knife: 680 - A collection of custom storage back ends for Django.
...
* [:octocat: flask-assets](https://github.com/miracle2k/flask-assets) - :star: 407 :fork_and_knife: 87 - Helps you integrate webassets into your Flask app.
* [:octocat: webassets](https://github.com/miracle2k/webassets) - :star: 893 :fork_and_knife: 256 - Bundles, optimizes, and manages unique cache-busting URLs for static resources.

## Web Content Extracting

*Libraries for extracting web contents.*

* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 1068 :fork_and_knife: 187 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 521 :fork_and_knife: 42 - Web Content Retrieval for Humans.
* [:octocat: micawber](https://github.com/coleifer/micawber) - :star: 532 :fork_and_knife: 80 - A small library for extracting rich content from URLs.
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 10791 :fork_and_knife: 1779 - News extraction, article extraction and content curation in Python.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1945 :fork_and_knife: 321 - Fast Python port of arc90's readability tool.
* [:octocat: requests-html](https://github.com/psf/requests-html) - :star: 11669 :fork_and_knife: 790 - Pythonic HTML Parsing for Humans.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 2529 :fork_and_knife: 455 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 2973 :fork_and_knife: 432 - Extract text from any document, Word, PowerPoint, PDFs, etc.
* [:octocat: toapi](https://github.com/gaojiuli/toapi) - :star: 3113 :fork_and_knife: 226 - Every web site provides APIs.

## Web Crawling

*Libraries to automate web scraping.*

* [:octocat: cola](https://github.com/chineking/cola) - :star: 1394 :fork_and_knife: 542 - A distributed crawling framework.
* [:earth_americas: feedparser](https://pythonhosted.org/feedparser/) - Universal feed parser.
* [:octocat: grab](https://github.com/lorien/grab) - :star: 2066 :fork_and_knife: 262 - Site scraping framework.
* [:octocat: MechanicalSoup](https://github.com/MechanicalSoup/MechanicalSoup) - :star: 3692 :fork_and_knife: 344 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 8113 :fork_and_knife: 1320 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 14910 :fork_and_knife: 3571 - A powerful spider system.
* [:octocat: robobrowser](https://github.com/jmcarp/robobrowser) - :star: 3533 :fork_and_knife: 336 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* Synchronous
    * [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
        * [:octocat: awesome-django](https://github.com/shahraizali/awesome-django) - :star: 590 :fork_and_knife: 115
        * [:octocat: awesome-django](https://github.com/wsvincent/awesome-django) - :star: 3663 :fork_and_knife: 638
    * [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
        * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 9687 :fork_and_knife: 1419
    * [:earth_americas: Pyramid](https://pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
        * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 499 :fork_and_knife: 54
    * [:octocat: Masonite](https://github.com/MasoniteFramework/masonite) - :star: 1555 :fork_and_knife: 94 - The modern and developer centric Python web framework.
* Asynchronous
...
* [:octocat: autobahn-python](https://github.com/crossbario/autobahn-python) - :star: 2260 :fork_and_knife: 628 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: channels](https://github.com/django/channels) - :star: 4812 :fork_and_knife: 663 - Developer-friendly asynchrony for Django.
* [:octocat: websockets](https://github.com/aaugustin/websockets) - :star: 3240 :fork_and_knife: 363 - A library for building WebSocket servers and clients with a focus on correctness and simplicity.

## WSGI Servers

*WSGI-compatible web servers.*

* [:octocat: bjoern](https://github.com/jonashaag/bjoern) - :star: 2530 :fork_and_knife: 184 - Asynchronous, very fast and written in C.
* [:octocat: gunicorn](https://github.com/benoitc/gunicorn) - :star: 7512 :fork_and_knife: 1410 - Pre-forked, partly written in C.
...
* [:octocat: waitress](https://github.com/Pylons/waitress) - :star: 913 :fork_and_knife: 128 - Multi-threaded, powers Pyramid.
* [:octocat: werkzeug](https://github.com/pallets/werkzeug) - :star: 5641 :fork_and_knife: 1518 - A WSGI utility library for Python that powers Flask and can easily be embedded into your own projects.
...
* Tutorials
    ...
    * [:octocat: Ultimate Python study guide](https://github.com/huangsam/ultimate-python) - :star: 2807 :fork_and_knife: 264
* Libraries
...
* Others
    ...
    * [:octocat: What the f*ck Python!](https://github.com/satwikkansal/wtfpython) - :star: 26249 :fork_and_knife: 2206
