...
* [:octocat: wooey](https://github.com/wooey/wooey) - :star: 1496 :fork_and_knife: 169 - A Django app which creates automatic web UIs for Python scripts.
...
* Audio
    ...
    * [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 4882 :fork_and_knife: 676 - Manipulate audio with a simple and easy high level interface.
...
* CLI Enhancements
    ...
    * [:octocat: litecli](https://github.com/dbcli/litecli) - :star: 1238 :fork_and_knife: 41 - SQLite CLI with autocompletion and syntax highlighting.
...
* Tracing
    ...
    * [:octocat: python-hunter](https://github.com/ionelmc/python-hunter) - :star: 570 :fork_and_knife: 26 - A flexible code tracing toolkit.
* Profiler
...
* Office
    ...
    * [:octocat: unoconv](https://github.com/unoconv/unoconv) - :star: 1993 :fork_and_knife: 381 - Convert between any document format supported by LibreOffice/OpenOffice.
...
* [:octocat: daramatiq](https://github.com/Bogdanp/dramatiq) - :star: 2284 :fork_and_knife: 157 - A fast and reliable background task processing library for Python 3.
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 3235 :fork_and_knife: 292 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 826 :fork_and_knife: 112 - A distributed worker task queue in Python using Redis & gevent.
* [:octocat: rq](https://github.com/rq/rq) - :star: 7348 :fork_and_knife: 1170 - Simple job queues for Python.
...
* [:octocat: Jinja2](https://github.com/pallets/jinja) - :star: 7345 :fork_and_knife: 1345 - A modern and designer friendly templating language.
...
* Testing Frameworks
    * [:octocat: hypothesis](https://github.com/HypothesisWorks/hypothesis) - :star: 4756 :fork_and_knife: 434 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 5214 :fork_and_knife: 1531 - A generic test automation framework.
...
* GUI / Web Testing
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 14256 :fork_and_knife: 1954 - Scalable user load testing tool written in Python.
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 4429 :fork_and_knife: 624 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    * [:octocat: Schemathesis](https://github.com/kiwicom/schemathesis) - :star: 639 :fork_and_knife: 50 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
    ...
    * [:octocat: splinter](https://github.com/cobrateam/splinter) - :star: 2310 :fork_and_knife: 481 - Open source tool for testing web applications.
* Mock
    * [:earth_americas: doublex](https://pypi.org/project/doublex/) - Powerful test doubles framework for Python.
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 2637 :fork_and_knife: 191 - Travel through time by mocking the datetime module.
    * [:octocat: httmock](https://github.com/patrys/httmock) - :star: 413 :fork_and_knife: 52 - A mocking library for requests for Python 2.6+ and 3.2+.
    * [:octocat: httpretty](https://github.com/gabrielfalcao/HTTPretty) - :star: 1820 :fork_and_knife: 245 - HTTP request mock tool for Python.
    ...
    * [:octocat: responses](https://github.com/getsentry/responses) - :star: 2969 :fork_and_knife: 247 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 1811 :fork_and_knife: 258 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/FactoryBoy/factory_boy) - :star: 2320 :fork_and_knife: 307 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 709 :fork_and_knife: 77 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
...
* Fake Data
    ...
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 10784 :fork_and_knife: 1278 - A Python package that generates fake data.
    * [:octocat: mimesis](https://github.com/lk-geimfari/mimesis) - :star: 3132 :fork_and_knife: 263 - is a Python library that help you generate fake data.
...
* General
    ...
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 2847 :fork_and_knife: 98 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 7561 :fork_and_knife: 791 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 883 :fork_and_knife: 120 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 156 :fork_and_knife: 22 - Paranoid text spacing.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 720 :fork_and_knife: 78 - An implementation of figlet written in Python.
    * [:octocat: pypinyin](https://github.com/mozillazg/python-pinyin) - :star: 2941 :fork_and_knife: 466 - Convert Chinese hanzi (漢字) to pinyin (拼音).
    * [:octocat: textdistance](https://github.com/orsinium/textdistance) - :star: 1816 :fork_and_knife: 157 - Compute distance between sequences with 30+ algorithms.
...
* Slugify
    ...
    * [:octocat: python-slugify](https://github.com/un33k/python-slugify) - :star: 930 :fork_and_knife: 79 - A Python slugify library that translates unicode to ASCII.
...
* Unique identifiers
    * [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 1144 :fork_and_knife: 84 - Implementation of [hashids](http://hashids.org) in Python.
    * [:octocat: shortuuid](https://github.com/skorokithakis/shortuuid) - :star: 1354 :fork_and_knife: 84 - A generator library for concise, unambiguous and URL-safe UUIDs.
* Parser
    * [:octocat: ply](https://github.com/dabeaz/ply) - :star: 1783 :fork_and_knife: 309 - Implementation of lex and yacc parsing tools for Python.
    * [:earth_americas: pygments](http://pygments.org/) - A generic syntax highlighter.
    * [:octocat: pyparsing](https://github.com/pyparsing/pyparsing) - :star: 919 :fork_and_knife: 145 - A general purpose framework for generating parsers.
    ...
    * [:octocat: python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 2562 :fork_and_knife: 321 - Parsing, formatting, storing and validating international phone numbers.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 1085 :fork_and_knife: 177 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 2233 :fork_and_knife: 466 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 5911 :fork_and_knife: 1275 - Python interface to Amazon Web Services.
...
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 2558 :fork_and_knife: 941 - Facebook Platform Python SDK.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 4201 :fork_and_knife: 1762 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 5014 :fork_and_knife: 762 - Google Spreadsheets Python API.
...
* [:octocat: furl](https://github.com/gruns/furl) - :star: 1883 :fork_and_knife: 119 - A small Python library that makes parsing and manipulating URLs easy.
...
* [:octocat: pyshorteners](https://github.com/ellisonleao/pyshorteners) - :star: 273 :fork_and_knife: 51 - A pure Python URL shortening lib.
* [:octocat: webargs](https://github.com/marshmallow-code/webargs) - :star: 1083 :fork_and_knife: 138 - A friendly library for parsing HTTP request arguments with built-in support for popular web frameworks.
...
* [:octocat: vidgear](https://github.com/abhiTronix/vidgear) - :star: 1451 :fork_and_knife: 106 - Most Powerful multi-threaded Video Processing framework.

## Web Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 2379 :fork_and_knife: 559 - Compresses linked and inline JavaScript or CSS into a single cached file.
* [:octocat: django-pipeline](https://github.com/jazzband/django-pipeline) - :star: 1375 :fork_and_knife: 349 - An asset packaging library for Django.
* [:octocat: django-storages](https://github.com/jschneier/django-storages) - :star: 1726 :fork_and_knife: 664 - A collection of custom storage back ends for Django.
...
* [:octocat: flask-assets](https://github.com/miracle2k/flask-assets) - :star: 404 :fork_and_knife: 88 - Helps you integrate webassets into your Flask app.
* [:octocat: webassets](https://github.com/miracle2k/webassets) - :star: 886 :fork_and_knife: 254 - Bundles, optimizes, and manages unique cache-busting URLs for static resources.

## Web Content Extracting

*Libraries for extracting web contents.*

* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 1014 :fork_and_knife: 176 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 511 :fork_and_knife: 41 - Web Content Retrieval for Humans.
* [:octocat: micawber](https://github.com/coleifer/micawber) - :star: 505 :fork_and_knife: 75 - A small library for extracting rich content from URLs.
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 10375 :fork_and_knife: 1711 - News extraction, article extraction and content curation in Python.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1885 :fork_and_knife: 317 - Fast Python port of arc90's readability tool.
* [:octocat: requests-html](https://github.com/psf/requests-html) - :star: 11269 :fork_and_knife: 749 - Pythonic HTML Parsing for Humans.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 2414 :fork_and_knife: 435 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 2901 :fork_and_knife: 413 - Extract text from any document, Word, PowerPoint, PDFs, etc.
...
* [:octocat: grab](https://github.com/lorien/grab) - :star: 2000 :fork_and_knife: 251 - Site scraping framework.
* [:octocat: MechanicalSoup](https://github.com/MechanicalSoup/MechanicalSoup) - :star: 3601 :fork_and_knife: 331 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 7957 :fork_and_knife: 1288 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 14681 :fork_and_knife: 3540 - A powerful spider system.
...
* Synchronous
    * [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
        * [:octocat: awesome-django](https://github.com/shahraizali/awesome-django) - :star: 492 :fork_and_knife: 97
        * [:octocat: awesome-django](https://github.com/wsvincent/awesome-django) - :star: 3144 :fork_and_knife: 563
    * [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
        * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 9350 :fork_and_knife: 1384
    * [:earth_americas: Pyramid](https://pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
        * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 491 :fork_and_knife: 54
    * [:octocat: Masonite](https://github.com/MasoniteFramework/masonite) - :star: 1485 :fork_and_knife: 94 - The modern and developer centric Python web framework.
* Asynchronous
...
* [:octocat: bjoern](https://github.com/jonashaag/bjoern) - :star: 2452 :fork_and_knife: 176 - Asynchronous, very fast and written in C.
* [:octocat: gunicorn](https://github.com/benoitc/gunicorn) - :star: 7267 :fork_and_knife: 1358 - Pre-forked, partly written in C.
...
* [:octocat: waitress](https://github.com/Pylons/waitress) - :star: 864 :fork_and_knife: 121 - Multi-threaded, powers Pyramid.
* [:octocat: werkzeug](https://github.com/pallets/werkzeug) - :star: 5495 :fork_and_knife: 1489 - A WSGI utility library for Python that powers Flask and can easily be embedded into your own projects.
...
* Tutorials
    ...
    * [:octocat: Ultimate Python study guide](https://github.com/huangsam/ultimate-python) - :star: 2415 :fork_and_knife: 208
* Libraries
...
* Others
    ...
    * [:octocat: What the f*ck Python!](https://github.com/satwikkansal/wtfpython) - :star: 22603 :fork_and_knife: 2022
