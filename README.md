...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 499 :fork_and_knife: 162 - A module for parsing m3u8 file.
...
* Productivity Tools
    ...
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 3996 :fork_and_knife: 259 - Select files out of bash output.
...
* NoSQL Databases
    ...
    * [:octocat: HappyBase](https://github.com/wbolster/happybase) - :star: 440 :fork_and_knife: 136 - A developer-friendly library for Apache HBase.
...
* Profiler
    ...
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 12 :fork_and_knife: 5 - Monitor Memory usage of Python code.
...
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 834 :fork_and_knife: 165 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.
...
* Archive
    * [:octocat: unp](https://github.com/mitsuhiko/unp) - :star: 332 :fork_and_knife: 62 - A command line tool that can unpack archives easily.
...
* GUI / Web Testing
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 2313 :fork_and_knife: 345 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
...
* General
    ...
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 373 :fork_and_knife: 44 - An implementation of figlet written in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 3247 :fork_and_knife: 711 - HTML Content/Article Extractor.
...
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 12567 :fork_and_knife: 3102 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 3230 :fork_and_knife: 276 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 6567 :fork_and_knife: 1018
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 447 :fork_and_knife: 52
...
* [:octocat: AutobahnPython](https://github.com/crossbario/autobahn-python) - :star: 1938 :fork_and_knife: 552 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 1583 :fork_and_knife: 222 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 1171 :fork_and_knife: 233 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 1012 :fork_and_knife: 249 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 99528 :fork_and_knife: 13219
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 5487 :fork_and_knife: 480
* Python
    * [:octocat: pycrumbs](https://github.com/kirang89/pycrumbs) - :star: 2787 :fork_and_knife: 679
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 526 :fork_and_knife: 145
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 2081 :fork_and_knife: 513
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 680 :fork_and_knife: 149
