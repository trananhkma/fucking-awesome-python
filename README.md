...
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - Simple Python version management. :star: 3190 :fork_and_knife: 233
...
* [:octocat: conda](https://github.com/conda/conda/) - Cross-platform, Python-agnostic binary package manager. :star: 480 :fork_and_knife: 165
...
* [:octocat: localshop](https://github.com/mvantellingen/localshop) - Local PyPI server (custom packages and auto-mirroring of pypi). :star: 250 :fork_and_knife: 91

## Distribution

*Libraries to create packaged executables for release distribution.*

* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - Converts Python programs into stand-alone executables (cross-platform). :star: 1184 :fork_and_knife: 331
...
* [:octocat: IPython](https://github.com/ipython/ipython) - A rich toolkit to help you make the most out of using Python interactively. :star: 7602 :fork_and_knife: 2253
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html). :star: 540 :fork_and_knife: 71
...
* [:octocat: python-magic](https://github.com/ahupp/python-magic) - A Python interface to the libmagic file type identification library. :star: 525 :fork_and_knife: 83
...
* [:octocat: watchdog](https://github.com/gorakhargosh/watchdog) - API and shell utilities to monitor file system events. :star: 1805 :fork_and_knife: 237
...
* [:octocat: moment](https://github.com/zachwill/moment) - A Python library for dealing with dates/times. Inspired by [Moment.js](http://momentjs.com/). :star: 251 :fork_and_knife: 9
...
* General
    ...
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - Makes Unicode text less broken and more consistent automagically. :star: 1027 :fork_and_knife: 37
...
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - Parsing, formatting, storing and validating international phone numbers. :star: 983 :fork_and_knife: 127
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - A module for Tabular Datasets in XLS, CSV, JSON, YAML. :star: 1586 :fork_and_knife: 221
* Office
    ...
    * [:octocat: python-docx](https://github.com/python-openxml/python-docx) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. :star: 368 :fork_and_knife: 134
    ...
    * [:octocat: xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - Writing and reading data and formatting information from Excel files. :star: 440 :fork_and_knife: 153
* PDF
    * [:octocat: PDFMiner](https://github.com/euske/pdfminer) - A tool for extracting information from PDF documents. :star: 1221 :fork_and_knife: 306
...
* CSV
    * [:octocat: csvkit](https://github.com/onyxfish/csvkit) - Utilities for converting to and working with CSV. :star: 1705 :fork_and_knife: 264
* Archive
...
* [:octocat: jieba](https://github.com/fxsjy/jieba) - Chinese Words Segmentation Utilities. :star: 3771 :fork_and_knife: 1178
...
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - A library for processing Chinese text. :star: 1034 :fork_and_knife: 271
...
* Command-line Application Development
    ...
    * [:octocat: Gooey](https://github.com/chriskiehl/Gooey) - Turn command line programs into a full GUI application with one line :star: 3690 :fork_and_knife: 174
...
* Productivity Tools
    * [:octocat: bashplotlib](https://github.com/glamp/bashplotlib) - Making basic plots in the terminal. It's a quick way to visualize data without GUI. :star: 321 :fork_and_knife: 26
    * [:octocat: caniusepython3](https://github.com/brettcannon/caniusepython3) - Determine what projects are blocking you from porting to Python 3. :star: 207 :fork_and_knife: 20
    * [:octocat: cookiecutter](https://github.com/audreyr/cookiecutter) - A command-line utility that creates projects from cookiecutters (project templates). E.g. Python package projects, jQuery plugin projects. :star: 2383 :fork_and_knife: 288
    * [:octocat: doitlive](https://github.com/sloria/doitlive) - A tool for live presentations in the terminal. :star: 601 :fork_and_knife: 18
    * [:octocat: httpie](https://github.com/jakubroztocil/httpie) - A command line HTTP client, a user-friendly cURL replacement. :star: 18078 :fork_and_knife: 1031
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - Select files out of bash output. :star: 2536 :fork_and_knife: 122
    * [:octocat: percol](https://github.com/mooz/percol) - Adds flavor of interactive selection to the traditional pipe concept on UNIX. :star: 1796 :fork_and_knife: 72
    * [:earth_americas: RainbowStream](http://www.rainbowstream.org/) - Smart and nice Twitter client on terminal.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - Correcting your previous console command. :star: 14424 :fork_and_knife: 682

## Downloader

*Libraries for downloading.*

* [:octocat: coursera](https://github.com/coursera-dl/coursera) - Script for downloading Coursera.org videos and naming them. :star: 2499 :fork_and_knife: 918
* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - A command line tool for managing Amazon S3 and CloudFront. :star: 1580 :fork_and_knife: 522
...
* [:octocat: subliminal](https://github.com/Diaoul/subliminal) - Library and command line tool to search and download subtitles. :star: 785 :fork_and_knife: 181
...
* [:octocat: wand](https://github.com/dahlia/wand) - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick. :star: 488 :fork_and_knife: 116
...
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - Another wrapper for Google Tesseract OCR. :star: 290 :fork_and_knife: 71
...
* [:octocat: pyechonest](https://github.com/echonest/pyechonest) - Python client for the [Echo Nest](http://developer.echonest.com/docs/) API. :star: 488 :fork_and_knife: 904
...
* [:octocat: geopy](https://github.com/geopy/geopy) - Python Geocoding Toolbox. :star: 864 :fork_and_knife: 227
* [:octocat: pygeoip](https://github.com/appliedsec/pygeoip) - Pure Python GeoIP API. :star: 375 :fork_and_knife: 82
...
* [:octocat: urllib3](https://github.com/shazow/urllib3) - A HTTP library with thread-safe connection pooling, file post support, sanity friendly. :star: 914 :fork_and_knife: 278
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - A tiny, document-oriented database. :star: 536 :fork_and_knife: 39
...
* Relational Databases
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL. :star: 1554 :fork_and_knife: 99
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - mysql-python fork supporting Python 3. :star: 174 :fork_and_knife: 18
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - Pure Python MySQL driver compatible to mysql-python. :star: 1232 :fork_and_knife: 292
...
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - Python driver for Cassandra. :star: 404 :fork_and_knife: 195
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - The Redis Python Client. :star: 3592 :fork_and_knife: 886
...
* Relational Databases
    ...
    * [:octocat: peewee](https://github.com/coleifer/peewee) - A small, expressive ORM. :star: 2226 :fork_and_knife: 363
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) :star: 2776 :fork_and_knife: 432
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) :star: 1513 :fork_and_knife: 196
...
* [:octocat: django-guardian](https://github.com/lukaszb/django-guardian) - Implementation of per object permissions for Django 1.2+ :star: 954 :fork_and_knife: 272
...
* [:octocat: eve](https://github.com/nicolaiarocci/eve) - REST API framework powered by Flask, MongoDB and good intentions. :star: 2629 :fork_and_knife: 358
* [:octocat: sandman](https://github.com/jeffknupp/sandman) - Automated REST APIs for existing database-driven systems. :star: 2101 :fork_and_knife: 163
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - Authentication app for Django that "just works." :star: 1987 :fork_and_knife: 713
    ...
    * [:octocat: django-oauth2-provider](https://github.com/caffeinehit/django-oauth2-provider) - Providing OAuth2 access to Django app. :star: 274 :fork_and_knife: 203
    * [:octocat: Flask-OAuthlib](https://github.com/lepture/flask-oauthlib) - OAuth 1.0/a, 2.0 implementation of client and provider for Flask. :star: 556 :fork_and_knife: 161
    * [:octocat: OAuthLib](https://github.com/idan/oauthlib) - A generic and thorough implementation of the OAuth request-signing logic. :star: 974 :fork_and_knife: 219
    ...
    * [:octocat: python-social-auth](https://github.com/omab/python-social-auth) - An easy-to-setup social authentication mechanism. :star: 1890 :fork_and_knife: 798
...
* Others
    ...
    * [:octocat: PyJWT](https://github.com/progrium/pyjwt) - Implementation of the JSON Web Token draft 01. :star: 539 :fork_and_knife: 94
...
* [:octocat: Jinja2](https://github.com/mitsuhiko/jinja2) - A modern and designer friendly templating language. :star: 2740 :fork_and_knife: 564
...
* [:octocat: huey](https://github.com/coleifer/huey) - Little multi-threaded task queue. :star: 744 :fork_and_knife: 71
...
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - The official high-level Python client for Elasticsearch. :star: 535 :fork_and_knife: 123
...
* [:octocat: django-activity-stream](https://github.com/justquick/django-activity-stream) - Generate generic activity streams from the actions on your site. :star: 909 :fork_and_knife: 274
* [:octocat: Feedly](https://github.com/tschellenbach/Feedly) - A library to build newsfeed and notification systems using Cassandra and Redis. :star: 1779 :fork_and_knife: 209

## Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - Compresses linked and inline JavaScript or CSS into a single cached file. :star: 1560 :fork_and_knife: 443
...
* [:octocat: inbox](https://github.com/inboxapp/inbox) - The open source email toolkit. :star: 2450 :fork_and_knife: 203
...
* [:octocat: furl](https://github.com/gruns/furl) - A small Python library that makes manipulating URLs simple. :star: 823 :fork_and_knife: 53
...
* [:octocat: pyquery](https://github.com/gawel/pyquery) - A jQuery-like library for parsing HTML. :star: 789 :fork_and_knife: 72
...
* [:octocat: xmltodict](https://github.com/martinblech/xmltodict) - Working with XML feel like you are working with JSON. :star: 1766 :fork_and_knife: 161
...
* [:octocat: cola](https://github.com/chineking/cola) - A distributed crawling framework. :star: 686 :fork_and_knife: 385
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - A Python library for automating interaction with websites. :star: 1229 :fork_and_knife: 40
* [:octocat: portia](https://github.com/scrapinghub/portia) - Visual scraping for Scrapy. :star: 3445 :fork_and_knife: 477
* [:octocat: pyspider](https://github.com/binux/pyspider) - A powerful spider system. :star: 5255 :fork_and_knife: 1237
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - A simple, Pythonic library for browsing the web without a standalone web browser. :star: 1085 :fork_and_knife: 79
...
* [:octocat: sumy](https://github.com/miso-belica/sumy) - A module for automatic summarization of text documents and HTML pages. :star: 240 :fork_and_knife: 48
...
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - Bootstrap 3 integration with Django. :star: 1127 :fork_and_knife: 349
...
* [:octocat: django-xadmin](https://github.com/sshwsfc/django-xadmin) - Drop-in replacement of Django admin comes with lots of goodies. :star: 1419 :fork_and_knife: 431
...
* [:octocat: flower](https://github.com/mher/flower) - Real-time monitor and web admin for Celery. :star: 1405 :fork_and_knife: 259
* [:earth_americas: Grappelli](http://grappelliproject.com) – A jazzy skin for the Django Admin-Interface.
* [:octocat: Wooey](https://github.com/wooey/wooey) - A Django app which creates automatic web UIs for Python scripts. :star: 480 :fork_and_knife: 26
...
* [:octocat: sh](https://github.com/amoffat/sh) - A full-fledged subprocess replacement for Python. :star: 3067 :fork_and_knife: 251
...
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - Event-driven concurrent framework for Python. :star: 1132 :fork_and_knife: 63
...
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn). :star: 707 :fork_and_knife: 84
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - WebSockets for Django. :star: 792 :fork_and_knife: 151
...
* [:octocat: SimpleJSONRPCServer](https://github.com/joshmarshall/jsonrpclib/) - This library is an implementation of the JSON-RPC specification. :star: 226 :fork_and_knife: 90
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - Implementation of [hashids](http://hashids.org) in Python. :star: 331 :fork_and_knife: 32
...
* [:octocat: enaml](https://github.com/nucleic/enaml) - Creating beautiful user-interfaces with Declaratic Syntax like QML. :star: 406 :fork_and_knife: 52
...
* Testing Frameworks
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - PyAutoGUI is a cross-platform GUI automation Python module for human beings. :star: 269 :fork_and_knife: 36
...
* Mock
    ...
    * [:octocat: responses](https://github.com/dropbox/responses) - A utility library for mocking out the requests Python library. :star: 1062 :fork_and_knife: 80
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - Record and replay HTTP interactions on your tests. :star: 520 :fork_and_knife: 79
* Object Factories
...
* Code Analysis
    ...
    * [:octocat: pysonar2](https://github.com/yinwang0/pysonar2) - A type inferencer and indexer for Python. :star: 1736 :fork_and_knife: 445
* Linter
...
* Debugger
    ...
    * [:octocat: django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) - Display various debug information about the current request/response. :star: 3297 :fork_and_knife: 631
...
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - Line-by-line profiling. :star: 519 :fork_and_knife: 35
    ...
    * [:octocat: profiling](https://github.com/what-studio/profiling) - An interactive Python profiler. :star: 2263 :fork_and_knife: 70
* Others
...
* [:octocat: SymPy](https://github.com/sympy/sympy) - A Python library for symbolic mathematics. :star: 2388 :fork_and_knife: 1165
* [:octocat: zipline](https://github.com/quantopian/zipline) - A Pythonic algorithmic trading library. :star: 2588 :fork_and_knife: 706
...
* [:octocat: bokeh](https://github.com/ContinuumIO/bokeh) - Interactive Web Plotting for Python. :star: 3303 :fork_and_knife: 602
* [:octocat: ggplot](https://github.com/yhat/ggplot) - Same API as ggplot2 for R. :star: 2285 :fork_and_knife: 284
...
* [:octocat: NuPIC](https://github.com/numenta/nupic) - Numenta Platform for Intelligent Computing. :star: 3486 :fork_and_knife: 936
* [:octocat: pattern](https://github.com/clips/pattern) - Web mining module for Python. :star: 3626 :fork_and_knife: 562
* [:octocat: PyBrain](https://github.com/pybrain/pybrain) - Another Python Machine Learning Library. :star: 1434 :fork_and_knife: 448
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - A Machine Learning library based on [Theano](https://github.com/Theano/Theano). :star: 1781 :fork_and_knife: 713
...
* [:octocat: dpark](https://github.com/douban/dpark) - Python clone of Spark, a MapReduce alike framework in Python. :star: 1463 :fork_and_knife: 348
...
* [:octocat: luigi](https://github.com/spotify/luigi) - A module that helps you build complex pipelines of batch jobs. :star: 3323 :fork_and_knife: 595
* [:octocat: mrjob](https://github.com/Yelp/mrjob) - Run MapReduce jobs on Hadoop or Amazon Web Services. :star: 1542 :fork_and_knife: 396
...
* [:octocat: Toolz](https://github.com/pytoolz/toolz) - A collection of functional utilities for iterators, functions, and dictionaries. :star: 892 :fork_and_knife: 70
...
* [:octocat: facebook-sdk](https://github.com/pythonforfacebook/facebook-sdk) - Facebook Platform Python SDK. :star: 1478 :fork_and_knife: 542
* [:octocat: facepy](https://github.com/jgorset/facepy) - Facepy makes it really easy to interact with Facebook's Graph API :star: 392 :fork_and_knife: 120
* [:octocat: gmail](https://github.com/charlierguo/gmail) - A Pythonic interface for Gmail. :star: 1142 :fork_and_knife: 181
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - Google APIs Client Library for Python. :star: 629 :fork_and_knife: 234
* [:octocat: gspread](https://github.com/burnash/gspread) - Google Spreadsheets Python API. :star: 1315 :fork_and_knife: 257
...
* [:octocat: Ansible](https://github.com/ansible/ansible) - A radically simple IT automation platform. :star: 13037 :fork_and_knife: 3894
* [:octocat: SaltStack](https://github.com/saltstack/salt) - Infrastructure automation and management system. :star: 5728 :fork_and_knife: 2447
...
* [:octocat: psutil](https://github.com/giampaolo/psutil) - A cross-platform process and system utilities module. :star: 1047 :fork_and_knife: 166
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - Supervisor process control system for UNIX. :star: 1991 :fork_and_knife: 420
...
* [:octocat: schedule](https://github.com/dbader/schedule) - Python job scheduling for humans. :star: 1644 :fork_and_knife: 137
...
* [:octocat: PythonNet](https://github.com/pythonnet/pythonnet) - Python Integration with the .NET Common Language Runtime (CLR). :star: 90 :fork_and_knife: 41
...
* [:octocat: PyUserInput](https://github.com/SavinaRoja/PyUserInput) - A module for cross-platform control of the mouse and keyboard. :star: 324 :fork_and_knife: 69
...
* [:octocat: blinker](https://github.com/jek/blinker) - A fast Python in-process signal/event dispatching system. :star: 238 :fork_and_knife: 28
* [:octocat: itsdangerous](https://github.com/mitsuhiko/itsdangerous) - Various helpers to pass trusted data to untrusted environments. :star: 749 :fork_and_knife: 66
...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - A module of algorithms for Python. :star: 1171 :fork_and_knife: 292
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - A collection of design patterns in Python. :star: 6966 :fork_and_knife: 1632
...
* Sublime Text
    ...
    * [:octocat: Anaconda](https://github.com/DamnWidget/anaconda) - Anaconda turns your Sublime Text 3 in a full featured Python development IDE. :star: 848 :fork_and_knife: 80
* Vim
    * [:octocat: YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - Includes [Jedi](https://github.com/davidhalter/jedi)-based completion engine for Python. :star: 8719 :fork_and_knife: 999
    ...
    * [:octocat: Python-mode](https://github.com/klen/python-mode) - An all in one plugin for turning Vim into a Python IDE. :star: 2659 :fork_and_knife: 553
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - Python Tools for Visual Studio. :star: 595 :fork_and_knife: 140
...
* [:octocat: Spyder](https://github.com/spyder-ide/spyder) - Open Source Python IDE. :star: 556 :fork_and_knife: 157
...
* Python
    ...
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) :star: 1359 :fork_and_knife: 215
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) :star: 263 :fork_and_knife: 50
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) :star: 20165 :fork_and_knife: 2079
    * [:octocat: lists](https://github.com/jnv/lists) :star: 3431 :fork_and_knife: 207
