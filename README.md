...
* [:octocat: p](https://github.com/qw3rtman/p) - :star: 564 :fork_and_knife: 23 - Dead simple interactive Python version management.
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - :star: 4884 :fork_and_knife: 391 - Simple Python version management.
...
* [:octocat: conda](https://github.com/conda/conda/) - :star: 811 :fork_and_knife: 277 - Cross-platform, Python-agnostic binary package manager.
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - :star: 657 :fork_and_knife: 146 - Next generation Python Package Repository (PyPI).
...
* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - :star: 1900 :fork_and_knife: 458 - Converts Python programs into stand-alone executables (cross-platform).
...
* [:octocat: PlatformIO](https://github.com/ivankravets/platformio) - :star: 1135 :fork_and_knife: 171 - A console tool to build code with different development platforms.
* [:octocat: PyBuilder](https://github.com/pybuilder/pybuilder) - :star: 667 :fork_and_knife: 143 - A continuous build tool written in pure Python.
...
* [:octocat: IPython](https://github.com/ipython/ipython) - :star: 9571 :fork_and_knife: 2801 - A rich toolkit to help you make the most out of using Python interactively.
* [:earth_americas: bpython](http://bpython-interpreter.org) – A fancy interface to the Python interpreter.
* [:octocat: ptpython](https://github.com/jonathanslenders/ptpython) - :star: 1394 :fork_and_knife: 54 - Advanced Python REPL built on top of the [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - :star: 632 :fork_and_knife: 85 - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html).
...
* [:octocat: python-magic](https://github.com/ahupp/python-magic) - :star: 664 :fork_and_knife: 103 - A Python interface to the libmagic file type identification library.
* [:octocat: Unipath](https://github.com/mikeorr/Unipath) - :star: 369 :fork_and_knife: 31 - An object-oriented approach to file/directory operations.
* [:octocat: watchdog](https://github.com/gorakhargosh/watchdog) - :star: 2107 :fork_and_knife: 275 - API and shell utilities to monitor file system events.

## Date and Time

*Libraries for working with dates and times.*

* [:octocat: arrow](https://github.com/crsmithdev/arrow) - :star: 3147 :fork_and_knife: 270 - Better dates & times for Python.
...
* [:octocat: delorean](https://github.com/myusuf3/delorean/) - :star: 1192 :fork_and_knife: 62 - A library for clearing up the inconvenient truths that arise dealing with datetimes.
* [:octocat: moment](https://github.com/zachwill/moment) - :star: 298 :fork_and_knife: 15 - A Python library for dealing with dates/times. Inspired by [Moment.js](http://momentjs.com/).
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 544 :fork_and_knife: 82 - Python 2/3 compatible character encoding detector.
    ...
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 1382 :fork_and_knife: 50 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 2531 :fork_and_knife: 260 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 218 :fork_and_knife: 42 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 40 :fork_and_knife: 7 - Spacing texts for CJK and alphanumerics.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 153 :fork_and_knife: 18 - An implementation of figlet written in Python.
    * [:octocat: shortuuid](https://github.com/stochastic-technologies/shortuuid) - :star: 594 :fork_and_knife: 47 - A generator library for concise, unambiguous and URL-safe UUIDs.
    ...
    * [:octocat: xpinyin](https://github.com/lxneng/xpinyin) - :star: 342 :fork_and_knife: 95 - A library to translate Chinese hanzi (漢字) to pinyin (拼音).
* Slugify
    * [:octocat: awesome-slugify](https://github.com/dimka665/awesome-slugify) - :star: 286 :fork_and_knife: 18 - A Python slugify library that can preserve unicode.
    * [:octocat: python-slugify](https://github.com/un33k/python-slugify) - :star: 263 :fork_and_knife: 31 - A Python slugify library that translates unicode to ASCII.
    * [:octocat: unicode-slugify](https://github.com/mozilla/unicode-slugify) - :star: 206 :fork_and_knife: 37 - A slugifier that generates unicode slugs with Django as a dependency.
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 1244 :fork_and_knife: 164 - Parsing, formatting, storing and validating international phone numbers.
    ...
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 368 :fork_and_knife: 80 - Browser user agent parser.
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - :star: 1998 :fork_and_knife: 281 - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
    ...
    * [:octocat: python-docx](https://github.com/python-openxml/python-docx) - :star: 555 :fork_and_knife: 221 - Reads, queries and modifies Microsoft Word 2007/2008 docx files.
    * [:octocat: unoconv](https://github.com/dagwieers/unoconv) - :star: 740 :fork_and_knife: 220 - Convert between any document format supported by LibreOffice/OpenOffice.
    ...
    * [:octocat: xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - :star: 526 :fork_and_knife: 179 - Writing and reading data and formatting information from Excel files.
* PDF
    * [:octocat: PDFMiner](https://github.com/euske/pdfminer) - :star: 1591 :fork_and_knife: 427 - A tool for extracting information from PDF documents.
    * [:octocat: PyPDF2](https://github.com/mstamy2/PyPDF2) - :star: 1009 :fork_and_knife: 302 - A library capable of splitting, merging and transforming PDF pages.
    * [:earth_americas: ReportLab](http://www.reportlab.com/opensource/) - Allowing Rapid creation of rich PDF documents.
* Markdown
    * [:octocat: Mistune](https://github.com/lepture/mistune) - :star: 690 :fork_and_knife: 61 - Fastest and full featured pure Python parsers of Markdown.
    * [:octocat: Python-Markdown](https://github.com/waylan/Python-Markdown) - :star: 894 :fork_and_knife: 248 - A Python implementation of John Gruber’s Markdown.
* YAML
    * [:earth_americas: PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [:octocat: csvkit](https://github.com/onyxfish/csvkit) - :star: 2215 :fork_and_knife: 322 - Utilities for converting to and working with CSV.
* Archive
...
* [:octocat: jieba](https://github.com/fxsjy/jieba) - :star: 5591 :fork_and_knife: 1771 - Chinese Words Segmentation Utilities.
* [:octocat: langid.py](https://github.com/saffsd/langid.py) - :star: 603 :fork_and_knife: 112 - Stand-alone language identification system.
* [:earth_americas: Pattern](http://www.clips.ua.ac.be/pattern) - A web mining module for the Python.
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - :star: 1403 :fork_and_knife: 409 - A library for processing Chinese text.
...
* [:earth_americas: Sphinx](http://sphinx-doc.org/) - Python Documentation generator.
    * [:octocat: awesome-sphinxdoc](https://github.com/yoloseem/awesome-sphinxdoc) - :star: 176 :fork_and_knife: 14
...
* Command-line Application Development
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - :star: 2031 :fork_and_knife: 185 - Python Command-line Application Tools.
    ...
    * [:octocat: Gooey](https://github.com/chriskiehl/Gooey) - :star: 4131 :fork_and_knife: 207 - Turn command line programs into a full GUI application with one line
    ...
    * [:octocat: python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) - :star: 2803 :fork_and_knife: 140 - A Library for building powerful interactive command lines.
* Productivity Tools
    * [:octocat: bashplotlib](https://github.com/glamp/bashplotlib) - :star: 581 :fork_and_knife: 46 - Making basic plots in the terminal. It's a quick way to visualize data without GUI.
    ...
    * [:octocat: cookiecutter](https://github.com/audreyr/cookiecutter) - :star: 3565 :fork_and_knife: 433 - A command-line utility that creates projects from cookiecutters (project templates). E.g. Python package projects, jQuery plugin projects.
    * [:octocat: doitlive](https://github.com/sloria/doitlive) - :star: 722 :fork_and_knife: 23 - A tool for live presentations in the terminal.
    * [:octocat: httpie](https://github.com/jakubroztocil/httpie) - :star: 24429 :fork_and_knife: 1521 - A command line HTTP client, a user-friendly cURL replacement.
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 2921 :fork_and_knife: 166 - Select files out of bash output.
    * [:octocat: percol](https://github.com/mooz/percol) - :star: 2094 :fork_and_knife: 96 - Adds flavor of interactive selection to the traditional pipe concept on UNIX.
    * [:earth_americas: RainbowStream](http://www.rainbowstream.org/) - Smart and nice Twitter client on terminal.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - :star: 21112 :fork_and_knife: 1014 - Correcting your previous console command.

## Downloader

*Libraries for downloading.*

* [:octocat: coursera](https://github.com/coursera-dl/coursera) - :star: 4354 :fork_and_knife: 1234 - Script for downloading Coursera.org videos and naming them.
* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - :star: 1915 :fork_and_knife: 596 - A command line tool for managing Amazon S3 and CloudFront.
* [:octocat: s4cmd](https://github.com/bloomreach/s4cmd) - :star: 428 :fork_and_knife: 86 - Super S3 command line tool, good for higher performance.
* [:octocat: subliminal](https://github.com/Diaoul/subliminal) - :star: 1018 :fork_and_knife: 209 - Library and command line tool to search and download subtitles.
...
* [:octocat: nude.py](https://github.com/hhatto/nude.py) - :star: 376 :fork_and_knife: 57 - Nudity detection.
...
* [:octocat: python-qrcode](https://github.com/lincolnloop/python-qrcode) - :star: 903 :fork_and_knife: 203 - A pure Python QR Code generator.
* [:octocat: Quads](https://github.com/fogleman/Quads) - :star: 571 :fork_and_knife: 50 - Computer art based on quadtrees.
* [:earth_americas: scikit-image](http://scikit-image.org/) - A Python library for (scientific) image processing.
* [:octocat: thumbor](https://github.com/thumbor/thumbor) - :star: 4011 :fork_and_knife: 403 - A smart imaging service. It enables on-demand crop, re-sizing and flipping of images.
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 581 :fork_and_knife: 134 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.

## OCR

*Libraries for Optical Character Recognition.*

* [:octocat: pyocr](https://github.com/jflesch/pyocr) - :star: 317 :fork_and_knife: 58 - A wrapper for Tesseract and Cuneiform.
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - :star: 478 :fork_and_knife: 99 - Another wrapper for Google Tesseract OCR.
...
* [:octocat: audioread](https://github.com/sampsyo/audioread) - :star: 98 :fork_and_knife: 36 - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding.
* [:earth_americas: beets](http://beets.radbox.org/) - A music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - :star: 2152 :fork_and_knife: 406 - Audio fingerprinting and recognition.
...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 176 :fork_and_knife: 79 - A module for parsing m3u8 file.
* [:earth_americas: mutagen](https://bitbucket.org/lazka/mutagen) - A Python module to handle audio metadata.
* [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 1443 :fork_and_knife: 153 - Manipulate audio with a simple and easy high level interface.
* [:octocat: pyechonest](https://github.com/echonest/pyechonest) - :star: 575 :fork_and_knife: 1167 - Python client for the [Echo Nest](http://developer.echonest.com/docs/) API.
* [:earth_americas: talkbox](http://scikits.appspot.com/talkbox) - A Python library for speech/signal processing.
* [:octocat: TimeSide](https://github.com/yomguy/TimeSide) - :star: 2 :fork_and_knife: 0 - Open web audio processing framework.
...
* [:octocat: geopy](https://github.com/geopy/geopy) - :star: 1121 :fork_and_knife: 274 - Python Geocoding Toolbox.
* [:octocat: pygeoip](https://github.com/appliedsec/pygeoip) - :star: 420 :fork_and_knife: 88 - Pure Python GeoIP API.
...
* [:octocat: grequests](https://github.com/kennethreitz/grequests) - :star: 1499 :fork_and_knife: 175 - requests + gevent for asynchronous HTTP requests.
* [:octocat: httplib2](https://github.com/jcgregorio/httplib2) - :star: 366 :fork_and_knife: 190 - Comprehensive HTTP client library.
...
* [:octocat: urllib3](https://github.com/shazow/urllib3) - :star: 1071 :fork_and_knife: 358 - A HTTP library with thread-safe connection pooling, file post support, sanity friendly.
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - :star: 1054 :fork_and_knife: 68 - A tiny, document-oriented database.
...
* Relational Databases
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 2264 :fork_and_knife: 128 - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL.
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - :star: 350 :fork_and_knife: 51 - mysql-python fork supporting Python 3.
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - :star: 1812 :fork_and_knife: 420 - Pure Python MySQL driver compatible to mysql-python.
    * [:octocat: queries](https://github.com/gmr/queries) - :star: 147 :fork_and_knife: 13 - A wrapper of the psycopg2 library for interacting with PostgreSQL.
    * [:earth_americas: txpostgres](http://txpostgres.readthedocs.org/) - Twisted based asynchronous driver for PostgreSQL.
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - :star: 524 :fork_and_knife: 248 - Python driver for Cassandra.
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - :star: 4243 :fork_and_knife: 1074 - The Redis Python Client.
...
* Relational Databases
    ...
    * [:earth_americas: SQLAlchemy](http://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
        * [:octocat: awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) - :star: 1149 :fork_and_knife: 73
    * [:octocat: peewee](https://github.com/coleifer/peewee) - :star: 2945 :fork_and_knife: 542 - A small, expressive ORM.
    * [:earth_americas: PonyORM](http://ponyorm.com) - ORM that provides a generator-oriented interface to SQL.
* NoSQL Databases
    * [:octocat: django-mongodb-engine](https://github.com/django-nonrel/mongodb-engine) - :star: 653 :fork_and_knife: 187 - Django MongoDB Backend.
    * [:octocat: PynamoDB](https://github.com/jlafon/PynamoDB) - :star: 207 :fork_and_knife: 61 - A Pythonic interface for [Amazon DynamoDB](https://aws.amazon.com/dynamodb/).
    * [:octocat: flywheel](https://github.com/mathcamp/flywheel) - :star: 63 :fork_and_knife: 8 - Object mapper for Amazon DynamoDB.
    * [:earth_americas: MongoEngine](http://mongoengine.org/) - A Python Object-Document-Mapper for working with MongoDB.
    * [:octocat: hot-redis](https://github.com/stephenmcd/hot-redis) - :star: 188 :fork_and_knife: 13 - Rich Python data types for Redis.
    * [:octocat: redisco](https://github.com/kiddouk/redisco) - :star: 310 :fork_and_knife: 59 - A Python Library for Simple Models and Containers Persisted in Redis.
* Others
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 3939 :fork_and_knife: 682
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 2620 :fork_and_knife: 416
...
* [:octocat: django-guardian](https://github.com/lukaszb/django-guardian) - :star: 1167 :fork_and_knife: 319 - Implementation of per object permissions for Django 1.2+
* [:octocat: django-rules](https://github.com/dfunckt/django-rules) - :star: 314 :fork_and_knife: 19 - A tiny but powerful app providing object-level permissions to Django, without requiring a database.
...
* [:octocat: Cartridge](https://github.com/stephenmcd/cartridge) - :star: 468 :fork_and_knife: 229 - A shopping cart app built using the Mezzanine.
* [:earth_americas: shoop](https://www.shoop.io/) - An open source E-Commerce platform based on Django.
* [:octocat: alipay](https://github.com/lxneng/alipay) - :star: 148 :fork_and_knife: 47 - Unofficial Alipay API for Python.
* [:octocat: merchant](https://github.com/agiliq/merchant) - :star: 835 :fork_and_knife: 147 - A Django app to accept payments from various payment processors.
* [:octocat: money](https://github.com/carlospalol/money) - :star: 76 :fork_and_knife: 8 - Money class with optional CLDR-backed locale-aware formatting and an extensible currency exchange solution.
...
* [:octocat: eve](https://github.com/nicolaiarocci/eve) - :star: 3348 :fork_and_knife: 449 - REST API framework powered by Flask, MongoDB and good intentions.
* [:octocat: sandman](https://github.com/jeffknupp/sandman) - :star: 2229 :fork_and_knife: 181 - Automated REST APIs for existing database-driven systems.
...
* [:octocat: ripozo](https://github.com/vertical-knowledge/ripozo) - :star: 158 :fork_and_knife: 18 - Quickly creating REST/HATEOAS/Hypermedia APIs with extensions for Flask and Django.
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - :star: 2453 :fork_and_knife: 893 - Authentication app for Django that "just works."
    * [:octocat: django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) - :star: 783 :fork_and_knife: 238 - OAuth2 goodies for the Djangonauts.
    * [:octocat: django-oauth2-provider](https://github.com/caffeinehit/django-oauth2-provider) - :star: 296 :fork_and_knife: 239 - Providing OAuth2 access to Django app.
    * [:octocat: Flask-OAuthlib](https://github.com/lepture/flask-oauthlib) - :star: 725 :fork_and_knife: 206 - OAuth 1.0/a, 2.0 implementation of client and provider for Flask.
    * [:octocat: OAuthLib](https://github.com/idan/oauthlib) - :star: 1165 :fork_and_knife: 260 - A generic and thorough implementation of the OAuth request-signing logic.
    * [:octocat: python-oauth2](https://github.com/simplegeo/python-oauth2) - :star: 2438 :fork_and_knife: 954 - A fully tested, abstract interface to creating OAuth clients and servers.
    * [:octocat: python-social-auth](https://github.com/omab/python-social-auth) - :star: 2352 :fork_and_knife: 1011 - An easy-to-setup social authentication mechanism.
    * [:octocat: rauth](https://github.com/litl/rauth) - :star: 1429 :fork_and_knife: 148 - A Python library for OAuth 1.0/a, 2.0, and Ofly.
...
* Others
    * [:octocat: jose](https://github.com/demonware/jose) - :star: 49 :fork_and_knife: 17 - JavaScript Object Signing and Encryption draft implementation.
    * [:octocat: PyJWT](https://github.com/progrium/pyjwt) - :star: 855 :fork_and_knife: 131 - Implementation of the JSON Web Token draft 01.
...
* [:octocat: Jinja2](https://github.com/mitsuhiko/jinja2) - :star: 3431 :fork_and_knife: 692 - A modern and designer friendly templating language.
...
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 933 :fork_and_knife: 99 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 398 :fork_and_knife: 29 - Mr. Queue - A distributed worker task queue in Python using Redis & gevent.
...
* [:octocat: django-haystack](https://github.com/toastdriven/django-haystack) - :star: 2015 :fork_and_knife: 895 - Modular search for Django.
...
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - :star: 876 :fork_and_knife: 210 - The official high-level Python client for Elasticsearch.
...
* [:octocat: django-activity-stream](https://github.com/justquick/django-activity-stream) - :star: 1038 :fork_and_knife: 315 - Generate generic activity streams from the actions on your site.
* [:octocat: Feedly](https://github.com/tschellenbach/Feedly) - :star: 2275 :fork_and_knife: 278 - A library to build newsfeed and notification systems using Cassandra and Redis.

## Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 1692 :fork_and_knife: 490 - Compresses linked and inline JavaScript or CSS into a single cached file.
...
* [:octocat: django-cache-machine](https://github.com/jbalogh/django-cache-machine) - :star: 626 :fork_and_knife: 126 - Automatic caching and invalidation for Django models.
...
* [:octocat: flanker](https://github.com/mailgun/flanker) - :star: 938 :fork_and_knife: 89 - A email address and Mime parsing library.
* [:octocat: imbox](https://github.com/martinrusev/imbox) - :star: 634 :fork_and_knife: 83 - Python IMAP for Humans.
* [:octocat: inbox.py](https://github.com/kennethreitz/inbox.py) - :star: 1225 :fork_and_knife: 81 - Python SMTP Server for Humans.
* [:octocat: inbox](https://github.com/inboxapp/inbox) - :star: 3014 :fork_and_knife: 277 - The open source email toolkit.
* [:octocat: lamson](https://github.com/zedshaw/lamson) - :star: 552 :fork_and_knife: 155 - Pythonic SMTP Application Server.
...
* [:octocat: modoboa](https://github.com/tonioo/modoboa) - :star: 548 :fork_and_knife: 85 - A mail hosting and management platform including a modern and simplified Web UI.
* [:earth_americas: pyzmail](http://www.magiksys.net/pyzmail/) - Compose, send and parse emails.
* [:octocat: Talon](https://github.com/mailgun/talon) - :star: 568 :fork_and_knife: 80 - Mailgun library to extract message quotations and signatures.
...
* [:octocat: furl](https://github.com/gruns/furl) - :star: 922 :fork_and_knife: 60 - A small Python library that makes manipulating URLs simple.
...
* [:octocat: pyshorteners](https://github.com/ellisonleao/pyshorteners) - :star: 121 :fork_and_knife: 20 - A pure Python URL shortening lib.
* [:octocat: short_url](https://github.com/Alir3z4/python-short_url) - :star: 51 :fork_and_knife: 9 - Python implementation for generating Tiny URL and bit.ly-like URLs.
* [:octocat: webargs](https://github.com/sloria/webargs) - :star: 344 :fork_and_knife: 45 - A friendly library for parsing HTTP request arguments, with built-in support for popular web frameworks, including Flask, Django, Bottle, Tornado, and Pyramid.
...
* [:octocat: MarkupSafe](https://github.com/mitsuhiko/markupsafe) - :star: 129 :fork_and_knife: 49 - Implements a XML/HTML/XHTML Markup safe string for Python.
* [:octocat: pyquery](https://github.com/gawel/pyquery) - :star: 978 :fork_and_knife: 93 - A jQuery-like library for parsing HTML.
* [:octocat: untangle](https://github.com/stchris/untangle) - :star: 169 :fork_and_knife: 22 - Converts XML documents to Python objects for easy access.
* [:octocat: xhtml2pdf](https://github.com/chrisglass/xhtml2pdf) - :star: 1152 :fork_and_knife: 414 - HTML/CSS to PDF converter.
* [:octocat: xmltodict](https://github.com/martinblech/xmltodict) - :star: 2061 :fork_and_knife: 203 - Working with XML feel like you are working with JSON.
...
* [:octocat: cola](https://github.com/chineking/cola) - :star: 952 :fork_and_knife: 459 - A distributed crawling framework.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 1375 :fork_and_knife: 70 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 4382 :fork_and_knife: 640 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 7105 :fork_and_knife: 1804 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 2457 :fork_and_knife: 164 - A simple, Pythonic library for browsing the web without a standalone web browser.

## Web Content Extracting

*Libraries for extracting web contents.*

* [:octocat: Haul](https://github.com/vinta/Haul) - :star: 71 :fork_and_knife: 18 - An Extensible Image Crawler.
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 256 :fork_and_knife: 55 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 308 :fork_and_knife: 19 - Web Content Retrieval for Humans.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 3383 :fork_and_knife: 471 - News extraction, article extraction and content curation in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 1977 :fork_and_knife: 476 - HTML Content/Article Extractor.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 967 :fork_and_knife: 196 - Fast Python port of arc90's readability tool.
* [:octocat: sanitize](https://github.com/Alir3z4/sanitize) - :star: 20 :fork_and_knife: 1 - Bringing sanity to world of messed-up data.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 588 :fork_and_knife: 123 - A module for automatic summarization of text documents and HTML pages.
...
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - :star: 1432 :fork_and_knife: 460 - Bootstrap 3 integration with Django.
...
* [:octocat: schema](https://github.com/halst/schema) - :star: 877 :fork_and_knife: 79 - A library for validating Python data structures.
* [:octocat: Schematics](https://github.com/schematics/schematics) - :star: 1592 :fork_and_knife: 201 - Data Structure Validation.
...
* [:octocat: voluptuous](https://github.com/alecthomas/voluptuous) - :star: 622 :fork_and_knife: 95 - A Python data validation library. It is primarily intended for validating data coming into Python as JSON, YAML, etc.

## Anti-spam

*Libraries for fighting spam.*

* [:octocat: django-simple-captcha](https://github.com/mbi/django-simple-captcha) - :star: 368 :fork_and_knife: 151 - A simple and highly customizable Django app to add captcha images to any Django form.
...
* [:octocat: django-taggit](https://github.com/alex/django-taggit) - :star: 1480 :fork_and_knife: 407 - Simple tagging for Django.

## Admin Panels

*Libraries for administrative interfaces.*

* [:octocat: Ajenti](https://github.com/Eugeny/ajenti) - :star: 172 :fork_and_knife: 34 - The admin panel your servers deserve.
* [:earth_americas: django-suit](http://djangosuit.com/) - Alternative Django Admin-Interface (free only for Non-commercial use).
* [:octocat: django-xadmin](https://github.com/sshwsfc/django-xadmin) - :star: 1664 :fork_and_knife: 520 - Drop-in replacement of Django admin comes with lots of goodies.
* [:octocat: flask-admin](https://github.com/mrjoes/flask-admin) - :star: 56 :fork_and_knife: 26 - Simple and extensible administrative interface framework for Flask.
* [:octocat: flower](https://github.com/mher/flower) - :star: 1782 :fork_and_knife: 342 - Real-time monitor and web admin for Celery.
* [:earth_americas: Grappelli](http://grappelliproject.com) – A jazzy skin for the Django Admin-Interface.
* [:octocat: Wooey](https://github.com/wooey/wooey) - :star: 650 :fork_and_knife: 55 - A Django app which creates automatic web UIs for Python scripts.
...
* [:octocat: envoy](https://github.com/kennethreitz/envoy) - :star: 1704 :fork_and_knife: 111 - Python [subprocess](https://docs.python.org/2/library/subprocess.html) for Humans™.
* [:earth_americas: sarge](http://sarge.readthedocs.org/) - Yet another wrapper for subprocess.
* [:octocat: sh](https://github.com/amoffat/sh) - :star: 3403 :fork_and_knife: 286 - A full-fledged subprocess replacement for Python.
...
* [:octocat: gevent](http://www.gevent.org/) - :star: 645 :fork_and_knife: 119 - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
* [:octocat: Tomorrow](https://github.com/madisonmay/Tomorrow) - :star: 1142 :fork_and_knife: 67 - Magic decorator syntax for asynchronous code.
...
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - :star: 1277 :fork_and_knife: 91 - Event-driven concurrent framework for Python.
* [:octocat: diesel](https://github.com/jamwt/diesel) - :star: 536 :fork_and_knife: 52 - Greenlet-based event I/O Framework for Python.
...
* [:octocat: AutobahnPython](https://github.com/tavendo/AutobahnPython) - :star: 1175 :fork_and_knife: 381 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 973 :fork_and_knife: 131 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 898 :fork_and_knife: 183 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 692 :fork_and_knife: 172 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* [:octocat: SimpleJSONRPCServer](https://github.com/joshmarshall/jsonrpclib/) - :star: 270 :fork_and_knife: 109 - This library is an implementation of the JSON-RPC specification.
...
* [:octocat: zeroRPC](https://github.com/dotcloud/zerorpc-python) - :star: 1728 :fork_and_knife: 212 - zerorpc is a flexible RPC implementation based on [ZeroMQ](http://zeromq.org/) and [MessagePack](http://msgpack.org/).
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 449 :fork_and_knife: 40 - Implementation of [hashids](http://hashids.org) in Python.
...
* [:octocat: enaml](https://github.com/nucleic/enaml) - :star: 461 :fork_and_knife: 63 - Creating beautiful user-interfaces with Declaratic Syntax like QML.
...
* [:octocat: Toga](https://github.com/pybee/toga) - :star: 815 :fork_and_knife: 61 - A Python native, OS native GUI toolkit.
...
* Testing Frameworks
    ...
    * [:octocat: hypothesis](https://github.com/DRMacIver/hypothesis) - :star: 1359 :fork_and_knife: 129 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 525 :fork_and_knife: 76 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    ...
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 1011 :fork_and_knife: 381 - A generic test automation framework.
* Web Testing
    ...
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 3761 :fork_and_knife: 535 - Scalable user load testing tool written in Python.
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1104 :fork_and_knife: 113 - A language-agnostic A/B Testing framework.
...
* Mock
    ...
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 767 :fork_and_knife: 83 - Travel through time by mocking the datetime module.
    * [:octocat: httmock](https://github.com/patrys/httmock) - :star: 252 :fork_and_knife: 26 - A mocking library for requests for Python 2.6+ and 3.2+.
    * [:earth_americas: httpretty](http://falcao.it/HTTPretty/) - HTTP request mock tool for Python.
    * [:octocat: responses](https://github.com/dropbox/responses) - :star: 1254 :fork_and_knife: 119 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 713 :fork_and_knife: 107 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - :star: 934 :fork_and_knife: 128 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 317 :fork_and_knife: 34 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
    * [:octocat: model_mommy](https://github.com/vandersonmota/model_mommy) - :star: 583 :fork_and_knife: 133 - Creating random fixtures for testing in Django.
* Code Coverage
...
* Fake Data
    ...
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 1661 :fork_and_knife: 79 - Fake database generator.
    * [:earth_americas: radar](https://pypi.python.org/pypi/radar) - Generate random datetime / time.
* Error Handler
    * [:octocat: FuckIt.py](https://github.com/ajalt/fuckitpy) - :star: 2087 :fork_and_knife: 89 - FuckIt.py uses state-of-the-art technology to make sure your Python code runs whether it has any right to or not.
...
* Code Analysis
    * [:octocat: code2flow](https://github.com/scottrogowski/code2flow) - :star: 259 :fork_and_knife: 32 - Turn your Python and JavaScript code into DOT flowcharts.
    * [:octocat: pycallgraph](https://github.com/gak/pycallgraph) - :star: 649 :fork_and_knife: 105 - A library that visualises the flow (call graph) of your Python application.
...
* Debugger
    ...
    * [:octocat: pyringe](https://github.com/google/pyringe) - :star: 1361 :fork_and_knife: 48 - Debugger capable of attaching to and injecting code into Python processes.
    * [:octocat: wdb](https://github.com/Kozea/wdb) - :star: 1005 :fork_and_knife: 51 - An improbable web debugger through WebSockets.
    ...
    * [:octocat: django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) - :star: 3672 :fork_and_knife: 681 - Display various debug information about the current request/response.
    * [:octocat: django-devserver](https://github.com/dcramer/django-devserver) - :star: 1150 :fork_and_knife: 145 - A drop-in replacement for Django's runserver.
    * [:octocat: flask-debugtoolbar](https://github.com/mgood/flask-debugtoolbar) - :star: 471 :fork_and_knife: 74 - A port of the django-debug-toolbar to flask.
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - :star: 869 :fork_and_knife: 66 - Line-by-line profiling.
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 792 :fork_and_knife: 104 - Monitor Memory usage of Python code.
    * [:octocat: profiling](https://github.com/what-studio/profiling) - :star: 2414 :fork_and_knife: 83 - An interactive Python profiler.
* Others
    * [:octocat: pyelftools](https://github.com/eliben/pyelftools) - :star: 331 :fork_and_knife: 121 - A pure-Python library for parsing and analyzing ELF files and DWARF debugging information.
...
* [:octocat: bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) - :star: 321 :fork_and_knife: 167 - A toolkit providing best-practice pipelines for fully automated high throughput sequencing analysis.
* [:octocat: bccb](https://github.com/chapmanb/bcbb) - :star: 307 :fork_and_knife: 154 - Collection of useful code related to biological analysis.
...
* [:octocat: Open Mining](https://github.com/avelino/mining) - :star: 591 :fork_and_knife: 98 - Business Intelligence (BI) in Python (Pandas web interface)
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - :star: 1541 :fork_and_knife: 350 - Markov Chain Monte Carlo sampling toolkit.
...
* [:octocat: statsmodels](https://github.com/statsmodels/statsmodels) - :star: 1530 :fork_and_knife: 750 - Statistical modeling and econometrics in Python.
* [:octocat: SymPy](https://github.com/sympy/sympy) - :star: 2969 :fork_and_knife: 1493 - A Python library for symbolic mathematics.
* [:octocat: zipline](https://github.com/quantopian/zipline) - :star: 3400 :fork_and_knife: 1061 - A Pythonic algorithmic trading library.
...
* [:octocat: bokeh](https://github.com/ContinuumIO/bokeh) - :star: 4393 :fork_and_knife: 957 - Interactive Web Plotting for Python.
* [:octocat: ggplot](https://github.com/yhat/ggplot) - :star: 2614 :fork_and_knife: 347 - Same API as ggplot2 for R.
...
* [:octocat: vincent](https://github.com/wrobstory/vincent) - :star: 1889 :fork_and_knife: 197 - A Python to Vega translator.
...
* [:octocat: Crab](https://github.com/muricoca/crab) - :star: 706 :fork_and_knife: 260 - A ﬂexible, fast recommender engine.
* [:octocat: gensim](https://github.com/piskvorky/gensim) - :star: 2720 :fork_and_knife: 987 - Topic Modelling for Humans.
* [:octocat: hebel](https://github.com/hannes-brt/hebel) - :star: 1142 :fork_and_knife: 106 - GPU-Accelerated Deep Learning Library in Python.
* [:octocat: NuPIC](https://github.com/numenta/nupic) - :star: 4285 :fork_and_knife: 1199 - Numenta Platform for Intelligent Computing.
* [:octocat: pattern](https://github.com/clips/pattern) - :star: 4599 :fork_and_knife: 813 - Web mining module for Python.
* [:octocat: PyBrain](https://github.com/pybrain/pybrain) - :star: 1863 :fork_and_knife: 587 - Another Python Machine Learning Library.
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - :star: 2131 :fork_and_knife: 875 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano).
* [:octocat: python-recsys](https://github.com/ocelma/python-recsys) - :star: 601 :fork_and_knife: 266 - A Python library for implementing a Recommender System.
* [:earth_americas: scikit-learn](http://scikit-learn.org/) - A Python module for machine learning built on top of SciPy.
* [:octocat: vowpal_porpoise](https://github.com/josephreisinger/vowpal_porpoise) - :star: 122 :fork_and_knife: 30 - A lightweight Python wrapper for [Vowpal Wabbit](https://github.com/JohnLangford/vowpal_wabbit/).

## MapReduce

*Framworks and libraries for MapReduce.*

* [:octocat: dpark](https://github.com/douban/dpark) - :star: 1807 :fork_and_knife: 429 - Python clone of Spark, a MapReduce alike framework in Python.
...
* [:octocat: luigi](https://github.com/spotify/luigi) - :star: 4914 :fork_and_knife: 957 - A module that helps you build complex pipelines of batch jobs.
* [:octocat: mrjob](https://github.com/Yelp/mrjob) - :star: 1848 :fork_and_knife: 463 - Run MapReduce jobs on Hadoop or Amazon Web Services.
* [:earth_americas: PySpark](http://spark.apache.org/docs/latest/programming-guide.html) - The Spark Python API.
* [:octocat: streamparse](https://github.com/Parsely/streamparse) - :star: 1010 :fork_and_knife: 145 - Run Python code against real-time streams of data. Integrates with [Apache Storm](https://storm.incubator.apache.org/).

## Functional Programming

*Functional Programming with Python.*

* [:octocat: CyToolz](https://github.com/pytoolz/cytoolz/) - :star: 270 :fork_and_knife: 22 - Cython implementation of Toolz: High performance functional utilities.
* [:octocat: fn.py](https://github.com/kachayev/fn.py) - :star: 1974 :fork_and_knife: 126 - Functional programming in Python: implementation of missing features to enjoy FP.
* [:octocat: funcy](https://github.com/Suor/funcy) - :star: 1304 :fork_and_knife: 64 - A fancy and practical functional tools.
* [:octocat: Toolz](https://github.com/pytoolz/toolz) - :star: 1144 :fork_and_knife: 95 - A collection of functional utilities for iterators, functions, and dictionaries.
...
* [:octocat: boto](https://github.com/boto/boto) - :star: 5540 :fork_and_knife: 2029 - Python interface to Amazon Web Services.
...
* [:octocat: facebook-sdk](https://github.com/pythonforfacebook/facebook-sdk) - :star: 1710 :fork_and_knife: 649 - Facebook Platform Python SDK.
* [:octocat: facepy](https://github.com/jgorset/facepy) - :star: 499 :fork_and_knife: 146 - Facepy makes it really easy to interact with Facebook's Graph API
* [:octocat: gmail](https://github.com/charlierguo/gmail) - :star: 1279 :fork_and_knife: 232 - A Pythonic interface for Gmail.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 1032 :fork_and_knife: 449 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 1760 :fork_and_knife: 334 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1199 :fork_and_knife: 310 - A Python wrapper for the Twitter API.

## DevOps Tools

*Software and libraries for DevOps.*

* [:octocat: Ansible](https://github.com/ansible/ansible) - :star: 17795 :fork_and_knife: 5374 - A radically simple IT automation platform.
* [:octocat: SaltStack](https://github.com/saltstack/salt) - :star: 6697 :fork_and_knife: 3010 - Infrastructure automation and management system.
* [:earth_americas: Fabric](http://www.fabfile.org/) - A simple, Pythonic tool for remote execution and deployment.
* [:octocat: cuisine](https://github.com/sebastien/cuisine) - :star: 1184 :fork_and_knife: 148 - Chef-like functionality for Fabric.
...
* [:octocat: Fabtools](https://github.com/ronnix/fabtools) - :star: 1016 :fork_and_knife: 202 - Tools for writing awesome Fabric files.
* [:earth_americas: gitapi](http://bitbucket.org/haard/gitapi) - Pure-Python API for git.
* [:octocat: gunnery](https://github.com/gunnery/gunnery) - :star: 598 :fork_and_knife: 54 - Multipurpose task execution tool for distributed systems with web-based interface.
* [:earth_americas: hgapi](http://bitbucket.org/haard/hgapi) - Pure-Python API for Mercurial.
* [:octocat: honcho](https://github.com/nickstenning/honcho) - :star: 793 :fork_and_knife: 92 - A Python port of [Foreman](https://github.com/ddollar/foreman), a tool for managing Procfile-based applications.
* [:earth_americas: OpenStack](http://www.openstack.org/) - Open source software for building private and public clouds.
* [:octocat: pexpect](https://github.com/pexpect/pexpect) - :star: 630 :fork_and_knife: 168 - Controlling interactive programs in a pseudo-terminal like GNU expect.
...
* [:octocat: psutil](https://github.com/giampaolo/psutil) - :star: 1691 :fork_and_knife: 285 - A cross-platform process and system utilities module.
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - :star: 2607 :fork_and_knife: 542 - Supervisor process control system for UNIX.
...
* [:octocat: django-schedule](https://github.com/thauber/django-schedule) - :star: 640 :fork_and_knife: 262 - A calendaring app for Django.
...
* [:octocat: Plan](https://github.com/fengsp/plan) - :star: 901 :fork_and_knife: 65 - Writing crontab file in Python like a charm.
* [:octocat: schedule](https://github.com/dbader/schedule) - :star: 2276 :fork_and_knife: 229 - Python job scheduling for humans.
* [:octocat: Spiff](https://github.com/knipknap/SpiffWorkflow) - :star: 343 :fork_and_knife: 84 - A powerful workflow engine implemented in pure Python.
...
* [:octocat: Pyston](https://github.com/dropbox/pyston) - :star: 3821 :fork_and_knife: 265 - A Python implementation built using LLVM and modern JIT techniques with the goal of achieving good performance.
...
* [:octocat: PythonNet](https://github.com/pythonnet/pythonnet) - :star: 201 :fork_and_knife: 73 - Python Integration with the .NET Common Language Runtime (CLR).
...
* [:octocat: PyUserInput](https://github.com/SavinaRoja/PyUserInput) - :star: 445 :fork_and_knife: 105 - A module for cross-platform control of the mouse and keyboard.
...
* [:octocat: blinker](https://github.com/jek/blinker) - :star: 365 :fork_and_knife: 43 - A fast Python in-process signal/event dispatching system.
* [:octocat: itsdangerous](https://github.com/mitsuhiko/itsdangerous) - :star: 941 :fork_and_knife: 83 - Various helpers to pass trusted data to untrusted environments.
...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - :star: 1540 :fork_and_knife: 408 - A module of algorithms for Python.
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - :star: 8772 :fork_and_knife: 2063 - A collection of design patterns in Python.
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - :star: 755 :fork_and_knife: 111 - Emacs Python Development Environment.
* Sublime Text
    * [:octocat: SublimeJEDI](https://github.com/srusskih/SublimeJEDI) - :star: 642 :fork_and_knife: 67 - A Sublime Text plugin to the awesome auto-complete library Jedi.
    * [:octocat: Anaconda](https://github.com/DamnWidget/anaconda) - :star: 1115 :fork_and_knife: 119 - Anaconda turns your Sublime Text 3 in a full featured Python development IDE.
* Vim
    * [:octocat: YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - :star: 11220 :fork_and_knife: 1305 - Includes [Jedi](https://github.com/davidhalter/jedi)-based completion engine for Python.
    * [:octocat: Jedi-vim](https://github.com/davidhalter/jedi-vim) - :star: 2396 :fork_and_knife: 216 - Vim bindings for the Jedi auto-completion library for Python.
    * [:octocat: Python-mode](https://github.com/klen/python-mode) - :star: 3067 :fork_and_knife: 632 - An all in one plugin for turning Vim into a Python IDE.
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - :star: 1154 :fork_and_knife: 303 - Python Tools for Visual Studio.
...
* [:octocat: Spyder](https://github.com/spyder-ide/spyder) - :star: 1188 :fork_and_knife: 297 - Open Source Python IDE.
...
* Python
    ...
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 231 :fork_and_knife: 41
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 1612 :fork_and_knife: 315
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 392 :fork_and_knife: 77
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 38132 :fork_and_knife: 4323
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 3860 :fork_and_knife: 277
