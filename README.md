...
* [:octocat: p](https://github.com/qw3rtman/p) - :star: 625 :fork_and_knife: 30 - Dead simple interactive Python version management.
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - :star: 5620 :fork_and_knife: 450 - Simple Python version management.
...
* [:octocat: conda](https://github.com/conda/conda/) - :star: 930 :fork_and_knife: 317 - Cross-platform, Python-agnostic binary package manager.
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - :star: 800 :fork_and_knife: 168 - Next generation Python Package Repository (PyPI).
...
* [:octocat: localshop](https://github.com/mvantellingen/localshop) - :star: 283 :fork_and_knife: 101 - Local PyPI server (custom packages and auto-mirroring of pypi).

## Distribution

*Libraries to create packaged executables for release distribution.*

* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - :star: 2163 :fork_and_knife: 521 - Converts Python programs into stand-alone executables (cross-platform).
...
* [:octocat: PlatformIO](https://github.com/ivankravets/platformio) - :star: 1336 :fork_and_knife: 199 - A console tool to build code with different development platforms.
* [:octocat: PyBuilder](https://github.com/pybuilder/pybuilder) - :star: 754 :fork_and_knife: 154 - A continuous build tool written in pure Python.
...
* [:octocat: IPython](https://github.com/ipython/ipython) - :star: 10416 :fork_and_knife: 3070 - A rich toolkit to help you make the most out of using Python interactively.
* [:earth_americas: bpython](http://bpython-interpreter.org) – A fancy interface to the Python interpreter.
* [:octocat: ptpython](https://github.com/jonathanslenders/ptpython) - :star: 1661 :fork_and_knife: 66 - Advanced Python REPL built on top of the [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - :star: 663 :fork_and_knife: 89 - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html).
...
* [:octocat: Unipath](https://github.com/mikeorr/Unipath) - :star: 391 :fork_and_knife: 33 - An object-oriented approach to file/directory operations.
* [:octocat: watchdog](https://github.com/gorakhargosh/watchdog) - :star: 2273 :fork_and_knife: 304 - API and shell utilities to monitor file system events.

## Date and Time

*Libraries for working with dates and times.*

* [:octocat: arrow](https://github.com/crsmithdev/arrow) - :star: 3380 :fork_and_knife: 290 - Better dates & times for Python.
...
* [:octocat: moment](https://github.com/zachwill/moment) - :star: 338 :fork_and_knife: 20 - A Python library for dealing with dates/times. Inspired by [Moment.js](http://momentjs.com/).
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 615 :fork_and_knife: 88 - Python 2/3 compatible character encoding detector.
    ...
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 1555 :fork_and_knife: 54 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 2758 :fork_and_knife: 290 - Fuzzy String Matching.
    ...
    * [:octocat: shortuuid](https://github.com/stochastic-technologies/shortuuid) - :star: 664 :fork_and_knife: 52 - A generator library for concise, unambiguous and URL-safe UUIDs.
...
* Slugify
    * [:octocat: awesome-slugify](https://github.com/dimka665/awesome-slugify) - :star: 306 :fork_and_knife: 18 - A Python slugify library that can preserve unicode.
    ...
    * [:octocat: unicode-slugify](https://github.com/mozilla/unicode-slugify) - :star: 225 :fork_and_knife: 39 - A slugifier that generates unicode slugs with Django as a dependency.
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 1331 :fork_and_knife: 174 - Parsing, formatting, storing and validating international phone numbers.
    ...
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 414 :fork_and_knife: 92 - Browser user agent parser.
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - :star: 2139 :fork_and_knife: 310 - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
    ...
    * [:octocat: python-docx](https://github.com/python-openxml/python-docx) - :star: 644 :fork_and_knife: 253 - Reads, queries and modifies Microsoft Word 2007/2008 docx files.
    * [:octocat: unoconv](https://github.com/dagwieers/unoconv) - :star: 818 :fork_and_knife: 232 - Convert between any document format supported by LibreOffice/OpenOffice.
    ...
    * [:octocat: xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - :star: 560 :fork_and_knife: 193 - Writing and reading data and formatting information from Excel files.
* PDF
    * [:octocat: PDFMiner](https://github.com/euske/pdfminer) - :star: 1765 :fork_and_knife: 487 - A tool for extracting information from PDF documents.
    * [:octocat: PyPDF2](https://github.com/mstamy2/PyPDF2) - :star: 1114 :fork_and_knife: 350 - A library capable of splitting, merging and transforming PDF pages.
    * [:earth_americas: ReportLab](http://www.reportlab.com/opensource/) - Allowing Rapid creation of rich PDF documents.
* Markdown
    * [:octocat: Mistune](https://github.com/lepture/mistune) - :star: 762 :fork_and_knife: 76 - Fastest and full featured pure Python parsers of Markdown.
    * [:octocat: Python-Markdown](https://github.com/waylan/Python-Markdown) - :star: 953 :fork_and_knife: 267 - A Python implementation of John Gruber’s Markdown.
* YAML
    * [:earth_americas: PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [:octocat: csvkit](https://github.com/onyxfish/csvkit) - :star: 2362 :fork_and_knife: 340 - Utilities for converting to and working with CSV.
* Archive
...
* [:octocat: jieba](https://github.com/fxsjy/jieba) - :star: 6428 :fork_and_knife: 2014 - Chinese Words Segmentation Utilities.
* [:octocat: langid.py](https://github.com/saffsd/langid.py) - :star: 645 :fork_and_knife: 119 - Stand-alone language identification system.
* [:earth_americas: Pattern](http://www.clips.ua.ac.be/pattern) - A web mining module for the Python.
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - :star: 1546 :fork_and_knife: 447 - A library for processing Chinese text.
...
* Command-line Application Development
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - :star: 2092 :fork_and_knife: 198 - Python Command-line Application Tools.
    ...
    * [:octocat: Gooey](https://github.com/chriskiehl/Gooey) - :star: 4309 :fork_and_knife: 226 - Turn command line programs into a full GUI application with one line
    ...
    * [:octocat: python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) - :star: 3070 :fork_and_knife: 185 - A Library for building powerful interactive command lines.
* Productivity Tools
    * [:octocat: bashplotlib](https://github.com/glamp/bashplotlib) - :star: 640 :fork_and_knife: 50 - Making basic plots in the terminal. It's a quick way to visualize data without GUI.
    ...
    * [:octocat: cookiecutter](https://github.com/audreyr/cookiecutter) - :star: 4001 :fork_and_knife: 482 - A command-line utility that creates projects from cookiecutters (project templates). E.g. Python package projects, jQuery plugin projects.
    * [:octocat: doitlive](https://github.com/sloria/doitlive) - :star: 748 :fork_and_knife: 22 - A tool for live presentations in the terminal.
    * [:octocat: httpie](https://github.com/jakubroztocil/httpie) - :star: 26697 :fork_and_knife: 1706 - A command line HTTP client, a user-friendly cURL replacement.
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 3062 :fork_and_knife: 186 - Select files out of bash output.
    * [:octocat: percol](https://github.com/mooz/percol) - :star: 2176 :fork_and_knife: 99 - Adds flavor of interactive selection to the traditional pipe concept on UNIX.
    * [:earth_americas: RainbowStream](http://www.rainbowstream.org/) - Smart and nice Twitter client on terminal.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - :star: 22476 :fork_and_knife: 1080 - Correcting your previous console command.
...
* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - :star: 2021 :fork_and_knife: 616 - A command line tool for managing Amazon S3 and CloudFront.
...
* [:octocat: subliminal](https://github.com/Diaoul/subliminal) - :star: 1086 :fork_and_knife: 210 - Library and command line tool to search and download subtitles.
...
* [:octocat: python-qrcode](https://github.com/lincolnloop/python-qrcode) - :star: 979 :fork_and_knife: 222 - A pure Python QR Code generator.
...
* [:octocat: thumbor](https://github.com/thumbor/thumbor) - :star: 4232 :fork_and_knife: 433 - A smart imaging service. It enables on-demand crop, re-sizing and flipping of images.
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 619 :fork_and_knife: 138 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.

## OCR

*Libraries for Optical Character Recognition.*

* [:octocat: pyocr](https://github.com/jflesch/pyocr) - :star: 375 :fork_and_knife: 74 - A wrapper for Tesseract and Cuneiform.
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - :star: 555 :fork_and_knife: 113 - Another wrapper for Google Tesseract OCR.
...
* [:octocat: audioread](https://github.com/sampsyo/audioread) - :star: 111 :fork_and_knife: 39 - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding.
* [:earth_americas: beets](http://beets.radbox.org/) - A music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - :star: 2648 :fork_and_knife: 482 - Audio fingerprinting and recognition.
...
* [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 1560 :fork_and_knife: 168 - Manipulate audio with a simple and easy high level interface.
* [:octocat: pyechonest](https://github.com/echonest/pyechonest) - :star: 583 :fork_and_knife: 1121 - Python client for the [Echo Nest](http://developer.echonest.com/docs/) API.
...
* [:octocat: geopy](https://github.com/geopy/geopy) - :star: 1252 :fork_and_knife: 302 - Python Geocoding Toolbox.
* [:octocat: pygeoip](https://github.com/appliedsec/pygeoip) - :star: 436 :fork_and_knife: 93 - Pure Python GeoIP API.
* [:octocat: django-countries](https://github.com/SmileyChris/django-countries) - :star: 294 :fork_and_knife: 94 - A Django app that provides country choices for use with forms, flag icons static files, and a country field for models.
...
* [:octocat: grequests](https://github.com/kennethreitz/grequests) - :star: 1672 :fork_and_knife: 197 - requests + gevent for asynchronous HTTP requests.
* [:octocat: httplib2](https://github.com/jcgregorio/httplib2) - :star: 366 :fork_and_knife: 201 - Comprehensive HTTP client library.
* [:octocat: treq](https://github.com/dreid/treq) - :star: 308 :fork_and_knife: 82 - Python requests like API built on top of Twisted's HTTP client.
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - :star: 1277 :fork_and_knife: 91 - A tiny, document-oriented database.
...
* Relational Databases
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 2514 :fork_and_knife: 144 - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL.
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - :star: 438 :fork_and_knife: 65 - mysql-python fork supporting Python 3.
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - :star: 2098 :fork_and_knife: 484 - Pure Python MySQL driver compatible to mysql-python.
...
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - :star: 588 :fork_and_knife: 270 - Python driver for Cassandra.
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - :star: 4539 :fork_and_knife: 1147 - The Redis Python Client.
...
* Relational Databases
    ...
    * [:earth_americas: SQLAlchemy](http://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
        * [:octocat: awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) - :star: 1218 :fork_and_knife: 81
    * [:octocat: peewee](https://github.com/coleifer/peewee) - :star: 3255 :fork_and_knife: 609 - A small, expressive ORM.
    * [:earth_americas: PonyORM](http://ponyorm.com) - ORM that provides a generator-oriented interface to SQL.
* NoSQL Databases
    * [:octocat: django-mongodb-engine](https://github.com/django-nonrel/mongodb-engine) - :star: 674 :fork_and_knife: 193 - Django MongoDB Backend.
    ...
    * [:octocat: flywheel](https://github.com/mathcamp/flywheel) - :star: 75 :fork_and_knife: 12 - Object mapper for Amazon DynamoDB.
...
* Others
    * [:octocat: butterdb](https://github.com/Widdershin/butterdb) - :star: 316 :fork_and_knife: 15 - A Python ORM for Google Drive Spreadsheets.
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 4459 :fork_and_knife: 790
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 3098 :fork_and_knife: 494
...
* [:octocat: django-rules](https://github.com/dfunckt/django-rules) - :star: 346 :fork_and_knife: 24 - A tiny but powerful app providing object-level permissions to Django, without requiring a database.
...
* [:octocat: Cartridge](https://github.com/stephenmcd/cartridge) - :star: 489 :fork_and_knife: 237 - A shopping cart app built using the Mezzanine.
* [:earth_americas: shoop](https://www.shoop.io/) - An open source E-Commerce platform based on Django.
* [:octocat: alipay](https://github.com/lxneng/alipay) - :star: 171 :fork_and_knife: 54 - Unofficial Alipay API for Python.
...
* [:octocat: eve](https://github.com/nicolaiarocci/eve) - :star: 3563 :fork_and_knife: 476 - REST API framework powered by Flask, MongoDB and good intentions.
* [:octocat: sandman](https://github.com/jeffknupp/sandman) - :star: 2254 :fork_and_knife: 182 - Automated REST APIs for existing database-driven systems.
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - :star: 2627 :fork_and_knife: 962 - Authentication app for Django that "just works."
    ...
    * [:octocat: Flask-OAuthlib](https://github.com/lepture/flask-oauthlib) - :star: 806 :fork_and_knife: 234 - OAuth 1.0/a, 2.0 implementation of client and provider for Flask.
    * [:octocat: OAuthLib](https://github.com/idan/oauthlib) - :star: 1247 :fork_and_knife: 270 - A generic and thorough implementation of the OAuth request-signing logic.
    ...
    * [:octocat: python-social-auth](https://github.com/omab/python-social-auth) - :star: 2523 :fork_and_knife: 1108 - An easy-to-setup social authentication mechanism.
    * [:octocat: rauth](https://github.com/litl/rauth) - :star: 1454 :fork_and_knife: 150 - A Python library for OAuth 1.0/a, 2.0, and Ofly.
...
* Others
    ...
    * [:octocat: PyJWT](https://github.com/progrium/pyjwt) - :star: 978 :fork_and_knife: 144 - Implementation of the JSON Web Token draft 01.
...
* [:octocat: Jinja2](https://github.com/mitsuhiko/jinja2) - :star: 3674 :fork_and_knife: 728 - A modern and designer friendly templating language.
...
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 1036 :fork_and_knife: 110 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 452 :fork_and_knife: 40 - Mr. Queue - A distributed worker task queue in Python using Redis & gevent.
...
* [:octocat: django-haystack](https://github.com/toastdriven/django-haystack) - :star: 2064 :fork_and_knife: 934 - Modular search for Django.
...
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - :star: 988 :fork_and_knife: 236 - The official high-level Python client for Elasticsearch.
...
* [:octocat: Feedly](https://github.com/tschellenbach/Feedly) - :star: 2524 :fork_and_knife: 310 - A library to build newsfeed and notification systems using Cassandra and Redis.

## Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 1760 :fork_and_knife: 491 - Compresses linked and inline JavaScript or CSS into a single cached file.
...
* [:octocat: imbox](https://github.com/martinrusev/imbox) - :star: 655 :fork_and_knife: 86 - Python IMAP for Humans.
* [:octocat: inbox.py](https://github.com/kennethreitz/inbox.py) - :star: 1256 :fork_and_knife: 86 - Python SMTP Server for Humans.
* [:octocat: inbox](https://github.com/inboxapp/inbox) - :star: 3163 :fork_and_knife: 314 - The open source email toolkit.
* [:octocat: lamson](https://github.com/zedshaw/lamson) - :star: 570 :fork_and_knife: 162 - Pythonic SMTP Application Server.
...
* [:octocat: modoboa](https://github.com/tonioo/modoboa) - :star: 623 :fork_and_knife: 92 - A mail hosting and management platform including a modern and simplified Web UI.
...
* [:octocat: furl](https://github.com/gruns/furl) - :star: 957 :fork_and_knife: 62 - A small Python library that makes manipulating URLs simple.
* [:octocat: purl](https://github.com/codeinthehole/purl) - :star: 170 :fork_and_knife: 21 - A simple, immutable URL class with a clean API for interrogation and manipulation.
...
* [:octocat: MarkupSafe](https://github.com/mitsuhiko/markupsafe) - :star: 138 :fork_and_knife: 48 - Implements a XML/HTML/XHTML Markup safe string for Python.
* [:octocat: pyquery](https://github.com/gawel/pyquery) - :star: 1052 :fork_and_knife: 98 - A jQuery-like library for parsing HTML.
...
* [:octocat: xmltodict](https://github.com/martinblech/xmltodict) - :star: 2175 :fork_and_knife: 213 - Working with XML feel like you are working with JSON.
...
* [:octocat: cola](https://github.com/chineking/cola) - :star: 1008 :fork_and_knife: 474 - A distributed crawling framework.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 1437 :fork_and_knife: 76 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 4580 :fork_and_knife: 677 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 7700 :fork_and_knife: 1996 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 2589 :fork_and_knife: 182 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 297 :fork_and_knife: 61 - Convert HTML to Markdown-formatted text.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 3652 :fork_and_knife: 533 - News extraction, article extraction and content curation in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 2160 :fork_and_knife: 520 - HTML Content/Article Extractor.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1040 :fork_and_knife: 205 - Fast Python port of arc90's readability tool.
* [:octocat: sanitize](https://github.com/Alir3z4/sanitize) - :star: 28 :fork_and_knife: 2 - Bringing sanity to world of messed-up data.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 699 :fork_and_knife: 143 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 1769 :fork_and_knife: 168 - Extract text from any document, Word, PowerPoint, PDFs, etc.
...
* [:octocat: schema](https://github.com/halst/schema) - :star: 933 :fork_and_knife: 87 - A library for validating Python data structures.
* [:octocat: Schematics](https://github.com/schematics/schematics) - :star: 1662 :fork_and_knife: 212 - Data Structure Validation.
...
* [:octocat: voluptuous](https://github.com/alecthomas/voluptuous) - :star: 690 :fork_and_knife: 107 - A Python data validation library. It is primarily intended for validating data coming into Python as JSON, YAML, etc.

## Anti-spam

*Libraries for fighting spam.*

* [:octocat: django-simple-captcha](https://github.com/mbi/django-simple-captcha) - :star: 393 :fork_and_knife: 159 - A simple and highly customizable Django app to add captcha images to any Django form.
...
* [:octocat: django-taggit](https://github.com/alex/django-taggit) - :star: 1528 :fork_and_knife: 416 - Simple tagging for Django.
...
* [:octocat: django-xadmin](https://github.com/sshwsfc/django-xadmin) - :star: 1739 :fork_and_knife: 548 - Drop-in replacement of Django admin comes with lots of goodies.
...
* [:octocat: flower](https://github.com/mher/flower) - :star: 1934 :fork_and_knife: 357 - Real-time monitor and web admin for Celery.
...
* [:octocat: envoy](https://github.com/kennethreitz/envoy) - :star: 1833 :fork_and_knife: 150 - Python [subprocess](https://docs.python.org/2/library/subprocess.html) for Humans™.
* [:earth_americas: sarge](http://sarge.readthedocs.org/) - Yet another wrapper for subprocess.
* [:octocat: sh](https://github.com/amoffat/sh) - :star: 3480 :fork_and_knife: 306 - A full-fledged subprocess replacement for Python.
...
* [:octocat: gevent](http://www.gevent.org/) - :star: 690 :fork_and_knife: 128 - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
...
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - :star: 1344 :fork_and_knife: 95 - Event-driven concurrent framework for Python.
...
* [:octocat: AutobahnPython](https://github.com/tavendo/AutobahnPython) - :star: 1274 :fork_and_knife: 402 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
...
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 935 :fork_and_knife: 195 - WebSockets for Django.
...
* [:octocat: SimpleJSONRPCServer](https://github.com/joshmarshall/jsonrpclib/) - :star: 283 :fork_and_knife: 111 - This library is an implementation of the JSON-RPC specification.
...
* [:octocat: zeroRPC](https://github.com/dotcloud/zerorpc-python) - :star: 1811 :fork_and_knife: 219 - zerorpc is a flexible RPC implementation based on [ZeroMQ](http://zeromq.org/) and [MessagePack](http://msgpack.org/).
...
* [:octocat: Toga](https://github.com/pybee/toga) - :star: 952 :fork_and_knife: 74 - A Python native, OS native GUI toolkit.
...
* Testing Frameworks
    ...
    * [:octocat: hypothesis](https://github.com/DRMacIver/hypothesis) - :star: 1601 :fork_and_knife: 146 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 645 :fork_and_knife: 99 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
...
* Web Testing
    ...
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 4172 :fork_and_knife: 601 - Scalable user load testing tool written in Python.
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1179 :fork_and_knife: 119 - A language-agnostic A/B Testing framework.
...
* Mock
    ...
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 847 :fork_and_knife: 90 - Travel through time by mocking the datetime module.
    * [:octocat: httmock](https://github.com/patrys/httmock) - :star: 263 :fork_and_knife: 28 - A mocking library for requests for Python 2.6+ and 3.2+.
    * [:earth_americas: httpretty](http://falcao.it/HTTPretty/) - HTTP request mock tool for Python.
    * [:octocat: responses](https://github.com/dropbox/responses) - :star: 1347 :fork_and_knife: 124 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 760 :fork_and_knife: 117 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - :star: 1009 :fork_and_knife: 143 - A test fixtures replacement for Python.
...
* Error Handler
    * [:octocat: FuckIt.py](https://github.com/ajalt/fuckitpy) - :star: 2154 :fork_and_knife: 89 - FuckIt.py uses state-of-the-art technology to make sure your Python code runs whether it has any right to or not.
...
* Code Analysis
    ...
    * [:octocat: pycallgraph](https://github.com/gak/pycallgraph) - :star: 709 :fork_and_knife: 114 - A library that visualises the flow (call graph) of your Python application.
...
* Debugger
    ...
    * [:octocat: django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) - :star: 3865 :fork_and_knife: 700 - Display various debug information about the current request/response.
...
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - :star: 1002 :fork_and_knife: 80 - Line-by-line profiling.
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 857 :fork_and_knife: 117 - Monitor Memory usage of Python code.
...
* [:octocat: bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) - :star: 359 :fork_and_knife: 179 - A toolkit providing best-practice pipelines for fully automated high throughput sequencing analysis.
...
* [:octocat: Open Mining](https://github.com/avelino/mining) - :star: 650 :fork_and_knife: 104 - Business Intelligence (BI) in Python (Pandas web interface)
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - :star: 1695 :fork_and_knife: 399 - Markov Chain Monte Carlo sampling toolkit.
...
* [:octocat: statsmodels](https://github.com/statsmodels/statsmodels) - :star: 1695 :fork_and_knife: 828 - Statistical modeling and econometrics in Python.
* [:octocat: SymPy](https://github.com/sympy/sympy) - :star: 3276 :fork_and_knife: 1628 - A Python library for symbolic mathematics.
* [:octocat: zipline](https://github.com/quantopian/zipline) - :star: 3871 :fork_and_knife: 1211 - A Pythonic algorithmic trading library.
...
* [:octocat: bokeh](https://github.com/ContinuumIO/bokeh) - :star: 4757 :fork_and_knife: 1099 - Interactive Web Plotting for Python.
* [:octocat: ggplot](https://github.com/yhat/ggplot) - :star: 2769 :fork_and_knife: 388 - Same API as ggplot2 for R.
...
* [:octocat: Crab](https://github.com/muricoca/crab) - :star: 743 :fork_and_knife: 283 - A ﬂexible, fast recommender engine.
* [:octocat: gensim](https://github.com/piskvorky/gensim) - :star: 3163 :fork_and_knife: 1190 - Topic Modelling for Humans.
...
* [:octocat: NuPIC](https://github.com/numenta/nupic) - :star: 4536 :fork_and_knife: 1280 - Numenta Platform for Intelligent Computing.
* [:octocat: pattern](https://github.com/clips/pattern) - :star: 4878 :fork_and_knife: 895 - Web mining module for Python.
* [:octocat: PyBrain](https://github.com/pybrain/pybrain) - :star: 2067 :fork_and_knife: 639 - Another Python Machine Learning Library.
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - :star: 2210 :fork_and_knife: 907 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano).
...
* [:octocat: dpark](https://github.com/douban/dpark) - :star: 1950 :fork_and_knife: 447 - Python clone of Spark, a MapReduce alike framework in Python.
...
* [:octocat: luigi](https://github.com/spotify/luigi) - :star: 5628 :fork_and_knife: 1072 - A module that helps you build complex pipelines of batch jobs.
* [:octocat: mrjob](https://github.com/Yelp/mrjob) - :star: 1913 :fork_and_knife: 487 - Run MapReduce jobs on Hadoop or Amazon Web Services.
...
* [:octocat: fn.py](https://github.com/kachayev/fn.py) - :star: 2098 :fork_and_knife: 133 - Functional programming in Python: implementation of missing features to enjoy FP.
* [:octocat: funcy](https://github.com/Suor/funcy) - :star: 1347 :fork_and_knife: 67 - A fancy and practical functional tools.
* [:octocat: Toolz](https://github.com/pytoolz/toolz) - :star: 1234 :fork_and_knife: 102 - A collection of functional utilities for iterators, functions, and dictionaries.
...
* [:octocat: boto](https://github.com/boto/boto) - :star: 5676 :fork_and_knife: 2075 - Python interface to Amazon Web Services.
...
* [:octocat: facebook-sdk](https://github.com/pythonforfacebook/facebook-sdk) - :star: 1795 :fork_and_knife: 682 - Facebook Platform Python SDK.
...
* [:octocat: gmail](https://github.com/charlierguo/gmail) - :star: 1315 :fork_and_knife: 251 - A Pythonic interface for Gmail.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 1217 :fork_and_knife: 562 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 1895 :fork_and_knife: 352 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1248 :fork_and_knife: 317 - A Python wrapper for the Twitter API.

## DevOps Tools

*Software and libraries for DevOps.*

* [:octocat: Ansible](https://github.com/ansible/ansible) - :star: 19515 :fork_and_knife: 5927 - A radically simple IT automation platform.
* [:octocat: SaltStack](https://github.com/saltstack/salt) - :star: 7000 :fork_and_knife: 3201 - Infrastructure automation and management system.
...
* [:octocat: Fabtools](https://github.com/ronnix/fabtools) - :star: 1044 :fork_and_knife: 204 - Tools for writing awesome Fabric files.
...
* [:octocat: honcho](https://github.com/nickstenning/honcho) - :star: 862 :fork_and_knife: 99 - A Python port of [Foreman](https://github.com/ddollar/foreman), a tool for managing Procfile-based applications.
* [:earth_americas: OpenStack](http://www.openstack.org/) - Open source software for building private and public clouds.
* [:octocat: pexpect](https://github.com/pexpect/pexpect) - :star: 721 :fork_and_knife: 195 - Controlling interactive programs in a pseudo-terminal like GNU expect.
...
* [:octocat: psutil](https://github.com/giampaolo/psutil) - :star: 2004 :fork_and_knife: 343 - A cross-platform process and system utilities module.
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - :star: 2847 :fork_and_knife: 574 - Supervisor process control system for UNIX.
...
* [:octocat: Plan](https://github.com/fengsp/plan) - :star: 931 :fork_and_knife: 67 - Writing crontab file in Python like a charm.
* [:octocat: schedule](https://github.com/dbader/schedule) - :star: 2521 :fork_and_knife: 251 - Python job scheduling for humans.
* [:octocat: Spiff](https://github.com/knipknap/SpiffWorkflow) - :star: 384 :fork_and_knife: 94 - A powerful workflow engine implemented in pure Python.
...
* [:octocat: Pyston](https://github.com/dropbox/pyston) - :star: 4040 :fork_and_knife: 279 - A Python implementation built using LLVM and modern JIT techniques with the goal of achieving good performance.
...
* [:octocat: PythonNet](https://github.com/pythonnet/pythonnet) - :star: 261 :fork_and_knife: 83 - Python Integration with the .NET Common Language Runtime (CLR).
...
* [:octocat: PyUserInput](https://github.com/SavinaRoja/PyUserInput) - :star: 471 :fork_and_knife: 118 - A module for cross-platform control of the mouse and keyboard.
...
* [:octocat: blinker](https://github.com/jek/blinker) - :star: 445 :fork_and_knife: 59 - A fast Python in-process signal/event dispatching system.
* [:octocat: itsdangerous](https://github.com/mitsuhiko/itsdangerous) - :star: 1023 :fork_and_knife: 87 - Various helpers to pass trusted data to untrusted environments.
* [:octocat: pluginbase](https://github.com/mitsuhiko/pluginbase) - :star: 430 :fork_and_knife: 46 - A simple but flexible plugin system for Python.
...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - :star: 1741 :fork_and_knife: 447 - A module of algorithms for Python.
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - :star: 9642 :fork_and_knife: 2305 - A collection of design patterns in Python.
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - :star: 816 :fork_and_knife: 117 - Emacs Python Development Environment.
* Sublime Text
    ...
    * [:octocat: Anaconda](https://github.com/DamnWidget/anaconda) - :star: 1232 :fork_and_knife: 134 - Anaconda turns your Sublime Text 3 in a full featured Python development IDE.
* Vim
    * [:octocat: YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - :star: 12151 :fork_and_knife: 1417 - Includes [Jedi](https://github.com/davidhalter/jedi)-based completion engine for Python.
    * [:octocat: Jedi-vim](https://github.com/davidhalter/jedi-vim) - :star: 2550 :fork_and_knife: 220 - Vim bindings for the Jedi auto-completion library for Python.
    * [:octocat: Python-mode](https://github.com/klen/python-mode) - :star: 3205 :fork_and_knife: 657 - An all in one plugin for turning Vim into a Python IDE.
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - :star: 1308 :fork_and_knife: 347 - Python Tools for Visual Studio.
...
* [:octocat: Spyder](https://github.com/spyder-ide/spyder) - :star: 1511 :fork_and_knife: 364 - Open Source Python IDE.
...
* Python
    ...
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 1683 :fork_and_knife: 349
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 421 :fork_and_knife: 80
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 45577 :fork_and_knife: 5429
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 3950 :fork_and_knife: 301
