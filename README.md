...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - :star: 2861 :fork_and_knife: 707 - A module of algorithms for Python.
* [:octocat: PyPattyrn](https://github.com/tylerlaberge/PyPattyrn) - :star: 591 :fork_and_knife: 49 - A simple yet effective library for implementing common design patterns.
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - :star: 16915 :fork_and_knife: 3811 - A collection of design patterns in Python.
...
* [:octocat: audiolazy](https://github.com/danilobellini/audiolazy) - :star: 420 :fork_and_knife: 58 - Expressive Digital Signal Processing (DSP) package for Python.
* [:octocat: audioread](https://github.com/beetbox/audioread) - :star: 216 :fork_and_knife: 57 - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding.
* [:earth_americas: beets](http://beets.io/) - A music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - :star: 3965 :fork_and_knife: 869 - Audio fingerprinting and recognition.
...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 435 :fork_and_knife: 150 - A module for parsing m3u8 file.
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - :star: 3980 :fork_and_knife: 1428 - Authentication app for Django that "just works."
    * [:octocat: django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) - :star: 1371 :fork_and_knife: 436 - OAuth 2 goodies for Django.
...
* Others
    ...
    * [:octocat: PyJWT](https://github.com/jpadilla/pyjwt) - :star: 2152 :fork_and_knife: 280 - Implementation of the JSON Web Token draft 01.
...
* [:octocat: django-cache-machine](https://github.com/django-cache-machine/django-cache-machine) - :star: 711 :fork_and_knife: 145 - Automatic caching and invalidation for Django models.
* [:octocat: django-cacheops](https://github.com/Suor/django-cacheops) - :star: 911 :fork_and_knife: 137 - A slick ORM cache with automatic granular event-driven invalidation.
...
* Linter
    ...
    * [:octocat: pylama](https://github.com/klen/pylama) - :star: 438 :fork_and_knife: 54 - Code audit tool for Python and JavaScript.
...
* Command-line Application Development
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - :star: 2437 :fork_and_knife: 227 - Python Command-line Application Tools.
...
* Productivity Tools
    ...
    * [:octocat: SAWS](https://github.com/donnemartin/saws) - :star: 3704 :fork_and_knife: 187 - A Supercharged AWS CLI.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - :star: 36768 :fork_and_knife: 1839 - Correcting your previous console command.
...
* [:octocat: pyocr](https://github.com/jflesch/pyocr) - :star: 909 :fork_and_knife: 149 - A wrapper for Tesseract and Cuneiform.
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - :star: 1581 :fork_and_knife: 259 - Another wrapper for [Google Tesseract OCR](https://github.com/tesseract-ocr).
...
* [:octocat: gevent](http://www.gevent.org/) - :star: 919 :fork_and_knife: 163 - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
...
* [:octocat: python-decouple](https://github.com/henriquebastos/python-decouple) - :star: 762 :fork_and_knife: 62 - Strict separation of settings from code.
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 789 :fork_and_knife: 70 - Implementation of [hashids](http://hashids.org) in Python.
...
* [:octocat: PyNacl](https://github.com/pyca/pynacl) - :star: 511 :fork_and_knife: 104 - Python binding to the Networking and Cryptography (NaCl) library.

## Data Analysis

*Libraries for data analyzing.*

* [:octocat: Blaze](https://github.com/blaze/blaze) - :star: 2455 :fork_and_knife: 326 - NumPy and Pandas interface to Big Data.
* [:octocat: Open Mining](https://github.com/mining/mining) - :star: 902 :fork_and_knife: 173 - Business Intelligence (BI) in Pandas interface.
...
* [:octocat: Cerberus](https://github.com/nicolaiarocci/cerberus/) - :star: 1342 :fork_and_knife: 145 - A lightweight and extensible data validation library.
...
* [:octocat: jsonschema](https://github.com/Julian/jsonschema) - :star: 1760 :fork_and_knife: 307 - An implementation of [JSON Schema](http://json-schema.org/) for Python.
* [:octocat: schema](https://github.com/keleshev/schema) - :star: 1497 :fork_and_knife: 130 - A library for validating Python data structures.
* [:octocat: Schematics](https://github.com/schematics/schematics) - :star: 2017 :fork_and_knife: 258 - Data Structure Validation.
...
* [:octocat: voluptuous](https://github.com/alecthomas/voluptuous) - :star: 1262 :fork_and_knife: 159 - A Python data validation library.

## Data Visualization

*Libraries for visualizing data. See: [awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization).*

* [:octocat: Altair](https://github.com/altair-viz/altair) - :star: 2710 :fork_and_knife: 262 - Declarative statistical visualization library for Python.
* [:octocat: Bokeh](https://github.com/bokeh/bokeh) - :star: 8052 :fork_and_knife: 2138 - Interactive Web Plotting for Python.
* [:octocat: ggplot](https://github.com/yhat/ggplot) - :star: 3356 :fork_and_knife: 525 - Same API as ggplot2 for R.
...
* [:octocat: Seaborn](https://github.com/mwaskom/seaborn) - :star: 5192 :fork_and_knife: 793 - Statistical data visualization using Matplotlib.
* [:octocat: VisPy](https://github.com/vispy/vispy) - :star: 1739 :fork_and_knife: 388 - High-performance scientific visualization based on OpenGL.
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - :star: 2323 :fork_and_knife: 230 - A tiny, document-oriented database.
...
* MySQL - [awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/)
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - :star: 1194 :fork_and_knife: 184 - mysql-python fork supporting Python 3.
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - :star: 4273 :fork_and_knife: 958 - Pure Python MySQL driver compatible to mysql-python.
* PostgreSQL
...
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - :star: 909 :fork_and_knife: 389 - Python driver for Cassandra.
    ...
    * [:octocat: Plyvel](https://github.com/wbolster/plyvel) - :star: 213 :fork_and_knife: 38 - A fast and feature-rich Python interface to LevelDB.
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - :star: 6499 :fork_and_knife: 1537 - The Redis Python Client.
...
* [:octocat: Pendulum](https://github.com/sdispater/pendulum) - :star: 2775 :fork_and_knife: 121 - Python datetimes made easy.
...
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - :star: 2237 :fork_and_knife: 165 - Line-by-line profiling.
    ...
    * [:octocat: profiling](https://github.com/what-studio/profiling) - :star: 2739 :fork_and_knife: 105 - An interactive Python profiler.
* Others
    * [:octocat: pyelftools](https://github.com/eliben/pyelftools) - :star: 665 :fork_and_knife: 255 - Parsing and analyzing ELF files and DWARF debugging information.
...
* [:octocat: Ansible](https://github.com/ansible/ansible) - :star: 32102 :fork_and_knife: 12482 - A radically simple IT automation platform.
...
* [:octocat: honcho](https://github.com/nickstenning/honcho) - :star: 1142 :fork_and_knife: 111 - A Python clone of [Foreman](https://github.com/ddollar/foreman), for managing Procfile-based applications.
...
* [:octocat: SaltStack](https://github.com/saltstack/salt) - :star: 9128 :fork_and_knife: 4267 - Infrastructure automation and management system.
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - :star: 4579 :fork_and_knife: 827 - Supervisor process control system for UNIX.
...
* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - :star: 4390 :fork_and_knife: 974 - Converts Python programs into stand-alone executables (cross-platform).
...
* [:earth_americas: Sphinx](http://www.sphinx-doc.org/en/latest/) - Python Documentation generator.
    * [:octocat: awesome-sphinxdoc](https://github.com/yoloseem/awesome-sphinxdoc) - :star: 443 :fork_and_knife: 38
...
* [:octocat: Pycco](https://github.com/pycco-docs/pycco) - :star: 610 :fork_and_knife: 124 - The literate-programming-style documentation generator.

## Downloader

*Libraries for downloading.*

* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - :star: 2761 :fork_and_knife: 704 - A command line tool for managing Amazon S3 and CloudFront.
* [:octocat: s4cmd](https://github.com/bloomreach/s4cmd) - :star: 741 :fork_and_knife: 148 - Super S3 command line tool, good for higher performance.
...
* [:octocat: alipay](https://github.com/lxneng/alipay) - :star: 297 :fork_and_knife: 94 - Unofficial Alipay API for Python.
* [:octocat: Cartridge](https://github.com/stephenmcd/cartridge) - :star: 568 :fork_and_knife: 274 - A shopping cart app built using the Mezzanine.
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - :star: 1271 :fork_and_knife: 170 - Emacs Python Development Environment.
* Sublime Text
...
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - :star: 2023 :fork_and_knife: 536 - Python Tools for Visual Studio.
* Visual Studio Code
...
* IDE
    ...
    * [:octocat: Spyder](https://github.com/spyder-ide/spyder) - :star: 3408 :fork_and_knife: 720 - Open Source Python IDE.
...
* [:octocat: flanker](https://github.com/mailgun/flanker) - :star: 1221 :fork_and_knife: 139 - A email address and Mime parsing library.
* [:octocat: imbox](https://github.com/martinrusev/imbox) - :star: 777 :fork_and_knife: 119 - Python IMAP for Humans.
* [:octocat: inbox.py](https://github.com/kennethreitz/inbox.py) - :star: 1428 :fork_and_knife: 119 - Python SMTP Server for Humans.
* [:octocat: lamson](https://github.com/zedshaw/lamson) - :star: 644 :fork_and_knife: 191 - Pythonic SMTP Application Server.
* [:octocat: Marrow Mailer](https://github.com/marrow/mailer) - :star: 159 :fork_and_knife: 36 - High-performance extensible mail delivery framework.
...
* [:octocat: yagmail](https://github.com/kootenpv/yagmail) - :star: 1132 :fork_and_knife: 106 - Yet another Gmail/SMTP client.

## Environment Management

*Libraries for Python version and environment management.*

* [:octocat: p](https://github.com/qw3rtman/p) - :star: 721 :fork_and_knife: 41 - Dead simple interactive Python version management.
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - :star: 12221 :fork_and_knife: 1072 - Simple Python version management.
...
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - :star: 2024 :fork_and_knife: 681 - Bootstrap 3 integration with Django.
...
* [:octocat: Toga](https://github.com/pybee/toga) - :star: 1695 :fork_and_knife: 274 - A Python native, OS native GUI toolkit.
...
* [:octocat: geojson](https://github.com/frewsxcv/python-geojson) - :star: 352 :fork_and_knife: 52 - Python bindings and utilities for GeoJSON.
* [:octocat: geopy](https://github.com/geopy/geopy) - :star: 2002 :fork_and_knife: 402 - Python Geocoding Toolbox.
* [:octocat: pygeoip](https://github.com/appliedsec/pygeoip) - :star: 477 :fork_and_knife: 103 - Pure Python GeoIP API.
...
* [:octocat: pyquery](https://github.com/gawel/pyquery) - :star: 1533 :fork_and_knife: 139 - A jQuery-like library for parsing HTML.
* [:octocat: untangle](https://github.com/stchris/untangle) - :star: 340 :fork_and_knife: 49 - Converts XML documents to Python objects for easy access.
...
* [:octocat: grequests](https://github.com/kennethreitz/grequests) - :star: 2701 :fork_and_knife: 266 - requests + gevent for asynchronous HTTP requests.
* [:octocat: httplib2](https://github.com/jcgregorio/httplib2) - :star: 387 :fork_and_knife: 185 - Comprehensive HTTP client library.
...
* [:octocat: scapy](https://github.com/secdev/scapy) - :star: 2844 :fork_and_knife: 658 - A brilliant packet manipulation library.
...
* [:octocat: hmap](https://github.com/rossgoodwin/hmap) - :star: 151 :fork_and_knife: 17 - Image histogram remapping.
...
* [:octocat: nude.py](https://github.com/hhatto/nude.py) - :star: 583 :fork_and_knife: 94 - Nudity detection.
* [:octocat: pagan](https://github.com/daboth/pagan) - :star: 101 :fork_and_knife: 14 - Retro identicon (Avatar) generation based on input string and hash.
* [:octocat: pillow](https://github.com/python-pillow/Pillow) - :star: 5228 :fork_and_knife: 1076 - Pillow is the friendly [PIL](http://www.pythonware.com/products/pil/) fork.
* [:earth_americas: pyBarcode](https://pythonhosted.org/pyBarcode/) - Create barcodes in Python without needing PIL.
* [:octocat: pygram](https://github.com/ajkumar25/pygram) - :star: 70 :fork_and_knife: 11 - Instagram-like image filters.
* [:octocat: python-qrcode](https://github.com/lincolnloop/python-qrcode) - :star: 1490 :fork_and_knife: 289 - A pure Python QR Code generator.
* [:octocat: Quads](https://github.com/fogleman/Quads) - :star: 752 :fork_and_knife: 68 - Computer art based on quadtrees.
...
* [:octocat: bpython](https://github.com/bpython/bpython) - :star: 1074 :fork_and_knife: 131 - A fancy interface to the Python interpreter.
...
* [:octocat: django-schedule](https://github.com/thauber/django-schedule) - :star: 725 :fork_and_knife: 274 - A calendaring app for Django.
...
* [:octocat: schedule](https://github.com/dbader/schedule) - :star: 4916 :fork_and_knife: 464 - Python job scheduling for humans.
* [:octocat: Spiff](https://github.com/knipknap/SpiffWorkflow) - :star: 653 :fork_and_knife: 150 - A powerful workflow engine implemented in pure Python.
...
* [:octocat: Eliot](https://github.com/ClusterHQ/eliot) - :star: 391 :fork_and_knife: 27 - Logging for complex & distributed systems.
...
* [:octocat: Raven](https://github.com/getsentry/raven-python) - :star: 1510 :fork_and_knife: 790 - The Python client for Sentry.
...
* [:octocat: gensim](https://github.com/piskvorky/gensim) - :star: 7596 :fork_and_knife: 2881 - Topic Modelling for Humans.
* [:earth_americas: MLlib](http://spark.apache.org/mllib/) - [Apache Spark](http://spark.apache.org/)'s scalable Machine Learning library.
* [:octocat: NuPIC](https://github.com/numenta/nupic) - :star: 5661 :fork_and_knife: 1538 - Numenta Platform for Intelligent Computing.
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - :star: 2610 :fork_and_knife: 1078 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano).
...
* [:octocat: streamparse](https://github.com/Parsely/streamparse) - :star: 1304 :fork_and_knife: 201 - Run Python code against real-time streams of data. Integrates with [Apache Storm](http://storm.apache.org/).
...
* [:octocat: Jieba](https://github.com/fxsjy/jieba) - :star: 14783 :fork_and_knife: 4127 - Chinese text segmentation.
* [:octocat: langid.py](https://github.com/saffsd/langid.py) - :star: 1082 :fork_and_knife: 194 - Stand-alone language identification system.
...
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - :star: 3394 :fork_and_knife: 910 - A library for processing Chinese text.
...
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - :star: 1649 :fork_and_knife: 132 - Event-driven concurrent framework for Python.
...
* Relational Databases
    ...
    * [:earth_americas: SQLAlchemy](http://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
        * [:octocat: awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) - :star: 1657 :fork_and_knife: 96
    * [:octocat: Peewee](https://github.com/coleifer/peewee) - :star: 5524 :fork_and_knife: 957 - A small, expressive ORM.
...
* NoSQL Databases
    * [:octocat: django-mongodb-engine](https://github.com/django-nonrel/mongodb-engine) - :star: 779 :fork_and_knife: 203 - Django MongoDB Backend.
...
* Others
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 3172 :fork_and_knife: 205 - A JSON-based database.
...
* [:octocat: conda](https://github.com/conda/conda/) - :star: 2326 :fork_and_knife: 586 - Cross-platform, Python-agnostic binary package manager.
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - :star: 1911 :fork_and_knife: 432 - Next generation Python Package Repository (PyPI).
...
* [:octocat: envoy](https://github.com/kennethreitz/envoy) - :star: 2207 :fork_and_knife: 259 - Python [subprocess](https://docs.python.org/2/library/subprocess.html) for Humans.
* [:earth_americas: sarge](http://sarge.readthedocs.io/) - Yet another wrapper for subprocess.
* [:octocat: sh](https://github.com/amoffat/sh) - :star: 4566 :fork_and_knife: 365 - A full-fledged subprocess replacement for Python.
...
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 1851 :fork_and_knife: 197 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 692 :fork_and_knife: 83 - Mr. Queue - A distributed worker task queue in Python using Redis & gevent.
...
* Flask
    ...
    * [:octocat: flask-restful](https://github.com/flask-restful/flask-restful) - :star: 3954 :fork_and_knife: 671 - Quickly building REST APIs for Flask.
    * [:octocat: flask-restless](https://github.com/jfinkels/flask-restless) - :star: 907 :fork_and_knife: 266 - Generating RESTful APIs for database models defined with SQLAlchemy.
* Pyramid
    * [:octocat: cornice](https://github.com/mozilla-services/cornice) - :star: 330 :fork_and_knife: 132 - A RESTful framework for Pyramid.
* Framework agnostic
...
* [:octocat: bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) - :star: 590 :fork_and_knife: 267 - Providing best-practice pipelines for fully automated high throughput sequencing analysis.
* [:octocat: bccb](https://github.com/chapmanb/bcbb) - :star: 414 :fork_and_knife: 189 - Collection of useful code related to biological analysis.
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - :star: 3533 :fork_and_knife: 871 - Markov Chain Monte Carlo sampling toolkit.
...
* [:octocat: statsmodels](https://github.com/statsmodels/statsmodels) - :star: 3159 :fork_and_knife: 1353 - Statistical modeling and econometrics in Python.
* [:octocat: SymPy](https://github.com/sympy/sympy) - :star: 5041 :fork_and_knife: 2324 - A Python library for symbolic mathematics.
* [:octocat: Zipline](https://github.com/quantopian/zipline) - :star: 7512 :fork_and_knife: 2377 - A Pythonic algorithmic trading library.

## Search

*Libraries and software for indexing and performing search queries on data.*

* [:octocat: django-haystack](https://github.com/django-haystack/django-haystack) - :star: 2483 :fork_and_knife: 1073 - Modular search for Django.
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - :star: 1977 :fork_and_knife: 444 - The official high-level Python client for Elasticsearch.
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - :star: 3097 :fork_and_knife: 464 - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
...
* Markdown
    ...
    * [:octocat: Python-Markdown](https://github.com/waylan/Python-Markdown) - :star: 1465 :fork_and_knife: 355 - A Python implementation of John Grubers Markdown.
* YAML
    * [:earth_americas: PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [:octocat: csvkit](https://github.com/wireservice/csvkit) - :star: 3357 :fork_and_knife: 457 - Utilities for converting to and working with CSV.
* Archive
    * [:octocat: unp](https://github.com/mitsuhiko/unp) - :star: 317 :fork_and_knife: 61 - A command line tool that can unpack archives easily.

## Static Site Generator

*Static site generator is a software that takes some text + templates as input and produces HTML files on the output.*

* [:octocat: Cactus](https://github.com/koenbok/Cactus/) - :star: 3222 :fork_and_knife: 309 - Static site generator for designers.
...
* [:octocat: django-taggit](https://github.com/alex/django-taggit) - :star: 1929 :fork_and_knife: 468 - Simple tagging for Django.
...
* [:octocat: Jinja2](https://github.com/pallets/jinja) - :star: 5383 :fork_and_knife: 1051 - A modern and designer friendly templating language.
...
* Testing Frameworks
    * [:octocat: hypothesis](https://github.com/HypothesisWorks/hypothesis-python) - :star: 2872 :fork_and_knife: 247 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: nose](https://github.com/nose-devs/nose) - :star: 1222 :fork_and_knife: 339 - A nicer unittest for Python.
    * [:octocat: nose2](https://github.com/nose-devs/nose2) - :star: 475 :fork_and_knife: 111 - The successor to nose, based on unittest2.
    * [:earth_americas: pytest](http://pytest.org/latest/) - A mature full-featured Python testing tool.
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 2527 :fork_and_knife: 849 - A generic test automation framework.
    * [:earth_americas: unittest](https://docs.python.org/2/library/unittest.html) - (Python standard library) Unit testing framework.
* Test Runners
    * [:octocat: green](https://github.com/CleanCut/green) - :star: 545 :fork_and_knife: 58 - A clean, colorful test runner.
...
* GUI / Web Testing
    ...
    * [:octocat: splinter](https://github.com/cobrateam/splinter) - :star: 1814 :fork_and_knife: 385 - Open source tool for testing web applications.
* Mock
    * [:earth_americas: doublex](https://pypi.python.org/pypi/doublex) - Powerful test doubles framework for Python.
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 1588 :fork_and_knife: 130 - Travel through time by mocking the datetime module.
    ...
    * [:octocat: httpretty](https://github.com/gabrielfalcao/HTTPretty) - :star: 1569 :fork_and_knife: 217 - HTTP request mock tool for Python.
...
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - :star: 1538 :fork_and_knife: 209 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 518 :fork_and_knife: 58 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
    * [:octocat: model_mommy](https://github.com/vandersonmota/model_mommy) - :star: 812 :fork_and_knife: 160 - Creating random fixtures for testing in Django.
* Code Coverage
    * [:earth_americas: coverage](https://pypi.python.org/pypi/coverage) - Code coverage measurement.
* Fake Data
    * [:octocat: church](https://github.com/lk-geimfari/church) - :star: 2063 :fork_and_knife: 162 - is a Python library that help you generate fake data.
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 1873 :fork_and_knife: 92 - Fake database generator.
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 6576 :fork_and_knife: 786 - A Python package that generates fake data.
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 997 :fork_and_knife: 140 - Python 2/3 compatible character encoding detector.
    ...
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 4546 :fork_and_knife: 490 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 486 :fork_and_knife: 79 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 79 :fork_and_knife: 13 - Spacing texts for CJK and alphanumerics.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 310 :fork_and_knife: 43 - An implementation of figlet written in Python.
    * [:octocat: shortuuid](https://github.com/stochastic-technologies/shortuuid) - :star: 922 :fork_and_knife: 69 - A generator library for concise, unambiguous and URL-safe UUIDs.
    ...
    * [:octocat: xpinyin](https://github.com/lxneng/xpinyin) - :star: 572 :fork_and_knife: 133 - A library to translate Chinese hanzi (??) to pinyin (??).
* Slugify
    ...
    * [:octocat: python-slugify](https://github.com/un33k/python-slugify) - :star: 507 :fork_and_knife: 51 - A Python slugify library that translates unicode to ASCII.
...
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 1918 :fork_and_knife: 238 - Parsing, formatting, storing and validating international phone numbers.
    ...
    * [:octocat: python-nameparser](https://github.com/derek73/python-nameparser) - :star: 284 :fork_and_knife: 48 - Parsing human names into their individual components.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 780 :fork_and_knife: 135 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 1322 :fork_and_knife: 292 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 3618 :fork_and_knife: 748 - Python interface to Amazon Web Services.
...
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 2321 :fork_and_knife: 848 - Facebook Platform Python SDK.
...
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 3453 :fork_and_knife: 544 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1550 :fork_and_knife: 343 - A Python wrapper for the Twitter API.
...
* [:octocat: scikit-video](https://github.com/aizvorski/scikit-video) - :star: 80 :fork_and_knife: 13 - Video processing routines for SciPy.
...
* [:octocat: netius](https://github.com/hivesolutions/netius) - :star: 98 :fork_and_knife: 5 - Asynchronous, very fast.
...
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 551 :fork_and_knife: 117 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 427 :fork_and_knife: 32 - Web Content Retrieval for Humans.
* [:octocat: micawber](https://github.com/coleifer/micawber) - :star: 406 :fork_and_knife: 64 - A small library for extracting rich content from URLs.
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 6627 :fork_and_knife: 1114 - News extraction, article extraction and content curation in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 3104 :fork_and_knife: 692 - HTML Content/Article Extractor.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1454 :fork_and_knife: 257 - Fast Python port of arc90's readability tool.
...
* [:octocat: cola](https://github.com/chineking/cola) - :star: 1276 :fork_and_knife: 526 - A distributed crawling framework.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 2812 :fork_and_knife: 202 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 6258 :fork_and_knife: 979 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 11823 :fork_and_knife: 2963 - A powerful spider system.
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 7985 :fork_and_knife: 1452
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 5912 :fork_and_knife: 932
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 430 :fork_and_knife: 50
...
* [:octocat: AutobahnPython](https://github.com/crossbario/autobahn-python) - :star: 1861 :fork_and_knife: 536 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
...
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 1145 :fork_and_knife: 232 - WebSockets for Django.
...
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 91063 :fork_and_knife: 12053
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 5172 :fork_and_knife: 467
* Python
    * [:octocat: pycrumbs](https://github.com/kirang89/pycrumbs) - :star: 2740 :fork_and_knife: 688
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 498 :fork_and_knife: 128
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 2020 :fork_and_knife: 476
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 655 :fork_and_knife: 139
