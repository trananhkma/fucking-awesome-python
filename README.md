...
* Metadata
    ...
    * [:octocat: mutagen](https://github.com/quodlibet/mutagen) - :star: 672 :fork_and_knife: 91 - A Python module to handle audio metadata.
...
* [:octocat: VisPy](https://github.com/vispy/vispy) - :star: 2466 :fork_and_knife: 530 - High-performance scientific visualization based on OpenGL.
...
* Others
    ...
    * [:octocat: django-debug-toolbar](https://github.com/jazzband/django-debug-toolbar) - :star: 6145 :fork_and_knife: 888 - Display various debug information for Django.
...
* [:octocat: CPython](https://github.com/python/cpython) - :star: 34042 :fork_and_knife: 16484 - **Default, most widely used implementation of the Python programming language written in C.**
...
* [:octocat: Surprise](https://github.com/NicolasHug/Surprise) - :star: 4418 :fork_and_knife: 803 - A scikit for building and analyzing recommender systems.
...
* Fake Data
    * [:octocat: mimesis](https://github.com/lk-geimfari/mimesis) - :star: 3100 :fork_and_knife: 259 - is a Python library that help you generate fake data.
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 2030 :fork_and_knife: 115 - Fake database generator.
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 10670 :fork_and_knife: 1266 - A Python package that generates fake data.
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 1376 :fork_and_knife: 192 - Python 2/3 compatible character encoding detector.
    * [:earth_americas: difflib](https://docs.python.org/3/library/difflib.html) - (Python standard library) Helpers for computing deltas.
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 2815 :fork_and_knife: 98 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 7395 :fork_and_knife: 788 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 873 :fork_and_knife: 120 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 151 :fork_and_knife: 21 - Paranoid text spacing.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 707 :fork_and_knife: 75 - An implementation of figlet written in Python.
    * [:octocat: pypinyin](https://github.com/mozillazg/python-pinyin) - :star: 2897 :fork_and_knife: 461 - Convert Chinese hanzi (漢字) to pinyin (拼音).
    * [:octocat: textdistance](https://github.com/orsinium/textdistance) - :star: 1800 :fork_and_knife: 157 - Compute distance between sequences with 30+ algorithms.
...
* Slugify
    ...
    * [:octocat: python-slugify](https://github.com/un33k/python-slugify) - :star: 920 :fork_and_knife: 79 - A Python slugify library that translates unicode to ASCII.
...
* Parser
    ...
    * [:octocat: pyparsing](https://github.com/pyparsing/pyparsing) - :star: 894 :fork_and_knife: 143 - A general purpose framework for generating parsers.
    * [:octocat: python-nameparser](https://github.com/derek73/python-nameparser) - :star: 431 :fork_and_knife: 76 - Parsing human names into their individual components.
    * [:octocat: python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 2551 :fork_and_knife: 320 - Parsing, formatting, storing and validating international phone numbers.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 1070 :fork_and_knife: 174 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 2203 :fork_and_knife: 460 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 5851 :fork_and_knife: 1259 - Python interface to Amazon Web Services.
...
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 2559 :fork_and_knife: 939 - Facebook Platform Python SDK.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 4147 :fork_and_knife: 1749 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 4980 :fork_and_knife: 758 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1747 :fork_and_knife: 395 - A Python wrapper for the Twitter API.

## URL Manipulation

*Libraries for parsing URLs.*

* [:octocat: furl](https://github.com/gruns/furl) - :star: 1875 :fork_and_knife: 119 - A small Python library that makes parsing and manipulating URLs easy.
...
* [:octocat: pyshorteners](https://github.com/ellisonleao/pyshorteners) - :star: 271 :fork_and_knife: 50 - A pure Python URL shortening lib.
* [:octocat: webargs](https://github.com/marshmallow-code/webargs) - :star: 1074 :fork_and_knife: 138 - A friendly library for parsing HTTP request arguments with built-in support for popular web frameworks.

## Video

*Libraries for manipulating video and GIFs.*

* [:octocat: vidgear](https://github.com/abhiTronix/vidgear) - :star: 1423 :fork_and_knife: 106 - Most Powerful multi-threaded Video Processing framework.
...
* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 2374 :fork_and_knife: 558 - Compresses linked and inline JavaScript or CSS into a single cached file.
* [:octocat: django-pipeline](https://github.com/jazzband/django-pipeline) - :star: 1373 :fork_and_knife: 348 - An asset packaging library for Django.
* [:octocat: django-storages](https://github.com/jschneier/django-storages) - :star: 1707 :fork_and_knife: 659 - A collection of custom storage back ends for Django.
...
* [:octocat: flask-assets](https://github.com/miracle2k/flask-assets) - :star: 402 :fork_and_knife: 87 - Helps you integrate webassets into your Flask app.
...
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 1003 :fork_and_knife: 174 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 509 :fork_and_knife: 40 - Web Content Retrieval for Humans.
* [:octocat: micawber](https://github.com/coleifer/micawber) - :star: 500 :fork_and_knife: 74 - A small library for extracting rich content from URLs.
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 10260 :fork_and_knife: 1693 - News extraction, article extraction and content curation in Python.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1878 :fork_and_knife: 315 - Fast Python port of arc90's readability tool.
* [:octocat: requests-html](https://github.com/psf/requests-html) - :star: 11223 :fork_and_knife: 745 - Pythonic HTML Parsing for Humans.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 2386 :fork_and_knife: 433 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 2891 :fork_and_knife: 409 - Extract text from any document, Word, PowerPoint, PDFs, etc.
* [:octocat: toapi](https://github.com/gaojiuli/toapi) - :star: 3054 :fork_and_knife: 216 - Every web site provides APIs.
...
* [:octocat: grab](https://github.com/lorien/grab) - :star: 1986 :fork_and_knife: 250 - Site scraping framework.
* [:octocat: MechanicalSoup](https://github.com/MechanicalSoup/MechanicalSoup) - :star: 3582 :fork_and_knife: 329 - A Python library for automating interaction with websites.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 14636 :fork_and_knife: 3537 - A powerful spider system.
* [:octocat: robobrowser](https://github.com/jmcarp/robobrowser) - :star: 3490 :fork_and_knife: 326 - A simple, Pythonic library for browsing the web without a standalone web browser.
* [:earth_americas: scrapy](https://scrapy.org/) - A fast high-level screen scraping and web crawling framework.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 7930 :fork_and_knife: 1281 - Visual scraping for Scrapy.
...
* Synchronous
    * [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
        * [:octocat: awesome-django](https://github.com/wsvincent/awesome-django) - :star: 3041 :fork_and_knife: 556
        * [:octocat: awesome-django](https://github.com/shahraizali/awesome-django) - :star: 471 :fork_and_knife: 92
    * [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
        * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 9270 :fork_and_knife: 1375
    ...
    * [:octocat: Masonite](https://github.com/MasoniteFramework/masonite) - :star: 1466 :fork_and_knife: 91 - The modern and developer centric Python web framework.
* Asynchronous
...
* [:octocat: channels](https://github.com/django/channels) - :star: 4587 :fork_and_knife: 636 - Developer-friendly asynchrony for Django.
* [:octocat: websockets](https://github.com/aaugustin/websockets) - :star: 2968 :fork_and_knife: 339 - A library for building WebSocket servers and clients with a focus on correctness and simplicity.

## WSGI Servers

*WSGI-compatible web servers.*

* [:octocat: bjoern](https://github.com/jonashaag/bjoern) - :star: 2433 :fork_and_knife: 177 - Asynchronous, very fast and written in C.
* [:octocat: gunicorn](https://github.com/benoitc/gunicorn) - :star: 7220 :fork_and_knife: 1349 - Pre-forked, partly written in C.
...
* [:octocat: waitress](https://github.com/Pylons/waitress) - :star: 844 :fork_and_knife: 122 - Multi-threaded, powers Pyramid.
* [:octocat: werkzeug](https://github.com/pallets/werkzeug) - :star: 5471 :fork_and_knife: 1480 - A WSGI utility library for Python that powers Flask and can easily be embedded into your own projects.
