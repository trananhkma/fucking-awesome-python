...
* [:octocat: wooey](https://github.com/wooey/wooey) - :star: 1792 :fork_and_knife: 178 - A Django app which creates automatic web UIs for Python scripts.
...
* Audio
    ...
    * [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 6283 :fork_and_knife: 848 - Manipulate audio with a simple and easy high level interface.
...
* CLI Enhancements
    ...
    * [:octocat: litecli](https://github.com/dbcli/litecli) - :star: 1664 :fork_and_knife: 61 - SQLite CLI with autocompletion and syntax highlighting.
...
* NoSQL Databases
    * [:octocat: cassandra-driver](https://github.com/datastax/python-driver) - :star: 1296 :fork_and_knife: 493 - The Python Driver for Apache Cassandra.
...
* [:octocat: Zipline](https://github.com/quantopian/zipline) - :star: 15334 :fork_and_knife: 4447 - A Pythonic algorithmic trading library.
...
* [:octocat: django-taggit](https://github.com/jazzband/django-taggit) - :star: 2887 :fork_and_knife: 599 - Simple tagging for Django.
...
* [:octocat: daramatiq](https://github.com/Bogdanp/dramatiq) - :star: 3190 :fork_and_knife: 230 - A fast and reliable background task processing library for Python 3.
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 4161 :fork_and_knife: 350 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 869 :fork_and_knife: 114 - A distributed worker task queue in Python using Redis & gevent.
* [:octocat: rq](https://github.com/rq/rq) - :star: 8412 :fork_and_knife: 1299 - Simple job queues for Python.
...
* [:octocat: Jinja2](https://github.com/pallets/jinja) - :star: 8659 :fork_and_knife: 1504 - A modern and designer friendly templating language.
...
* Testing Frameworks
    * [:octocat: hypothesis](https://github.com/HypothesisWorks/hypothesis) - :star: 6122 :fork_and_knife: 529 - Hypothesis is an advanced Quickcheck style property based testing library.
    * [:octocat: nose2](https://github.com/nose-devs/nose2) - :star: 719 :fork_and_knife: 137 - The successor to `nose`, based on `unittest2.
    * [:earth_americas: pytest](https://docs.pytest.org/en/latest/) - A mature full-featured Python testing tool.
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 7165 :fork_and_knife: 1996 - A generic test automation framework.
    * [:earth_americas: unittest](https://docs.python.org/3/library/unittest.html) - (Python standard library) Unit testing framework.
* Test Runners
    * [:octocat: green](https://github.com/CleanCut/green) - :star: 739 :fork_and_knife: 78 - A clean, colorful test runner.
...
* GUI / Web Testing
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 19429 :fork_and_knife: 2506 - Scalable user load testing tool written in Python.
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 6963 :fork_and_knife: 924 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    * [:octocat: Schemathesis](https://github.com/kiwicom/schemathesis) - :star: 1343 :fork_and_knife: 106 - A tool for automatic property-based testing of web applications built with Open API / Swagger specifications.
    * [:earth_americas: Selenium](https://pypi.org/project/selenium/) - Python bindings for [Selenium](http://www.seleniumhq.org/) WebDriver.
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1732 :fork_and_knife: 190 - A language-agnostic A/B Testing framework.
    * [:octocat: splinter](https://github.com/cobrateam/splinter) - :star: 2539 :fork_and_knife: 507 - Open source tool for testing web applications.
* Mock
    * [:earth_americas: doublex](https://pypi.org/project/doublex/) - Powerful test doubles framework for Python.
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 3365 :fork_and_knife: 235 - Travel through time by mocking the datetime module.
    ...
    * [:octocat: httpretty](https://github.com/gabrielfalcao/HTTPretty) - :star: 1964 :fork_and_knife: 259 - HTTP request mock tool for Python.
    ...
    * [:octocat: mocket](https://github.com/mindflayer/python-mocket) - :star: 236 :fork_and_knife: 40 - A socket mock framework with gevent/asyncio/SSL support.
    * [:octocat: responses](https://github.com/getsentry/responses) - :star: 3643 :fork_and_knife: 301 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 2279 :fork_and_knife: 311 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/FactoryBoy/factory_boy) - :star: 2887 :fork_and_knife: 351 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 843 :fork_and_knife: 91 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
...
* Fake Data
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 2137 :fork_and_knife: 119 - Fake database generator.
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 14519 :fork_and_knife: 1638 - A Python package that generates fake data.
    * [:octocat: mimesis](https://github.com/lk-geimfari/mimesis) - :star: 3703 :fork_and_knife: 294 - is a Python library that help you generate fake data.
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 1745 :fork_and_knife: 241 - Python 2/3 compatible character encoding detector.
    * [:earth_americas: difflib](https://docs.python.org/3/library/difflib.html) - (Python standard library) Helpers for computing deltas.
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 3267 :fork_and_knife: 112 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 8724 :fork_and_knife: 887 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 1156 :fork_and_knife: 153 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 190 :fork_and_knife: 22 - Paranoid text spacing.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 1009 :fork_and_knife: 101 - An implementation of figlet written in Python.
    * [:octocat: pypinyin](https://github.com/mozillazg/python-pinyin) - :star: 3964 :fork_and_knife: 567 - Convert Chinese hanzi (漢字) to pinyin (拼音).
    * [:octocat: textdistance](https://github.com/orsinium/textdistance) - :star: 2915 :fork_and_knife: 232 - Compute distance between sequences with 30+ algorithms.
    * [:earth_americas: unidecode](https://pypi.org/project/Unidecode/) - ASCII transliterations of Unicode text.
* Slugify
    * [:octocat: awesome-slugify](https://github.com/dimka665/awesome-slugify) - :star: 467 :fork_and_knife: 45 - A Python slugify library that can preserve unicode.
    * [:octocat: python-slugify](https://github.com/un33k/python-slugify) - :star: 1225 :fork_and_knife: 89 - A Python slugify library that translates unicode to ASCII.
    * [:octocat: unicode-slugify](https://github.com/mozilla/unicode-slugify) - :star: 308 :fork_and_knife: 53 - A slugifier that generates unicode slugs with Django as a dependency.
* Unique identifiers
    * [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 1335 :fork_and_knife: 97 - Implementation of [hashids](http://hashids.org) in Python.
    * [:octocat: shortuuid](https://github.com/skorokithakis/shortuuid) - :star: 1697 :fork_and_knife: 101 - A generator library for concise, unambiguous and URL-safe UUIDs.
* Parser
    * [:octocat: ply](https://github.com/dabeaz/ply) - :star: 2253 :fork_and_knife: 387 - Implementation of lex and yacc parsing tools for Python.
    * [:earth_americas: pygments](http://pygments.org/) - A generic syntax highlighter.
    * [:octocat: pyparsing](https://github.com/pyparsing/pyparsing) - :star: 1589 :fork_and_knife: 227 - A general purpose framework for generating parsers.
    * [:octocat: python-nameparser](https://github.com/derek73/python-nameparser) - :star: 551 :fork_and_knife: 89 - Parsing human names into their individual components.
    * [:octocat: python-phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 3053 :fork_and_knife: 388 - Parsing, formatting, storing and validating international phone numbers.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 1284 :fork_and_knife: 196 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 2933 :fork_and_knife: 590 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 7467 :fork_and_knife: 1627 - Python interface to Amazon Web Services.
...
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 2652 :fork_and_knife: 968 - Facebook Platform Python SDK.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 5846 :fork_and_knife: 2198 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 5999 :fork_and_knife: 876 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1835 :fork_and_knife: 405 - A Python wrapper for the Twitter API.

## URL Manipulation

*Libraries for parsing URLs.*

* [:octocat: furl](https://github.com/gruns/furl) - :star: 2286 :fork_and_knife: 140 - A small Python library that makes parsing and manipulating URLs easy.
* [:octocat: purl](https://github.com/codeinthehole/purl) - :star: 278 :fork_and_knife: 37 - A simple, immutable URL class with a clean API for interrogation and manipulation.
* [:octocat: pyshorteners](https://github.com/ellisonleao/pyshorteners) - :star: 340 :fork_and_knife: 59 - A pure Python URL shortening lib.
* [:octocat: webargs](https://github.com/marshmallow-code/webargs) - :star: 1269 :fork_and_knife: 153 - A friendly library for parsing HTTP request arguments with built-in support for popular web frameworks.
...
* [:octocat: scikit-video](https://github.com/aizvorski/scikit-video) - :star: 111 :fork_and_knife: 22 - Video processing routines for SciPy.
* [:octocat: vidgear](https://github.com/abhiTronix/vidgear) - :star: 2344 :fork_and_knife: 188 - Most Powerful multi-threaded Video Processing framework.

## Web Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 2586 :fork_and_knife: 581 - Compresses linked and inline JavaScript or CSS into a single cached file.
* [:octocat: django-pipeline](https://github.com/jazzband/django-pipeline) - :star: 1445 :fork_and_knife: 381 - An asset packaging library for Django.
* [:octocat: django-storages](https://github.com/jschneier/django-storages) - :star: 2210 :fork_and_knife: 777 - A collection of custom storage back ends for Django.
...
* [:octocat: flask-assets](https://github.com/miracle2k/flask-assets) - :star: 429 :fork_and_knife: 91 - Helps you integrate webassets into your Flask app.
...
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 1284 :fork_and_knife: 222 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 562 :fork_and_knife: 47 - Web Content Retrieval for Humans.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 12037 :fork_and_knife: 1965 - News extraction, article extraction and content curation in Python.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 2139 :fork_and_knife: 336 - Fast Python port of arc90's readability tool.
* [:octocat: requests-html](https://github.com/psf/requests-html) - :star: 12642 :fork_and_knife: 899 - Pythonic HTML Parsing for Humans.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 2876 :fork_and_knife: 480 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 3282 :fork_and_knife: 495 - Extract text from any document, Word, PowerPoint, PDFs, etc.
* [:octocat: toapi](https://github.com/gaojiuli/toapi) - :star: 3291 :fork_and_knife: 237 - Every web site provides APIs.
...
* [:octocat: grab](https://github.com/lorien/grab) - :star: 2207 :fork_and_knife: 273 - Site scraping framework.
* [:octocat: MechanicalSoup](https://github.com/MechanicalSoup/MechanicalSoup) - :star: 4054 :fork_and_knife: 375 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 8567 :fork_and_knife: 1376 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 15519 :fork_and_knife: 3651 - A powerful spider system.
* [:octocat: robobrowser](https://github.com/jmcarp/robobrowser) - :star: 3620 :fork_and_knife: 342 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* Synchronous
    * [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
        * [:octocat: awesome-django](https://github.com/shahraizali/awesome-django) - :star: 879 :fork_and_knife: 166
        * [:octocat: awesome-django](https://github.com/wsvincent/awesome-django) - :star: 5786 :fork_and_knife: 922
    * [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
        * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 10758 :fork_and_knife: 1531
    ...
    * [:octocat: Masonite](https://github.com/MasoniteFramework/masonite) - :star: 1856 :fork_and_knife: 117 - The modern and developer centric Python web framework.
* Asynchronous
...
* [:octocat: autobahn-python](https://github.com/crossbario/autobahn-python) - :star: 2361 :fork_and_knife: 758 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: channels](https://github.com/django/channels) - :star: 5352 :fork_and_knife: 735 - Developer-friendly asynchrony for Django.
* [:octocat: websockets](https://github.com/aaugustin/websockets) - :star: 4091 :fork_and_knife: 441 - A library for building WebSocket servers and clients with a focus on correctness and simplicity.

## WSGI Servers

*WSGI-compatible web servers.*

* [:octocat: bjoern](https://github.com/jonashaag/bjoern) - :star: 2809 :fork_and_knife: 189 - Asynchronous, very fast and written in C.
* [:octocat: gunicorn](https://github.com/benoitc/gunicorn) - :star: 8446 :fork_and_knife: 1582 - Pre-forked, partly written in C.
...
* [:octocat: waitress](https://github.com/Pylons/waitress) - :star: 1109 :fork_and_knife: 149 - Multi-threaded, powers Pyramid.
* [:octocat: werkzeug](https://github.com/pallets/werkzeug) - :star: 6142 :fork_and_knife: 1632 - A WSGI utility library for Python that powers Flask and can easily be embedded into your own projects.
...
* Tutorials
    ...
    * [:octocat: Ultimate Python study guide](https://github.com/huangsam/ultimate-python) - :star: 3678 :fork_and_knife: 371
* Libraries
...
* Others
    ...
    * [:octocat: What the f*ck Python!](https://github.com/satwikkansal/wtfpython) - :star: 31428 :fork_and_knife: 2498
