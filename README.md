...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 593 :fork_and_knife: 190 - A module for parsing m3u8 file.
...
* Productivity Tools
    ...
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 4124 :fork_and_knife: 267 - Select files out of bash output.
...
* NoSQL Databases
    ...
    * [:octocat: HappyBase](https://github.com/wbolster/happybase) - :star: 459 :fork_and_knife: 140 - A developer-friendly library for Apache HBase.
...
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 876 :fork_and_knife: 168 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.
...
* GUI / Web Testing
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 2737 :fork_and_knife: 401 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
...
* General
    ...
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 465 :fork_and_knife: 47 - An implementation of figlet written in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 3348 :fork_and_knife: 724 - HTML Content/Article Extractor.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 3226 :fork_and_knife: 275 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 6985 :fork_and_knife: 1103 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 13187 :fork_and_knife: 3239 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 3299 :fork_and_knife: 284 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 7199 :fork_and_knife: 1094
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 463 :fork_and_knife: 52
...
* [:octocat: AutobahnPython](https://github.com/crossbario/autobahn-python) - :star: 2020 :fork_and_knife: 571 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 1652 :fork_and_knife: 235 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 1187 :fork_and_knife: 237 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 1041 :fork_and_knife: 259 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 109348 :fork_and_knife: 14394
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 5783 :fork_and_knife: 505
* Python
    * [:octocat: pycrumbs](https://github.com/kirang89/pycrumbs) - :star: 2853 :fork_and_knife: 688
