...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - :star: 1961 :fork_and_knife: 507 - A module of algorithms for Python.
* [:octocat: PyPattyrn](https://github.com/tylerlaberge/PyPattyrn) - :star: 234 :fork_and_knife: 13 - A simple yet effective library for implementing common design patterns.
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - :star: 10423 :fork_and_knife: 2492 - A collection of design patterns in Python.
...
* [:octocat: audiolazy](https://github.com/danilobellini/audiolazy) - :star: 260 :fork_and_knife: 35 - Expressive Digital Signal Processing (DSP) package for Python.
* [:octocat: audioread](https://github.com/beetbox/audioread) - :star: 126 :fork_and_knife: 42 - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding.
* [:earth_americas: beets](http://beets.io/) - A music library manager and [MusicBrainz](https://musicbrainz.org/) tagger.
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - :star: 2802 :fork_and_knife: 530 - Audio fingerprinting and recognition.
...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 234 :fork_and_knife: 102 - A module for parsing m3u8 file.
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - :star: 2848 :fork_and_knife: 1050 - Authentication app for Django that "just works."
    * [:octocat: django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) - :star: 913 :fork_and_knife: 287 - OAuth 2 goodies for Django.
...
* Others
    ...
    * [:octocat: PyJWT](https://github.com/jpadilla/pyjwt) - :star: 1104 :fork_and_knife: 148 - Implementation of the JSON Web Token draft 01.
    ...
    * [:octocat: python-jwt](https://github.com/davedoesdev/python-jwt) - :star: 115 :fork_and_knife: 12 - Module for generating and verifying JSON Web Tokens.
...
* [:octocat: django-cacheops](https://github.com/Suor/django-cacheops) - :star: 630 :fork_and_knife: 103 - A slick ORM cache with automatic granular event-driven invalidation.
...
* [:octocat: pylibmc](https://github.com/lericson/pylibmc) - :star: 338 :fork_and_knife: 108 - A Python wrapper around the [libmemcached](http://libmemcached.org/libMemcached.html) interface.
...
* Linter
    ...
    * [:octocat: pylama](https://github.com/klen/pylama) - :star: 260 :fork_and_knife: 37 - Code audit tool for Python and JavaScript.
...
* Command-line Application Development
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - :star: 2149 :fork_and_knife: 209 - Python Command-line Application Tools.
...
* Productivity Tools
    ...
    * [:octocat: SAWS](https://github.com/donnemartin/saws) - :star: 3107 :fork_and_knife: 120 - A Supercharged AWS CLI.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - :star: 24021 :fork_and_knife: 1191 - Correcting your previous console command.
...
* [:octocat: Python-Modernize](https://github.com/mitsuhiko/python-modernize) - :star: 432 :fork_and_knife: 34 - Modernizes Python code for eventual Python 3 migration.
...
* [:octocat: pyocr](https://github.com/jflesch/pyocr) - :star: 437 :fork_and_knife: 87 - A wrapper for Tesseract and Cuneiform.
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - :star: 642 :fork_and_knife: 130 - Another wrapper for [Google Tesseract OCR](https://github.com/tesseract-ocr).
...
* [:octocat: gevent](http://www.gevent.org/) - :star: 730 :fork_and_knife: 130 - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
...
* [:octocat: Tomorrow](https://github.com/madisonmay/Tomorrow) - :star: 1204 :fork_and_knife: 66 - Magic decorator syntax for asynchronous code.
...
* [:octocat: python-decouple](https://github.com/henriquebastos/python-decouple) - :star: 354 :fork_and_knife: 26 - Strict separation of settings from code.
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 541 :fork_and_knife: 43 - Implementation of [hashids](http://hashids.org) in Python.
...
* [:octocat: PyNacl](https://github.com/pyca/pynacl) - :star: 337 :fork_and_knife: 70 - Python binding to the Networking and Cryptography (NaCl) library.

## Data Analysis

*Libraries for data analyzing.*

* [:octocat: Blaze](https://github.com/blaze/blaze) - :star: 1841 :fork_and_knife: 253 - NumPy and Pandas interface to Big Data.
* [:octocat: Open Mining](https://github.com/mining/mining) - :star: 694 :fork_and_knife: 114 - Business Intelligence (BI) in Pandas interface.
...
* [:octocat: Cerberus](https://github.com/nicolaiarocci/cerberus/) - :star: 823 :fork_and_knife: 99 - A lightweight and extensible data validation library.
...
* [:octocat: jsonschema](https://github.com/Julian/jsonschema) - :star: 1061 :fork_and_knife: 201 - An implementation of [JSON Schema](http://json-schema.org/) for Python.
* [:octocat: schema](https://github.com/keleshev/schema) - :star: 1017 :fork_and_knife: 88 - A library for validating Python data structures.
* [:octocat: Schematics](https://github.com/schematics/schematics) - :star: 1707 :fork_and_knife: 218 - Data Structure Validation.
...
* [:octocat: voluptuous](https://github.com/alecthomas/voluptuous) - :star: 785 :fork_and_knife: 110 - A Python data validation library.

## Data Visualization

*Libraries for visualizing data. See: [awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization).*

* [:octocat: Altair](https://github.com/altair-viz/altair) - :star: 1139 :fork_and_knife: 94 - Declarative statistical visualization library for Python.
* [:octocat: Bokeh](https://github.com/bokeh/bokeh) - :star: 5400 :fork_and_knife: 1277 - Interactive Web Plotting for Python.
* [:octocat: ggplot](https://github.com/yhat/ggplot) - :star: 2866 :fork_and_knife: 399 - Same API as ggplot2 for R.
...
* [:octocat: Seaborn](https://github.com/mwaskom/seaborn) - :star: 3683 :fork_and_knife: 546 - Statistical data visualization using Matplotlib.
* [:octocat: VisPy](https://github.com/vispy/vispy) - :star: 1226 :fork_and_knife: 272 - High-performance scientific visualization based on OpenGL.
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - :star: 1452 :fork_and_knife: 115 - A tiny, document-oriented database.
...
* MySQL - [awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/)
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - :star: 528 :fork_and_knife: 79 - mysql-python fork supporting Python 3.
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - :star: 2389 :fork_and_knife: 555 - Pure Python MySQL driver compatible to mysql-python.
* PostgreSQL
...
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - :star: 644 :fork_and_knife: 292 - Python driver for Cassandra.
    * [:octocat: HappyBase](https://github.com/wbolster/happybase) - :star: 300 :fork_and_knife: 91 - A developer-friendly library for Apache HBase.
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - :star: 4772 :fork_and_knife: 1201 - The Redis Python Client.
...
* [:octocat: arrow](https://github.com/crsmithdev/arrow) - :star: 4021 :fork_and_knife: 327 - Better dates & times for Python.
...
* [:octocat: Pendulum](https://github.com/sdispater/pendulum) - :star: 1637 :fork_and_knife: 51 - Python datetimes made easy.
...
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - :star: 1139 :fork_and_knife: 85 - Line-by-line profiling.
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 906 :fork_and_knife: 125 - Monitor Memory usage of Python code.
    * [:octocat: profiling](https://github.com/what-studio/profiling) - :star: 2484 :fork_and_knife: 87 - An interactive Python profiler.
* Others
    * [:octocat: pyelftools](https://github.com/eliben/pyelftools) - :star: 426 :fork_and_knife: 165 - Parsing and analyzing ELF files and DWARF debugging information.
...
* [:octocat: Ansible](https://github.com/ansible/ansible) - :star: 21355 :fork_and_knife: 6820 - A radically simple IT automation platform.
...
* [:octocat: cuisine](https://github.com/sebastien/cuisine) - :star: 1204 :fork_and_knife: 148 - Chef-like functionality for Fabric.
...
* [:octocat: Fabtools](https://github.com/ronnix/fabtools) - :star: 1055 :fork_and_knife: 205 - Tools for writing awesome Fabric files.
* [:octocat: honcho](https://github.com/nickstenning/honcho) - :star: 912 :fork_and_knife: 103 - A Python clone of [Foreman](https://github.com/ddollar/foreman), for managing Procfile-based applications.
...
* [:octocat: SaltStack](https://github.com/saltstack/salt) - :star: 7344 :fork_and_knife: 3383 - Infrastructure automation and management system.
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - :star: 3091 :fork_and_knife: 617 - Supervisor process control system for UNIX.
...
* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - :star: 2410 :fork_and_knife: 586 - Converts Python programs into stand-alone executables (cross-platform).
...
* [:earth_americas: Sphinx](http://www.sphinx-doc.org/en/latest/) - Python Documentation generator.
    * [:octocat: awesome-sphinxdoc](https://github.com/yoloseem/awesome-sphinxdoc) - :star: 225 :fork_and_knife: 20
...
* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - :star: 2130 :fork_and_knife: 628 - A command line tool for managing Amazon S3 and CloudFront.
* [:octocat: s4cmd](https://github.com/bloomreach/s4cmd) - :star: 553 :fork_and_knife: 109 - Super S3 command line tool, good for higher performance.
...
* [:octocat: alipay](https://github.com/lxneng/alipay) - :star: 191 :fork_and_knife: 59 - Unofficial Alipay API for Python.
* [:octocat: Cartridge](https://github.com/stephenmcd/cartridge) - :star: 507 :fork_and_knife: 240 - A shopping cart app built using the Mezzanine.
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - :star: 880 :fork_and_knife: 130 - Emacs Python Development Environment.
* Sublime Text
...
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - :star: 1465 :fork_and_knife: 386 - Python Tools for Visual Studio.
* Visual Studio Code
...
* IDE
    ...
    * [:octocat: Spyder](https://github.com/spyder-ide/spyder) - :star: 1788 :fork_and_knife: 429 - Open Source Python IDE.
...
* [:octocat: flanker](https://github.com/mailgun/flanker) - :star: 1020 :fork_and_knife: 107 - A email address and Mime parsing library.
* [:octocat: imbox](https://github.com/martinrusev/imbox) - :star: 667 :fork_and_knife: 95 - Python IMAP for Humans.
* [:octocat: inbox.py](https://github.com/kennethreitz/inbox.py) - :star: 1297 :fork_and_knife: 92 - Python SMTP Server for Humans.
* [:octocat: lamson](https://github.com/zedshaw/lamson) - :star: 586 :fork_and_knife: 167 - Pythonic SMTP Application Server.
* [:octocat: Marrow Mailer](https://github.com/marrow/mailer) - :star: 126 :fork_and_knife: 27 - High-performance extensible mail delivery framework.
...
* [:octocat: yagmail](https://github.com/kootenpv/yagmail) - :star: 687 :fork_and_knife: 47 - Yet another Gmail/SMTP client.
...
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - :star: 6476 :fork_and_knife: 537 - Simple Python version management.
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - :star: 686 :fork_and_knife: 82 - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html).
...
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - :star: 1639 :fork_and_knife: 558 - Bootstrap 3 integration with Django.
...
* [:octocat: Toga](https://github.com/pybee/toga) - :star: 1023 :fork_and_knife: 91 - A Python native, OS native GUI toolkit.
...
* [:octocat: GeoIP](https://github.com/maxmind/geoip-api-python) - :star: 147 :fork_and_knife: 38 - Python API for MaxMind GeoIP Legacy Database.
* [:octocat: geojson](https://github.com/frewsxcv/python-geojson) - :star: 238 :fork_and_knife: 39 - Python bindings and utilities for GeoJSON.
* [:octocat: geopy](https://github.com/geopy/geopy) - :star: 1359 :fork_and_knife: 315 - Python Geocoding Toolbox.
...
* [:octocat: MarkupSafe](https://github.com/pallets/markupsafe) - :star: 148 :fork_and_knife: 53 - Implements a XML/HTML/XHTML Markup safe string for Python.
* [:octocat: pyquery](https://github.com/gawel/pyquery) - :star: 1105 :fork_and_knife: 103 - A jQuery-like library for parsing HTML.
* [:octocat: untangle](https://github.com/stchris/untangle) - :star: 219 :fork_and_knife: 32 - Converts XML documents to Python objects for easy access.
...
* [:octocat: grequests](https://github.com/kennethreitz/grequests) - :star: 1811 :fork_and_knife: 200 - requests + gevent for asynchronous HTTP requests.
...
* [:octocat: treq](https://github.com/twisted/treq) - :star: 326 :fork_and_knife: 89 - Python requests like API built on top of Twisted's HTTP client.
* [:octocat: urllib3](https://github.com/shazow/urllib3) - :star: 1212 :fork_and_knife: 405 - A HTTP library with thread-safe connection pooling, file post support, sanity friendly.
...
* [:octocat: scapy](https://github.com/secdev/scapy) - :star: 919 :fork_and_knife: 254 - A brilliant packet manipulation library.
...
* [:octocat: nude.py](https://github.com/hhatto/nude.py) - :star: 436 :fork_and_knife: 73 - Nudity detection.
...
* [:octocat: pillow](https://github.com/python-pillow/Pillow) - :star: 3210 :fork_and_knife: 704 - Pillow is the friendly [PIL](http://www.pythonware.com/products/pil/) fork.
...
* [:octocat: python-qrcode](https://github.com/lincolnloop/python-qrcode) - :star: 1029 :fork_and_knife: 228 - A pure Python QR Code generator.
* [:octocat: Quads](https://github.com/fogleman/Quads) - :star: 607 :fork_and_knife: 53 - Computer art based on quadtrees.
...
* [:octocat: bpython](https://github.com/bpython/bpython) - :star: 712 :fork_and_knife: 91 - A fancy interface to the Python interpreter.
...
* [:octocat: django-schedule](https://github.com/thauber/django-schedule) - :star: 675 :fork_and_knife: 266 - A calendaring app for Django.
* [:earth_americas: doit](http://pydoit.org/) - A task runner and build tool.
* [:octocat: gunnery](https://github.com/gunnery/gunnery) - :star: 620 :fork_and_knife: 57 - Multipurpose task execution tool for distributed systems with web-based interface.
* [:earth_americas: Joblib](http://pythonhosted.org/joblib/index.html) - A set of tools to provide lightweight pipelining in Python.
* [:octocat: Plan](https://github.com/fengsp/plan) - :star: 957 :fork_and_knife: 72 - Writing crontab file in Python like a charm.
* [:octocat: schedule](https://github.com/dbader/schedule) - :star: 2774 :fork_and_knife: 273 - Python job scheduling for humans.
* [:octocat: Spiff](https://github.com/knipknap/SpiffWorkflow) - :star: 410 :fork_and_knife: 101 - A powerful workflow engine implemented in pure Python.
...
* [:octocat: Eliot](https://github.com/ClusterHQ/eliot) - :star: 164 :fork_and_knife: 16 - Logging for complex & distributed systems.
...
* [:octocat: Raven](https://github.com/getsentry/raven-python) - :star: 1074 :fork_and_knife: 646 - The Python client for Sentry.
...
* [:octocat: gensim](https://github.com/piskvorky/gensim) - :star: 3656 :fork_and_knife: 1374 - Topic Modelling for Humans.
* [:earth_americas: MLlib](http://spark.apache.org/mllib/) - [Apache Spark](http://spark.apache.org/)'s scalable Machine Learning library.
* [:octocat: NuPIC](https://github.com/numenta/nupic) - :star: 4784 :fork_and_knife: 1345 - Numenta Platform for Intelligent Computing.
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - :star: 2327 :fork_and_knife: 956 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano).
...
* [:octocat: dpark](https://github.com/douban/dpark) - :star: 2017 :fork_and_knife: 472 - Python clone of Spark, a MapReduce alike framework in Python.
...
* [:octocat: streamparse](https://github.com/Parsely/streamparse) - :star: 1100 :fork_and_knife: 166 - Run Python code against real-time streams of data. Integrates with [Apache Storm](http://storm.apache.org/).
...
* [:octocat: Jieba](https://github.com/fxsjy/jieba) - :star: 7328 :fork_and_knife: 2295 - Chinese text segmentation.
* [:octocat: langid.py](https://github.com/saffsd/langid.py) - :star: 705 :fork_and_knife: 129 - Stand-alone language identification system.
...
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - :star: 1707 :fork_and_knife: 487 - A library for processing Chinese text.
...
* [:octocat: diesel](https://github.com/dieseldev/diesel) - :star: 538 :fork_and_knife: 54 - Greenlet-based event I/O Framework for Python.
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - :star: 1388 :fork_and_knife: 107 - Event-driven concurrent framework for Python.
...
* Relational Databases
    ...
    * [:earth_americas: SQLAlchemy](http://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
        * [:octocat: awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) - :star: 1286 :fork_and_knife: 82
    * [:octocat: Peewee](https://github.com/coleifer/peewee) - :star: 3604 :fork_and_knife: 669 - A small, expressive ORM.
...
* NoSQL Databases
    * [:octocat: django-mongodb-engine](https://github.com/django-nonrel/mongodb-engine) - :star: 701 :fork_and_knife: 193 - Django MongoDB Backend.
    * [:octocat: flywheel](https://github.com/mathcamp/flywheel) - :star: 89 :fork_and_knife: 14 - Object mapper for Amazon DynamoDB.
    * [:octocat: hot-redis](https://github.com/stephenmcd/hot-redis) - :star: 203 :fork_and_knife: 15 - Rich Python data types for Redis.
...
* Others
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 2594 :fork_and_knife: 154 - A JSON-based database.
...
* [:octocat: conda](https://github.com/conda/conda/) - :star: 1101 :fork_and_knife: 364 - Cross-platform, Python-agnostic binary package manager.
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - :star: 935 :fork_and_knife: 192 - Next generation Python Package Repository (PyPI).
...
* [:octocat: envoy](https://github.com/kennethreitz/envoy) - :star: 1951 :fork_and_knife: 173 - Python [subprocess](https://docs.python.org/2/library/subprocess.html) for Humans.
* [:earth_americas: sarge](http://sarge.readthedocs.io/) - Yet another wrapper for subprocess.
* [:octocat: sh](https://github.com/amoffat/sh) - :star: 3622 :fork_and_knife: 312 - A full-fledged subprocess replacement for Python.
...
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 1113 :fork_and_knife: 115 - Little multi-threaded task queue.
* [:octocat: mrq](https://github.com/pricingassistant/mrq) - :star: 482 :fork_and_knife: 43 - Mr. Queue - A distributed worker task queue in Python using Redis & gevent.
* [:earth_americas: rq](http://python-rq.org/) - Simple job queues for Python.
* [:octocat: simpleq](https://github.com/rdegges/simpleq) - :star: 109 :fork_and_knife: 11 - A simple, infinitely scalable, Amazon SQS based queue.
...
* Flask
    ...
    * [:octocat: flask-restful](https://github.com/flask-restful/flask-restful) - :star: 2528 :fork_and_knife: 495 - Quickly building REST APIs for Flask.
    * [:octocat: flask-restless](https://github.com/jfinkels/flask-restless) - :star: 743 :fork_and_knife: 235 - Generating RESTful APIs for database models defined with SQLAlchemy.
* Pyramid
    * [:octocat: cornice](https://github.com/mozilla-services/cornice) - :star: 296 :fork_and_knife: 135 - A RESTful framework for Pyramid.
* Framework agnostic
    ...
    * [:octocat: sandman](https://github.com/jeffknupp/sandman) - :star: 2264 :fork_and_knife: 179 - Automated REST APIs for existing database-driven systems.
...
* [:octocat: bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) - :star: 390 :fork_and_knife: 197 - Providing best-practice pipelines for fully automated high throughput sequencing analysis.
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - :star: 1952 :fork_and_knife: 467 - Markov Chain Monte Carlo sampling toolkit.
...
* [:octocat: statsmodels](https://github.com/statsmodels/statsmodels) - :star: 1859 :fork_and_knife: 920 - Statistical modeling and econometrics in Python.
* [:octocat: SymPy](https://github.com/sympy/sympy) - :star: 3582 :fork_and_knife: 1801 - A Python library for symbolic mathematics.
* [:octocat: Zipline](https://github.com/quantopian/zipline) - :star: 4432 :fork_and_knife: 1416 - A Pythonic algorithmic trading library.

## Search

*Libraries and software for indexing and performing search queries on data.*

* [:octocat: django-haystack](https://github.com/django-haystack/django-haystack) - :star: 2122 :fork_and_knife: 965 - Modular search for Django.
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - :star: 1117 :fork_and_knife: 260 - The official high-level Python client for Elasticsearch.
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - :star: 2318 :fork_and_knife: 346 - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
...
* Markdown
    ...
    * [:octocat: Python-Markdown](https://github.com/waylan/Python-Markdown) - :star: 1011 :fork_and_knife: 272 - A Python implementation of John Grubers Markdown.
* YAML
    * [:earth_americas: PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [:octocat: csvkit](https://github.com/wireservice/csvkit) - :star: 2523 :fork_and_knife: 362 - Utilities for converting to and working with CSV.
* Archive
    * [:octocat: unp](https://github.com/mitsuhiko/unp) - :star: 252 :fork_and_knife: 23 - A command line tool that can unpack archives easily.

## Static Site Generator

*Static site generator is a software that takes some text + templates as input and produces HTML files on the output.*

* [:octocat: Cactus](https://github.com/koenbok/Cactus/) - :star: 2947 :fork_and_knife: 282 - Static site generator for designers.
...
* [:octocat: django-taggit](https://github.com/alex/django-taggit) - :star: 1592 :fork_and_knife: 423 - Simple tagging for Django.
...
* [:octocat: Jinja2](https://github.com/pallets/jinja) - :star: 3912 :fork_and_knife: 791 - A modern and designer friendly templating language.
...
* Testing Frameworks
    * [:octocat: hypothesis](https://github.com/HypothesisWorks/hypothesis-python) - :star: 1739 :fork_and_knife: 157 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: nose](https://github.com/nose-devs/nose) - :star: 1042 :fork_and_knife: 318 - A nicer unittest for Python.
    ...
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 1334 :fork_and_knife: 511 - A generic test automation framework.
    * [:earth_americas: unittest](https://docs.python.org/2/library/unittest.html) - (Python standard library) Unit testing framework.
* Test Runners
    * [:octocat: green](https://github.com/CleanCut/green) - :star: 408 :fork_and_knife: 34 - A clean, colorful test runner.
...
* GUI / Web Testing
    ...
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1240 :fork_and_knife: 127 - A language-agnostic A/B Testing framework.
    * [:octocat: splinter](https://github.com/cobrateam/splinter) - :star: 1303 :fork_and_knife: 302 - Open source tool for testing web applications.
* Mock
    * [:earth_americas: doublex](https://pypi.python.org/pypi/doublex) - Powerful test doubles framework for Python.
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 932 :fork_and_knife: 93 - Travel through time by mocking the datetime module.
    * [:octocat: httmock](https://github.com/patrys/httmock) - :star: 275 :fork_and_knife: 30 - A mocking library for requests for Python 2.6+ and 3.2+.
    * [:octocat: httpretty](https://github.com/gabrielfalcao/HTTPretty) - :star: 1330 :fork_and_knife: 195 - HTTP request mock tool for Python.
...
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - :star: 1090 :fork_and_knife: 149 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 380 :fork_and_knife: 41 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
    * [:octocat: model_mommy](https://github.com/vandersonmota/model_mommy) - :star: 631 :fork_and_knife: 140 - Creating random fixtures for testing in Django.
* Code Coverage
    * [:earth_americas: coverage](https://pypi.python.org/pypi/coverage) - Code coverage measurement.
* Fake Data
    * [:octocat: church](https://github.com/lk-geimfari/church) - :star: 935 :fork_and_knife: 67 - is a Python library that help you generate fake data.
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 1715 :fork_and_knife: 77 - Fake database generator.
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 4397 :fork_and_knife: 498 - A Python package that generates fake data.
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 674 :fork_and_knife: 93 - Python 2/3 compatible character encoding detector.
    ...
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 2970 :fork_and_knife: 318 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 276 :fork_and_knife: 54 - Fast computation of Levenshtein distance and string similarity.
    * [:octocat: pangu.py](https://github.com/vinta/pangu.py) - :star: 55 :fork_and_knife: 7 - Spacing texts for CJK and alphanumerics.
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 196 :fork_and_knife: 24 - An implementation of figlet written in Python.
    * [:octocat: shortuuid](https://github.com/stochastic-technologies/shortuuid) - :star: 705 :fork_and_knife: 53 - A generator library for concise, unambiguous and URL-safe UUIDs.
    ...
    * [:octocat: xpinyin](https://github.com/lxneng/xpinyin) - :star: 405 :fork_and_knife: 107 - A library to translate Chinese hanzi (??) to pinyin (??).
* Slugify
...
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 1426 :fork_and_knife: 185 - Parsing, formatting, storing and validating international phone numbers.
    ...
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 448 :fork_and_knife: 98 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 830 :fork_and_knife: 207 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 1843 :fork_and_knife: 355 - Python interface to Amazon Web Services.
* [:octocat: django-wordpress](https://github.com/sunlightlabs/django-wordpress/) - :star: 230 :fork_and_knife: 53 - WordPress models and views for Django.
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 1881 :fork_and_knife: 717 - Facebook Platform Python SDK.
...
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 2004 :fork_and_knife: 378 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1285 :fork_and_knife: 318 - A Python wrapper for the Twitter API.
...
* [:octocat: scikit-video](https://github.com/aizvorski/scikit-video) - :star: 49 :fork_and_knife: 6 - Video processing routines for SciPy.
...
* [:octocat: Haul](https://github.com/vinta/Haul) - :star: 80 :fork_and_knife: 25 - An Extensible Image Crawler.
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 332 :fork_and_knife: 70 - Convert HTML to Markdown-formatted text.
* [:octocat: lassie](https://github.com/michaelhelmick/lassie) - :star: 329 :fork_and_knife: 20 - Web Content Retrieval for Humans.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 4276 :fork_and_knife: 627 - News extraction, article extraction and content curation in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 2305 :fork_and_knife: 560 - HTML Content/Article Extractor.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1112 :fork_and_knife: 212 - Fast Python port of arc90's readability tool.
...
* [:octocat: cola](https://github.com/chineking/cola) - :star: 1061 :fork_and_knife: 488 - A distributed crawling framework.
...
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 4802 :fork_and_knife: 725 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 8254 :fork_and_knife: 2173 - A powerful spider system.
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 4944 :fork_and_knife: 906
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 3531 :fork_and_knife: 571
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 323 :fork_and_knife: 37
...
* [:octocat: AutobahnPython](https://github.com/crossbario/autobahn-python) - :star: 1348 :fork_and_knife: 415 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 1130 :fork_and_knife: 150 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
...
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 52113 :fork_and_knife: 6403
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 4090 :fork_and_knife: 325
* Python
    * [:octocat: pycrumbs](https://github.com/kirang89/pycrumbs) - :star: 2507 :fork_and_knife: 660
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 318 :fork_and_knife: 66
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 1738 :fork_and_knife: 367
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 507 :fork_and_knife: 111
