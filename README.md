...
* [:octocat: p](https://github.com/qw3rtman/p) - Dead simple interactive Python version management. :star: 491 :fork_and_knife: 14
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - Simple Python version management. :star: 3181 :fork_and_knife: 233
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - Next generation Python Package Repository (PyPI). :star: 287 :fork_and_knife: 64
...
* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - Converts Python programs into stand-alone executables (cross-platform). :star: 1181 :fork_and_knife: 330
...
* [:octocat: PlatformIO](https://github.com/ivankravets/platformio) - A console tool to build code with different development platforms. :star: 283 :fork_and_knife: 38
...
* [:octocat: IPython](https://github.com/ipython/ipython) - A rich toolkit to help you make the most out of using Python interactively. :star: 7592 :fork_and_knife: 2248
* [:earth_americas: bpython](http://bpython-interpreter.org) – A fancy interface to the Python interpreter.
* [:octocat: ptpython](https://github.com/jonathanslenders/ptpython) - Advanced Python REPL built on top of the [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit). :star: 810 :fork_and_knife: 21
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html). :star: 537 :fork_and_knife: 71
...
* [:octocat: arrow](https://github.com/crsmithdev/arrow) - Better dates & times for Python. :star: 2530 :fork_and_knife: 215
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - Python 2/3 compatible character encoding detector. :star: 377 :fork_and_knife: 62
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - A module for Tabular Datasets in XLS, CSV, JSON, YAML. :star: 1584 :fork_and_knife: 221
* Office
    ...
    * [:octocat: python-docx](https://github.com/python-openxml/python-docx) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. :star: 368 :fork_and_knife: 133
    ...
    * [:octocat: xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - Writing and reading data and formatting information from Excel files. :star: 439 :fork_and_knife: 154
* PDF
    * [:octocat: PDFMiner](https://github.com/euske/pdfminer) - A tool for extracting information from PDF documents. :star: 1220 :fork_and_knife: 306
    * [:octocat: PyPDF2](https://github.com/mstamy2/PyPDF2) - A library capable of splitting, merging and transforming PDF pages. :star: 748 :fork_and_knife: 230
    * [:earth_americas: ReportLab](http://www.reportlab.com/opensource/) - Allowing Rapid creation of rich PDF documents.
* Markdown
    * [:octocat: Mistune](https://github.com/lepture/mistune) - Fastest and full featured pure Python parsers of Markdown. :star: 478 :fork_and_knife: 34
...
* CSV
    * [:octocat: csvkit](https://github.com/onyxfish/csvkit) - Utilities for converting to and working with CSV. :star: 1704 :fork_and_knife: 264
* Archive
...
* [:octocat: jieba](https://github.com/fxsjy/jieba) - Chinese Words Segmentation Utilities. :star: 3769 :fork_and_knife: 1178
...
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - A library for processing Chinese text. :star: 1031 :fork_and_knife: 271
...
* [:earth_americas: Sphinx](http://sphinx-doc.org/) - Python Documentation generator.
    * [:octocat: awesome-sphinxdoc](https://github.com/yoloseem/awesome-sphinxdoc) :star: 116 :fork_and_knife: 8
...
* Command-line Application Development
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - Python Command-line Application Tools. :star: 1813 :fork_and_knife: 168
    ...
    * [:octocat: Gooey](https://github.com/chriskiehl/Gooey) - Turn command line programs into a full GUI application with one line :star: 3687 :fork_and_knife: 174
    ...
    * [:octocat: python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) - A Library for building powerful interactive command lines. :star: 1722 :fork_and_knife: 81
* Productivity Tools
    ...
    * [:octocat: cookiecutter](https://github.com/audreyr/cookiecutter) - A command-line utility that creates projects from cookiecutters (project templates). E.g. Python package projects, jQuery plugin projects. :star: 2376 :fork_and_knife: 287
    * [:octocat: doitlive](https://github.com/sloria/doitlive) - A tool for live presentations in the terminal. :star: 599 :fork_and_knife: 17
    * [:octocat: httpie](https://github.com/jakubroztocil/httpie) - A command line HTTP client, a user-friendly cURL replacement. :star: 18072 :fork_and_knife: 1030
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - Select files out of bash output. :star: 2533 :fork_and_knife: 122
    * [:octocat: percol](https://github.com/mooz/percol) - Adds flavor of interactive selection to the traditional pipe concept on UNIX. :star: 1795 :fork_and_knife: 72
    * [:earth_americas: RainbowStream](http://www.rainbowstream.org/) - Smart and nice Twitter client on terminal.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - Correcting your previous console command. :star: 14393 :fork_and_knife: 682

## Downloader

*Libraries for downloading.*

* [:octocat: coursera](https://github.com/coursera-dl/coursera) - Script for downloading Coursera.org videos and naming them. :star: 2498 :fork_and_knife: 917
* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - A command line tool for managing Amazon S3 and CloudFront. :star: 1578 :fork_and_knife: 522
* [:octocat: s4cmd](https://github.com/bloomreach/s4cmd) - Super S3 command line tool, good for higher performance. :star: 284 :fork_and_knife: 55
...
* [:octocat: nude.py](https://github.com/hhatto/nude.py) - Nudity detection. :star: 283 :fork_and_knife: 29
...
* [:octocat: thumbor](https://github.com/thumbor/thumbor) - A smart imaging service. It enables on-demand crop, re-sizing and flipping of images. :star: 3331 :fork_and_knife: 310
* [:octocat: wand](https://github.com/dahlia/wand) - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick. :star: 488 :fork_and_knife: 115
...
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - Another wrapper for Google Tesseract OCR. :star: 287 :fork_and_knife: 71
...
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - Audio fingerprinting and recognition. :star: 1800 :fork_and_knife: 291
...
* [:octocat: pydub](https://github.com/jiaaro/pydub) - Manipulate audio with a simple and easy high level interface. :star: 1224 :fork_and_knife: 114
...
* [:octocat: geopy](https://github.com/geopy/geopy) - Python Geocoding Toolbox. :star: 863 :fork_and_knife: 227
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - A tiny, document-oriented database. :star: 535 :fork_and_knife: 39
...
* Relational Databases
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL. :star: 1553 :fork_and_knife: 99
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - Pure Python MySQL driver compatible to mysql-python. :star: 1231 :fork_and_knife: 293
...
* NoSQL Databases
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - The Redis Python Client. :star: 3589 :fork_and_knife: 884
...
* Relational Databases
    ...
    * [:octocat: peewee](https://github.com/coleifer/peewee) - A small, expressive ORM. :star: 2225 :fork_and_knife: 362
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) :star: 2773 :fork_and_knife: 429
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) :star: 1511 :fork_and_knife: 197
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/ITCase/awesome-pyramid) :star: 185 :fork_and_knife: 18
...
* [:octocat: guava](https://github.com/flatpeach/guava) - A lightweight and high performance web framework for Python written in C. :star: 131 :fork_and_knife: 8
...
* [:octocat: django-rules](https://github.com/dfunckt/django-rules) - A tiny but powerful app providing object-level permissions to Django, without requiring a database. :star: 226 :fork_and_knife: 17
...
* [:octocat: eve](https://github.com/nicolaiarocci/eve) - REST API framework powered by Flask, MongoDB and good intentions. :star: 2625 :fork_and_knife: 358
...
* OAuth
    ...
    * [:octocat: Flask-OAuthlib](https://github.com/lepture/flask-oauthlib) - OAuth 1.0/a, 2.0 implementation of client and provider for Flask. :star: 555 :fork_and_knife: 161
    * [:octocat: OAuthLib](https://github.com/idan/oauthlib) - A generic and thorough implementation of the OAuth request-signing logic. :star: 973 :fork_and_knife: 219
    * [:octocat: python-oauth2](https://github.com/simplegeo/python-oauth2) - A fully tested, abstract interface to creating OAuth clients and servers. :star: 2295 :fork_and_knife: 913
    * [:octocat: python-social-auth](https://github.com/omab/python-social-auth) - An easy-to-setup social authentication mechanism. :star: 1889 :fork_and_knife: 797
...
* [:octocat: Jinja2](https://github.com/mitsuhiko/jinja2) - A modern and designer friendly templating language. :star: 2737 :fork_and_knife: 563
...
* [:octocat: django-haystack](https://github.com/toastdriven/django-haystack) - Modular search for Django. :star: 1802 :fork_and_knife: 765
...
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - The official high-level Python client for Elasticsearch. :star: 534 :fork_and_knife: 123
...
* [:octocat: Feedly](https://github.com/tschellenbach/Feedly) - A library to build newsfeed and notification systems using Cassandra and Redis. :star: 1775 :fork_and_knife: 209
...
* [:octocat: django-cacheops](https://github.com/Suor/django-cacheops) - A slick ORM cache with automatic granular event-driven invalidation. :star: 464 :fork_and_knife: 72
...
* [:octocat: inbox](https://github.com/inboxapp/inbox) - The open source email toolkit. :star: 2434 :fork_and_knife: 202
...
* [:octocat: pyquery](https://github.com/gawel/pyquery) - A jQuery-like library for parsing HTML. :star: 788 :fork_and_knife: 72
...
* [:octocat: xmltodict](https://github.com/martinblech/xmltodict) - Working with XML feel like you are working with JSON. :star: 1764 :fork_and_knife: 160
...
* [:octocat: portia](https://github.com/scrapinghub/portia) - Visual scraping for Scrapy. :star: 3443 :fork_and_knife: 476
* [:octocat: pyspider](https://github.com/binux/pyspider) - A powerful spider system. :star: 5251 :fork_and_knife: 1234
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - News extraction, article extraction and content curation in Python. :star: 2548 :fork_and_knife: 317
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - HTML Content/Article Extractor. :star: 1582 :fork_and_knife: 357
...
* [:octocat: sumy](https://github.com/miso-belica/sumy) - A module for automatic summarization of text documents and HTML pages. :star: 239 :fork_and_knife: 48
* [:octocat: textract](https://github.com/deanmalmgren/textract) - Extract text from any document, Word, PowerPoint, PDFs, etc. :star: 1612 :fork_and_knife: 125
...
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - Bootstrap 3 integration with Django. :star: 1126 :fork_and_knife: 349
...
* [:octocat: django-xadmin](https://github.com/sshwsfc/django-xadmin) - Drop-in replacement of Django admin comes with lots of goodies. :star: 1418 :fork_and_knife: 430
...
* [:octocat: flower](https://github.com/mher/flower) - Real-time monitor and web admin for Celery. :star: 1404 :fork_and_knife: 259
...
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - WebSockets for Django. :star: 792 :fork_and_knife: 150
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - Implementation of [hashids](http://hashids.org) in Python. :star: 327 :fork_and_knife: 32
...
* Testing Frameworks
    ...
    * [:octocat: hypothesis](https://github.com/DRMacIver/hypothesis) - Hypothesis is an advanced Quickcheck style property based testing library. :star: 853 :fork_and_knife: 77
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - PyAutoGUI is a cross-platform GUI automation Python module for human beings. :star: 269 :fork_and_knife: 35
    ...
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - A generic test automation framework. :star: 588 :fork_and_knife: 218
* Web Testing
    ...
    * [:octocat: locust](https://github.com/locustio/locust) - Scalable user load testing tool written in Python. :star: 2790 :fork_and_knife: 347
...
* Mock
    ...
    * [:octocat: responses](https://github.com/dropbox/responses) - A utility library for mocking out the requests Python library. :star: 1059 :fork_and_knife: 80
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - Record and replay HTTP interactions on your tests. :star: 519 :fork_and_knife: 79
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - A test fixtures replacement for Python. :star: 764 :fork_and_knife: 111
...
* Error Handler
    * [:octocat: FuckIt.py](https://github.com/ajalt/fuckitpy) - FuckIt.py uses state-of-the-art technology to make sure your Python code runs whether it has any right to or not. :star: 1865 :fork_and_knife: 70
...
* Code Analysis
    * [:octocat: code2flow](https://github.com/scottrogowski/code2flow) - Turn your Python and JavaScript code into DOT flowcharts. :star: 183 :fork_and_knife: 22
    * [:octocat: pycallgraph](https://github.com/gak/pycallgraph) - A library that visualises the flow (call graph) of your Python application. :star: 520 :fork_and_knife: 88
    * [:octocat: pysonar2](https://github.com/yinwang0/pysonar2) - A type inferencer and indexer for Python. :star: 1735 :fork_and_knife: 445
* Linter
...
* Debugger
    ...
    * [:octocat: wdb](https://github.com/Kozea/wdb) - An improbable web debugger through WebSockets. :star: 772 :fork_and_knife: 39
    ...
    * [:octocat: django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) - Display various debug information about the current request/response. :star: 3298 :fork_and_knife: 631
...
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - Line-by-line profiling. :star: 518 :fork_and_knife: 35
...
* Others
    * [:octocat: pyelftools](https://github.com/eliben/pyelftools) - A pure-Python library for parsing and analyzing ELF files and DWARF debugging information. :star: 215 :fork_and_knife: 80
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - Markov Chain Monte Carlo sampling toolkit. :star: 1239 :fork_and_knife: 263
...
* [:octocat: SymPy](https://github.com/sympy/sympy) - A Python library for symbolic mathematics. :star: 2386 :fork_and_knife: 1166
* [:octocat: zipline](https://github.com/quantopian/zipline) - A Pythonic algorithmic trading library. :star: 2587 :fork_and_knife: 706
...
* [:octocat: bokeh](https://github.com/ContinuumIO/bokeh) - Interactive Web Plotting for Python. :star: 3303 :fork_and_knife: 601
* [:octocat: ggplot](https://github.com/yhat/ggplot) - Same API as ggplot2 for R. :star: 2284 :fork_and_knife: 284
...
* [:octocat: vincent](https://github.com/wrobstory/vincent) - A Python to Vega translator. :star: 1505 :fork_and_knife: 169
...
* [:octocat: Crab](https://github.com/muricoca/crab) - A ﬂexible, fast recommender engine. :star: 564 :fork_and_knife: 213
* [:octocat: gensim](https://github.com/piskvorky/gensim) - Topic Modelling for Humans. :star: 1812 :fork_and_knife: 650
...
* [:octocat: NuPIC](https://github.com/numenta/nupic) - Numenta Platform for Intelligent Computing. :star: 3483 :fork_and_knife: 934
* [:octocat: pattern](https://github.com/clips/pattern) - Web mining module for Python. :star: 3622 :fork_and_knife: 562
* [:octocat: PyBrain](https://github.com/pybrain/pybrain) - Another Python Machine Learning Library. :star: 1434 :fork_and_knife: 447
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - A Machine Learning library based on [Theano](https://github.com/Theano/Theano). :star: 1780 :fork_and_knife: 712
* [:octocat: python-recsys](https://github.com/ocelma/python-recsys) - A Python library for implementing a Recommender System. :star: 451 :fork_and_knife: 193
...
* [:octocat: dpark](https://github.com/douban/dpark) - Python clone of Spark, a MapReduce alike framework in Python. :star: 1461 :fork_and_knife: 346
...
* [:octocat: luigi](https://github.com/spotify/luigi) - A module that helps you build complex pipelines of batch jobs. :star: 3321 :fork_and_knife: 596
...
* [:octocat: streamparse](https://github.com/Parsely/streamparse) - Run Python code against real-time streams of data. Integrates with [Apache Storm](https://storm.incubator.apache.org/). :star: 850 :fork_and_knife: 107

## Functional Programming

*Functional Programming with Python.*

* [:octocat: CyToolz](https://github.com/pytoolz/cytoolz/) - Cython implementation of Toolz: High performance functional utilities. :star: 215 :fork_and_knife: 16
* [:octocat: fn.py](https://github.com/kachayev/fn.py) - Functional programming in Python: implementation of missing features to enjoy FP. :star: 1705 :fork_and_knife: 95
* [:octocat: funcy](https://github.com/Suor/funcy) - A fancy and practical functional tools. :star: 1202 :fork_and_knife: 61
* [:octocat: Toolz](https://github.com/pytoolz/toolz) - A collection of functional utilities for iterators, functions, and dictionaries. :star: 891 :fork_and_knife: 70
...
* [:octocat: boto](https://github.com/boto/boto) - Python interface to Amazon Web Services. :star: 5168 :fork_and_knife: 1864
...
* [:octocat: facebook-sdk](https://github.com/pythonforfacebook/facebook-sdk) - Facebook Platform Python SDK. :star: 1477 :fork_and_knife: 542
* [:octocat: facepy](https://github.com/jgorset/facepy) - Facepy makes it really easy to interact with Facebook's Graph API :star: 391 :fork_and_knife: 120
* [:octocat: gmail](https://github.com/charlierguo/gmail) - A Pythonic interface for Gmail. :star: 1142 :fork_and_knife: 181
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - Google APIs Client Library for Python. :star: 626 :fork_and_knife: 233
* [:octocat: gspread](https://github.com/burnash/gspread) - Google Spreadsheets Python API. :star: 1311 :fork_and_knife: 256
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - A Python wrapper for the Twitter API. :star: 1059 :fork_and_knife: 275

## DevOps Tools

*Software and libraries for DevOps.*

* [:octocat: Ansible](https://github.com/ansible/ansible) - A radically simple IT automation platform. :star: 13032 :fork_and_knife: 3895
* [:octocat: SaltStack](https://github.com/saltstack/salt) - Infrastructure automation and management system. :star: 5726 :fork_and_knife: 2447
...
* [:octocat: Fabtools](https://github.com/ronnix/fabtools) - Tools for writing awesome Fabric files. :star: 885 :fork_and_knife: 181
* [:earth_americas: gitapi](http://bitbucket.org/haard/gitapi) - Pure-Python API for git.
* [:octocat: gunnery](https://github.com/gunnery/gunnery) - Multipurpose task execution tool for distributed systems with web-based interface. :star: 559 :fork_and_knife: 49
...
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - Supervisor process control system for UNIX. :star: 1989 :fork_and_knife: 419
...
* [:octocat: Plan](https://github.com/fengsp/plan) - Writing crontab file in Python like a charm. :star: 835 :fork_and_knife: 59
* [:octocat: schedule](https://github.com/dbader/schedule) - Python job scheduling for humans. :star: 1584 :fork_and_knife: 134
...
* [:octocat: Pyston](https://github.com/dropbox/pyston) - A Python implementation built using LLVM and modern JIT techniques with the goal of achieving good performance. :star: 3169 :fork_and_knife: 222
...
* [:octocat: PyUserInput](https://github.com/SavinaRoja/PyUserInput) - A module for cross-platform control of the mouse and keyboard. :star: 323 :fork_and_knife: 68
...
* [:octocat: blinker](https://github.com/jek/blinker) - A fast Python in-process signal/event dispatching system. :star: 236 :fork_and_knife: 27
...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - A module of algorithms for Python. :star: 1171 :fork_and_knife: 291
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - A collection of design patterns in Python. :star: 6963 :fork_and_knife: 1627
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - Emacs Python Development Environment. :star: 545 :fork_and_knife: 82
* Sublime Text
    * [:octocat: SublimeJEDI](https://github.com/srusskih/SublimeJEDI) - A Sublime Text plugin to the awesome auto-complete library Jedi. :star: 542 :fork_and_knife: 62
...
* Vim
    * [:octocat: YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - Includes [Jedi](https://github.com/davidhalter/jedi)-based completion engine for Python. :star: 8715 :fork_and_knife: 995
    * [:octocat: Jedi-vim](https://github.com/davidhalter/jedi-vim) - Vim bindings for the Jedi auto-completion library for Python. :star: 1973 :fork_and_knife: 165
    * [:octocat: Python-mode](https://github.com/klen/python-mode) - An all in one plugin for turning Vim into a Python IDE. :star: 2657 :fork_and_knife: 552
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - Python Tools for Visual Studio. :star: 594 :fork_and_knife: 140
...
* [:octocat: Spyder](https://github.com/spyder-ide/spyder) - Open Source Python IDE. :star: 553 :fork_and_knife: 157
...
* Python
    ...
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) :star: 143 :fork_and_knife: 19
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) :star: 1359 :fork_and_knife: 214
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) :star: 263 :fork_and_knife: 50
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) :star: 20089 :fork_and_knife: 2075
    * [:octocat: lists](https://github.com/jnv/lists) :star: 3427 :fork_and_knife: 209
