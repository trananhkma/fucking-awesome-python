...
* [:octocat: Ajenti](https://github.com/Eugeny/ajenti) - :star: 216 :fork_and_knife: 42 - The admin panel your servers deserve.
* [:earth_americas: django-suit](http://djangosuit.com/) - Alternative Django Admin-Interface (free only for Non-commercial use).
* [:octocat: django-xadmin](https://github.com/sshwsfc/xadmin) - :star: 1866 :fork_and_knife: 585 - Drop-in replacement of Django admin comes with lots of goodies.
* [:octocat: flask-admin](https://github.com/flask-admin/flask-admin) - :star: 2083 :fork_and_knife: 687 - Simple and extensible administrative interface framework for Flask.
* [:octocat: flower](https://github.com/mher/flower) - :star: 2066 :fork_and_knife: 379 - Real-time monitor and web admin for Celery.
* [:earth_americas: Grappelli](http://grappelliproject.com) - A jazzy skin for the Django Admin-Interface.
* [:octocat: Wooey](https://github.com/wooey/wooey) - :star: 768 :fork_and_knife: 69 - A Django app which creates automatic web UIs for Python scripts.

## Algorithms and Design Patterns

*Python implementation of algorithms and design patterns.*

* [:octocat: algorithms](https://github.com/nryoung/algorithms) - :star: 1926 :fork_and_knife: 498 - A module of algorithms for Python.
* [:octocat: PyPattyrn](https://github.com/tylerlaberge/PyPattyrn) - :star: 225 :fork_and_knife: 13 - A simple yet effective library for implementing common design patterns.
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - :star: 10232 :fork_and_knife: 2461 - A collection of design patterns in Python.
...
* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 1808 :fork_and_knife: 500 - Compresses linked and inline JavaScript or CSS into a single cached file.
* [:octocat: django-pipeline](https://github.com/jazzband/django-pipeline) - :star: 1115 :fork_and_knife: 297 - An asset packaging library for Django.
* [:octocat: django-storages](https://github.com/jschneier/django-storages) - :star: 530 :fork_and_knife: 211 - A collection of custom storage back ends for Django.
...
* [:octocat: webassets](https://github.com/miracle2k/webassets) - :star: 780 :fork_and_knife: 224 - Bundles, optimizes, and manages unique cache-busting URLs for static resources.
...
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - :star: 2770 :fork_and_knife: 522 - Audio fingerprinting and recognition.
...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 231 :fork_and_knife: 100 - A module for parsing m3u8 file.
...
* [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 1678 :fork_and_knife: 180 - Manipulate audio with a simple and easy high level interface.
* [:octocat: pyechonest](https://github.com/echonest/pyechonest) - :star: 589 :fork_and_knife: 1106 - Python client for the [Echo Nest](http://developer.echonest.com/) API.
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - :star: 2803 :fork_and_knife: 1031 - Authentication app for Django that "just works."
    * [:octocat: django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) - :star: 902 :fork_and_knife: 279 - OAuth 2 goodies for Django.
    * [:octocat: Flask-OAuthlib](https://github.com/lepture/flask-oauthlib) - :star: 871 :fork_and_knife: 251 - OAuth 1.0/a, 2.0 implementation of client and provider for Flask.
    * [:octocat: OAuthLib](https://github.com/idan/oauthlib) - :star: 1291 :fork_and_knife: 280 - A generic and thorough implementation of the OAuth request-signing logic.
    * [:octocat: python-oauth2](https://github.com/joestump/python-oauth2) - :star: 2534 :fork_and_knife: 983 - A fully tested, abstract interface to creating OAuth clients and servers.
    * [:octocat: python-social-auth](https://github.com/omab/python-social-auth) - :star: 2596 :fork_and_knife: 1151 - An easy-to-setup social authentication mechanism.
...
* Others
    ...
    * [:octocat: PyJWT](https://github.com/jpadilla/pyjwt) - :star: 1087 :fork_and_knife: 147 - Implementation of the JSON Web Token draft 01.
    ...
    * [:octocat: python-jwt](https://github.com/davedoesdev/python-jwt) - :star: 114 :fork_and_knife: 11 - Module for generating and verifying JSON Web Tokens.
...
* [:octocat: PlatformIO](https://github.com/platformio/platformio) - :star: 1450 :fork_and_knife: 213 - A console tool to build code with different development platforms.
* [:octocat: PyBuilder](https://github.com/pybuilder/pybuilder) - :star: 799 :fork_and_knife: 164 - A continuous build tool written in pure Python.
...
* [:octocat: django-cacheops](https://github.com/Suor/django-cacheops) - :star: 625 :fork_and_knife: 103 - A slick ORM cache with automatic granular event-driven invalidation.
...
* Code Analysis
    ...
    * [:octocat: pysonar2](https://github.com/yinwang0/pysonar2) - :star: 2386 :fork_and_knife: 646 - A type inferencer and indexer for Python.
* Linter
    * [:earth_americas: Flake8](https://pypi.python.org/pypi/flake8) - The modular source code checker: pep8, pyflakes and co.
    * [:octocat: pylama](https://github.com/klen/pylama) - :star: 258 :fork_and_knife: 36 - Code audit tool for Python and JavaScript.
...
* Command-line Application Development
    * [:octocat: asciimatics](https://github.com/peterbrittain/asciimatics) - :star: 457 :fork_and_knife: 32 - Cross-platform, full-screen terminal package (i.e.  mouse/keyboard input and coloured, positioned text output) complete with high-level API for complex animations and special effects.
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - :star: 2135 :fork_and_knife: 204 - Python Command-line Application Tools.
    ...
    * [:octocat: Gooey](https://github.com/chriskiehl/Gooey) - :star: 4421 :fork_and_knife: 240 - Turn command line programs into a full GUI application with one line
    * [:octocat: python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) - :star: 3253 :fork_and_knife: 201 - A Library for building powerful interactive command lines.
* Productivity Tools
    * [:octocat: aws-cli](https://github.com/aws/aws-cli) - :star: 4522 :fork_and_knife: 739 - A universal command-line interface for Amazon Web Services.
    * [:octocat: bashplotlib](https://github.com/glamp/bashplotlib) - :star: 663 :fork_and_knife: 51 - Making basic plots in the terminal.
    * [:octocat: caniusepython3](https://github.com/brettcannon/caniusepython3) - :star: 267 :fork_and_knife: 33 - Determine what projects are blocking you from porting to Python 3.
    * [:octocat: cookiecutter](https://github.com/audreyr/cookiecutter) - :star: 4402 :fork_and_knife: 521 - A command-line utility that creates projects from cookiecutters (project templates).
    ...
    * [:octocat: howdoi](https://github.com/gleitz/howdoi) - :star: 4864 :fork_and_knife: 449 - Instant coding answers via the command line.
    * [:octocat: httpie](https://github.com/jkbrzt/httpie) - :star: 27832 :fork_and_knife: 1800 - A command line HTTP client, a user-friendly cURL replacement.
    * [:octocat: mycli](https://github.com/dbcli/mycli) - :star: 3333 :fork_and_knife: 175 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 3140 :fork_and_knife: 195 - Select files out of bash output.
    * [:octocat: percol](https://github.com/mooz/percol) - :star: 2228 :fork_and_knife: 103 - Adds flavor of interactive selection to the traditional pipe concept on UNIX.
    * [:octocat: pgcli](https://github.com/dbcli/pgcli) - :star: 5170 :fork_and_knife: 214 - Postgres CLI with autocompletion and syntax highlighting.
    * [:octocat: SAWS](https://github.com/donnemartin/saws) - :star: 3088 :fork_and_knife: 120 - A Supercharged AWS CLI.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - :star: 23690 :fork_and_knife: 1146 - Correcting your previous console command.
...
* [:octocat: Python-Modernize](https://github.com/mitsuhiko/python-modernize) - :star: 430 :fork_and_knife: 34 - Modernizes Python code for eventual Python 3 migration.
...
* [:octocat: pyocr](https://github.com/jflesch/pyocr) - :star: 433 :fork_and_knife: 82 - A wrapper for Tesseract and Cuneiform.
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - :star: 629 :fork_and_knife: 128 - Another wrapper for [Google Tesseract OCR](https://github.com/tesseract-ocr).
...
* [:octocat: gevent](http://www.gevent.org/) - :star: 726 :fork_and_knife: 130 - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
...
* [:octocat: Tomorrow](https://github.com/madisonmay/Tomorrow) - :star: 1206 :fork_and_knife: 67 - Magic decorator syntax for asynchronous code.
* [:octocat: uvloop](https://github.com/MagicStack/uvloop) - :star: 2913 :fork_and_knife: 109 - Ultra fast implementation of asyncio event loop on top of libuv.
...
* [:octocat: python-decouple](https://github.com/henriquebastos/python-decouple) - :star: 338 :fork_and_knife: 25 - Strict separation of settings from code.
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 535 :fork_and_knife: 41 - Implementation of [hashids](http://hashids.org) in Python.
...
* [:octocat: Blaze](https://github.com/blaze/blaze) - :star: 1822 :fork_and_knife: 252 - NumPy and Pandas interface to Big Data.
* [:octocat: Open Mining](https://github.com/mining/mining) - :star: 688 :fork_and_knife: 115 - Business Intelligence (BI) in Pandas interface.
...
* [:octocat: Cerberus](https://github.com/nicolaiarocci/cerberus/) - :star: 811 :fork_and_knife: 99 - A lightweight and extensible data validation library.
...
* [:octocat: jsonschema](https://github.com/Julian/jsonschema) - :star: 1046 :fork_and_knife: 198 - An implementation of [JSON Schema](http://json-schema.org/) for Python.
* [:octocat: schema](https://github.com/keleshev/schema) - :star: 1005 :fork_and_knife: 87 - A library for validating Python data structures.
* [:octocat: Schematics](https://github.com/schematics/schematics) - :star: 1694 :fork_and_knife: 214 - Data Structure Validation.
...
* [:octocat: voluptuous](https://github.com/alecthomas/voluptuous) - :star: 756 :fork_and_knife: 110 - A Python data validation library.

## Data Visualization

*Libraries for visualizing data. See: [awesome-javascript](https://github.com/sorrycc/awesome-javascript#data-visualization).*

* [:octocat: Altair](https://github.com/altair-viz/altair) - :star: 1106 :fork_and_knife: 92 - Declarative statistical visualization library for Python.
* [:octocat: Bokeh](https://github.com/bokeh/bokeh) - :star: 5311 :fork_and_knife: 1254 - Interactive Web Plotting for Python.
* [:octocat: ggplot](https://github.com/yhat/ggplot) - :star: 2849 :fork_and_knife: 399 - Same API as ggplot2 for R.
...
* [:octocat: Seaborn](https://github.com/mwaskom/seaborn) - :star: 3646 :fork_and_knife: 539 - Statistical data visualization using Matplotlib.
* [:octocat: VisPy](https://github.com/vispy/vispy) - :star: 1213 :fork_and_knife: 266 - High-performance scientific visualization based on OpenGL.
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - :star: 1397 :fork_and_knife: 111 - A tiny, document-oriented database.
...
* MySQL - [awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/)
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - :star: 509 :fork_and_knife: 76 - mysql-python fork supporting Python 3.
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - :star: 2338 :fork_and_knife: 534 - Pure Python MySQL driver compatible to mysql-python.
* PostgreSQL
...
* Other Relational Databases
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 2579 :fork_and_knife: 152 - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL.
    * [:earth_americas: pymssql](http://www.pymssql.org/en/latest/) - A simple database interface to Microsoft SQL Server.
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - :star: 627 :fork_and_knife: 286 - Python driver for Cassandra.
    * [:octocat: HappyBase](https://github.com/wbolster/happybase) - :star: 296 :fork_and_knife: 90 - A developer-friendly library for Apache HBase.
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - :star: 4743 :fork_and_knife: 1188 - The Redis Python Client.
...
* [:octocat: arrow](https://github.com/crsmithdev/arrow) - :star: 3980 :fork_and_knife: 323 - Better dates & times for Python.
...
* [:octocat: dateutil](https://github.com/dateutil/dateutil) - :star: 311 :fork_and_knife: 81 - Extensions to the standard Python [datetime](https://docs.python.org/2/library/datetime.html) module.
...
* [:octocat: moment](https://github.com/zachwill/moment) - :star: 354 :fork_and_knife: 23 - A Python library for dealing with dates/times. Inspired by [Moment.js](http://momentjs.com/).
* [:octocat: Pendulum](https://github.com/sdispater/pendulum) - :star: 1621 :fork_and_knife: 51 - Python datetimes made easy.
...
* Debugger
    * [:octocat: django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) - :star: 3985 :fork_and_knife: 712 - Display various debug information for Django.
    * [:octocat: django-devserver](https://github.com/dcramer/django-devserver) - :star: 1175 :fork_and_knife: 153 - A drop-in replacement for Django's runserver.
    ...
    * [:octocat: wdb](https://github.com/Kozea/wdb) - :star: 1104 :fork_and_knife: 64 - An improbable web debugger through WebSockets.
    * [:earth_americas: winpdb](http://winpdb.org/) - A Python Debugger with GUI, capable of remote debugging based on `rpdb2`.
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - :star: 1119 :fork_and_knife: 84 - Line-by-line profiling.
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 891 :fork_and_knife: 124 - Monitor Memory usage of Python code.
    * [:octocat: profiling](https://github.com/what-studio/profiling) - :star: 2476 :fork_and_knife: 87 - An interactive Python profiler.
* Others
    * [:octocat: pyelftools](https://github.com/eliben/pyelftools) - :star: 415 :fork_and_knife: 160 - Parsing and analyzing ELF files and DWARF debugging information.
...
* [:octocat: Caffe](https://github.com/BVLC/caffe) - :star: 15503 :fork_and_knife: 9587 - A fast open framework for deep learning..
* [:octocat: Keras](https://github.com/fchollet/keras) - :star: 11481 :fork_and_knife: 3802 - A high-level neural networks library and capable of running on top of either TensorFlow or Theano.
* [:earth_americas: Neupy](http://neupy.com/pages/home.html) - Running and testing different Artificial Neural Networks algorithms.
* [:octocat: TensorFlow](https://github.com/tensorflow/tensorflow) - :star: 43742 :fork_and_knife: 20368 - The most popular Deep Learning framework created by Google.
* [:octocat: Theano](https://github.com/Theano/Theano) - :star: 5499 :fork_and_knife: 1908 - A library for fast numerical computation.

## DevOps Tools

*Software and libraries for DevOps.*

* [:octocat: Ansible](https://github.com/ansible/ansible) - :star: 20972 :fork_and_knife: 6622 - A radically simple IT automation platform.
...
* [:octocat: honcho](https://github.com/nickstenning/honcho) - :star: 905 :fork_and_knife: 102 - A Python clone of [Foreman](https://github.com/ddollar/foreman), for managing Procfile-based applications.
* [:earth_americas: OpenStack](http://www.openstack.org/) - Open source software for building private and public clouds.
* [:octocat: pexpect](https://github.com/pexpect/pexpect) - :star: 792 :fork_and_knife: 212 - Controlling interactive programs in a pseudo-terminal like GNU expect.
* [:octocat: psutil](https://github.com/giampaolo/psutil) - :star: 2226 :fork_and_knife: 377 - A cross-platform process and system utilities module.
* [:octocat: SaltStack](https://github.com/saltstack/salt) - :star: 7285 :fork_and_knife: 3345 - Infrastructure automation and management system.
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - :star: 3050 :fork_and_knife: 609 - Supervisor process control system for UNIX.
...
* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - :star: 2367 :fork_and_knife: 582 - Converts Python programs into stand-alone executables (cross-platform).
...
* [:octocat: alipay](https://github.com/lxneng/alipay) - :star: 190 :fork_and_knife: 57 - Unofficial Alipay API for Python.
* [:octocat: Cartridge](https://github.com/stephenmcd/cartridge) - :star: 504 :fork_and_knife: 239 - A shopping cart app built using the Mezzanine.
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - :star: 866 :fork_and_knife: 126 - Emacs Python Development Environment.
* Sublime Text
    * [:octocat: Anaconda](https://github.com/DamnWidget/anaconda) - :star: 1333 :fork_and_knife: 145 - Anaconda turns your Sublime Text 3 in a full featured Python development IDE.
    * [:octocat: SublimeJEDI](https://github.com/srusskih/SublimeJEDI) - :star: 690 :fork_and_knife: 73 - A Sublime Text plugin to the awesome auto-complete library Jedi.
* Vim
    * [:octocat: Jedi-vim](https://github.com/davidhalter/jedi-vim) - :star: 2675 :fork_and_knife: 226 - Vim bindings for the Jedi auto-completion library for Python.
    * [:octocat: Python-mode](https://github.com/klen/python-mode) - :star: 3307 :fork_and_knife: 680 - An all in one plugin for turning Vim into a Python IDE.
    * [:octocat: YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - :star: 12828 :fork_and_knife: 1509 - Includes [Jedi](https://github.com/davidhalter/jedi)-based completion engine for Python.
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - :star: 1424 :fork_and_knife: 373 - Python Tools for Visual Studio.
* Visual Studio Code
    * [:octocat: Python](https://github.com/DonJayamanne/pythonVSCode) - :star: 635 :fork_and_knife: 112 - An extension with rich support for the Python language, with features including linting, IntelliSense, formatting, refactoring, debugging, unit tests, and jupyter support.
* IDE
    ...
    * [:octocat: Spyder](https://github.com/spyder-ide/spyder) - :star: 1739 :fork_and_knife: 418 - Open Source Python IDE.
...
* [:octocat: lamson](https://github.com/zedshaw/lamson) - :star: 585 :fork_and_knife: 164 - Pythonic SMTP Application Server.
...
* [:octocat: modoboa](https://github.com/tonioo/modoboa) - :star: 683 :fork_and_knife: 96 - A mail hosting and management platform including a modern and simplified Web UI.
...
* [:octocat: yagmail](https://github.com/kootenpv/yagmail) - :star: 675 :fork_and_knife: 45 - Yet another Gmail/SMTP client.

## Environment Management

*Libraries for Python version and environment management.*

* [:octocat: p](https://github.com/qw3rtman/p) - :star: 637 :fork_and_knife: 34 - Dead simple interactive Python version management.
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - :star: 6301 :fork_and_knife: 514 - Simple Python version management.
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - :star: 679 :fork_and_knife: 85 - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html).
...
* [:octocat: python-magic](https://github.com/ahupp/python-magic) - :star: 782 :fork_and_knife: 120 - A Python interface to the libmagic file type identification library.
* [:octocat: Unipath](https://github.com/mikeorr/Unipath) - :star: 401 :fork_and_knife: 32 - An object-oriented approach to file/directory operations.
* [:octocat: watchdog](https://github.com/gorakhargosh/watchdog) - :star: 2372 :fork_and_knife: 324 - API and shell utilities to monitor file system events.
...
* [:octocat: Deform](https://github.com/Pylons/deform) - :star: 250 :fork_and_knife: 125 - Python HTML form generation library influenced by the formish form generation library.
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - :star: 1625 :fork_and_knife: 548 - Bootstrap 3 integration with Django.
* [:octocat: django-crispy-forms](https://github.com/maraujop/django-crispy-forms) - :star: 2658 :fork_and_knife: 480 - A Django app which lets you create beautiful forms in a very elegant and DRY way.
...
* [:octocat: WTForms](https://github.com/wtforms/wtforms) - :star: 629 :fork_and_knife: 193 - A flexible forms validation and rendering library.

## Functional Programming

*Functional Programming with Python.*

* [:octocat: CyToolz](https://github.com/pytoolz/cytoolz/) - :star: 318 :fork_and_knife: 29 - Cython implementation of Toolz: High performance functional utilities.
* [:octocat: fn.py](https://github.com/kachayev/fn.py) - :star: 2198 :fork_and_knife: 134 - Functional programming in Python: implementation of missing features to enjoy FP.
* [:octocat: funcy](https://github.com/Suor/funcy) - :star: 1404 :fork_and_knife: 67 - A fancy and practical functional tools.
* [:octocat: Toolz](https://github.com/pytoolz/toolz) - :star: 1323 :fork_and_knife: 105 - A collection of functional utilities for iterators, functions, and dictionaries.
...
* [:octocat: enaml](https://github.com/nucleic/enaml) - :star: 496 :fork_and_knife: 64 - Creating beautiful user-interfaces with Declaratic Syntax like QML.
* [:octocat: Flexx](https://github.com/zoofIO/flexx) - :star: 1127 :fork_and_knife: 118 - Flexx is a pure Python toolkit for creating GUI's, that uses web technology for its rendering.
...
* [:octocat: Toga](https://github.com/pybee/toga) - :star: 1006 :fork_and_knife: 88 - A Python native, OS native GUI toolkit.
...
* [:octocat: django-countries](https://github.com/SmileyChris/django-countries) - :star: 317 :fork_and_knife: 99 - A Django app that provides country choices for use with forms, flag icons static files, and a country field for models.
...
* [:octocat: geopy](https://github.com/geopy/geopy) - :star: 1343 :fork_and_knife: 313 - Python Geocoding Toolbox.
...
* [:octocat: bleach](https://github.com/mozilla/bleach) - :star: 1133 :fork_and_knife: 140 - A whitelist-based HTML sanitization and text linkification library.
* [:earth_americas: cssutils](https://pypi.python.org/pypi/cssutils/) - A CSS library for Python.
* [:octocat: html5lib](https://github.com/html5lib/html5lib-python) - :star: 563 :fork_and_knife: 118 - A standards-compliant library for parsing and serializing HTML documents and fragments.
...
* [:octocat: pyquery](https://github.com/gawel/pyquery) - :star: 1094 :fork_and_knife: 102 - A jQuery-like library for parsing HTML.
...
* [:octocat: xmltodict](https://github.com/martinblech/xmltodict) - :star: 2277 :fork_and_knife: 222 - Working with XML feel like you are working with JSON.

## HTTP

*Libraries for working with HTTP.*

* [:octocat: grequests](https://github.com/kennethreitz/grequests) - :star: 1790 :fork_and_knife: 200 - requests + gevent for asynchronous HTTP requests.
* [:octocat: httplib2](https://github.com/jcgregorio/httplib2) - :star: 374 :fork_and_knife: 204 - Comprehensive HTTP client library.
...
* [:octocat: urllib3](https://github.com/shazow/urllib3) - :star: 1196 :fork_and_knife: 399 - A HTTP library with thread-safe connection pooling, file post support, sanity friendly.
...
* [:octocat: PyUserInput](https://github.com/SavinaRoja/PyUserInput) - :star: 495 :fork_and_knife: 126 - A module for cross-platform control of the mouse and keyboard.
* [:octocat: scapy](https://github.com/secdev/scapy) - :star: 882 :fork_and_knife: 239 - A brilliant packet manipulation library.
...
* [:octocat: PeachPy](https://github.com/Maratyszcza/PeachPy) - :star: 860 :fork_and_knife: 48 - x86-64 assembler embedded in Python. Can be used as inline assembler for Python or as a stand-alone assembler for Windows, Linux, OS X, Native Client and Go.
...
* [:octocat: Pyston](https://github.com/dropbox/pyston) - :star: 4151 :fork_and_knife: 277 - A Python implementation built using LLVM and modern JIT techniques with the goal of achieving good performance.
* [:octocat: Pyjion](https://github.com/Microsoft/Pyjion) - :star: 977 :fork_and_knife: 52 - A JIT for Python based upon CoreCLR
...
* [:octocat: pillow](https://github.com/python-pillow/Pillow) - :star: 3144 :fork_and_knife: 693 - Pillow is the friendly [PIL](http://www.pythonware.com/products/pil/) fork.
...
* [:octocat: python-qrcode](https://github.com/lincolnloop/python-qrcode) - :star: 1020 :fork_and_knife: 228 - A pure Python QR Code generator.
* [:octocat: Quads](https://github.com/fogleman/Quads) - :star: 604 :fork_and_knife: 54 - Computer art based on quadtrees.
* [:earth_americas: scikit-image](http://scikit-image.org/) - A Python library for (scientific) image processing.
* [:octocat: thumbor](https://github.com/thumbor/thumbor) - :star: 4433 :fork_and_knife: 455 - A smart imaging service. It enables on-demand crop, re-sizing and flipping of images.
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 650 :fork_and_knife: 139 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.

## Interactive Interpreter

*Interactive Python interpreters (REPL).*

* [:octocat: bpython](https://github.com/bpython/bpython) - :star: 701 :fork_and_knife: 90 - A fancy interface to the Python interpreter.
...
* [:octocat: ptpython](https://github.com/jonathanslenders/ptpython) - :star: 1838 :fork_and_knife: 78 - Advanced Python REPL built on top of the [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
* [:octocat: django-schedule](https://github.com/thauber/django-schedule) - :star: 670 :fork_and_knife: 266 - A calendaring app for Django.
...
* [:octocat: Plan](https://github.com/fengsp/plan) - :star: 956 :fork_and_knife: 72 - Writing crontab file in Python like a charm.
* [:octocat: schedule](https://github.com/dbader/schedule) - :star: 2728 :fork_and_knife: 272 - Python job scheduling for humans.
...
* [:octocat: Raven](https://github.com/getsentry/raven-python) - :star: 1069 :fork_and_knife: 644 - The Python client for Sentry.
...
* [:octocat: gensim](https://github.com/piskvorky/gensim) - :star: 3561 :fork_and_knife: 1342 - Topic Modelling for Humans.
* [:earth_americas: MLlib](http://spark.apache.org/mllib/) - [Apache Spark](http://spark.apache.org/)'s scalable Machine Learning library.
* [:octocat: NuPIC](https://github.com/numenta/nupic) - :star: 4736 :fork_and_knife: 1337 - Numenta Platform for Intelligent Computing.
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - :star: 2311 :fork_and_knife: 951 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano).
...
* [:octocat: dpark](https://github.com/douban/dpark) - :star: 2012 :fork_and_knife: 468 - Python clone of Spark, a MapReduce alike framework in Python.
...
* [:octocat: luigi](https://github.com/spotify/luigi) - :star: 6135 :fork_and_knife: 1169 - A module that helps you build complex pipelines of batch jobs.
* [:octocat: mrjob](https://github.com/Yelp/mrjob) - :star: 1963 :fork_and_knife: 488 - Run MapReduce jobs on Hadoop or Amazon Web Services.
...
* [:octocat: PythonNet](https://github.com/pythonnet/pythonnet) - :star: 322 :fork_and_knife: 92 - Python Integration with the .NET Common Language Runtime (CLR).
...
* [:octocat: blinker](https://github.com/jek/blinker) - :star: 494 :fork_and_knife: 62 - A fast Python in-process signal/event dispatching system.
* [:octocat: itsdangerous](https://github.com/pallets/itsdangerous) - :star: 1090 :fork_and_knife: 96 - Various helpers to pass trusted data to untrusted environments.
* [:octocat: pluginbase](https://github.com/mitsuhiko/pluginbase) - :star: 500 :fork_and_knife: 73 - A simple but flexible plugin system for Python.
...
* [:octocat: Jieba](https://github.com/fxsjy/jieba) - :star: 7188 :fork_and_knife: 2252 - Chinese text segmentation.
* [:octocat: langid.py](https://github.com/saffsd/langid.py) - :star: 693 :fork_and_knife: 126 - Stand-alone language identification system.
...
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - :star: 1678 :fork_and_knife: 482 - A library for processing Chinese text.
* [:earth_americas: spaCy](https://spacy.io/) - A library for industrial-strength natural language processing in Python and Cython.
* [:octocat: TextBlob](https://github.com/sloria/TextBlob) - :star: 3557 :fork_and_knife: 435 - Providing a consistent API for diving into common NLP tasks.
* [:octocat: TextGrocery](https://github.com/2shou/TextGrocery) - :star: 344 :fork_and_knife: 115 - A simple, efficient short-text classification tool based on LibLinear and Jieba.
...
* [:octocat: POX](https://github.com/noxrepo/pox) - :star: 339 :fork_and_knife: 333 - An open source development platform for Python-based Software Defined Networking (SDN) control applications, such as OpenFlow SDN controllers.
...
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - :star: 1380 :fork_and_knife: 106 - Event-driven concurrent framework for Python.
...
* [:octocat: django-activity-stream](https://github.com/justquick/django-activity-stream) - :star: 1130 :fork_and_knife: 340 - Generating generic activity streams from the actions on your site.
* [:octocat: Stream-Framework](https://github.com/tschellenbach/Stream-Framework) - :star: 2736 :fork_and_knife: 338 - Building newsfeed and notification systems using Cassandra and Redis.
...
* Relational Databases
    ...
    * [:earth_americas: SQLAlchemy](http://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
        * [:octocat: awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) - :star: 1276 :fork_and_knife: 82
    * [:octocat: Peewee](https://github.com/coleifer/peewee) - :star: 3520 :fork_and_knife: 651 - A small, expressive ORM.
...
* NoSQL Databases
    * [:octocat: django-mongodb-engine](https://github.com/django-nonrel/mongodb-engine) - :star: 693 :fork_and_knife: 194 - Django MongoDB Backend.
    * [:octocat: flywheel](https://github.com/mathcamp/flywheel) - :star: 84 :fork_and_knife: 14 - Object mapper for Amazon DynamoDB.
    * [:octocat: hot-redis](https://github.com/stephenmcd/hot-redis) - :star: 200 :fork_and_knife: 15 - Rich Python data types for Redis.
    * [:earth_americas: MongoEngine](http://mongoengine.org/) - A Python Object-Document-Mapper for working with MongoDB.
    * [:octocat: PynamoDB](https://github.com/jlafon/PynamoDB) - :star: 322 :fork_and_knife: 84 - A Pythonic interface for [Amazon DynamoDB](https://aws.amazon.com/dynamodb/).
    * [:octocat: redisco](https://github.com/kiddouk/redisco) - :star: 338 :fork_and_knife: 63 - A Python Library for Simple Models and Containers Persisted in Redis.
* Others
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 2579 :fork_and_knife: 152 - A JSON-based database.
...
* [:octocat: conda](https://github.com/conda/conda/) - :star: 1065 :fork_and_knife: 358 - Cross-platform, Python-agnostic binary package manager.
* [:earth_americas: Curdling](http://clarete.li/curdling/) - Curdling is a command line tool for managing Python packages.
* [:octocat: pip-tools](https://github.com/nvie/pip-tools) - :star: 1924 :fork_and_knife: 189 - A set of tools to keep your pinned Python dependencies fresh.
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - :star: 893 :fork_and_knife: 187 - Next generation Python Package Repository (PyPI).
...
* [:octocat: localshop](https://github.com/mvantellingen/localshop) - :star: 287 :fork_and_knife: 101 - Local PyPI server (custom packages and auto-mirroring of pypi).
...
* [:octocat: django-guardian](https://github.com/django-guardian/django-guardian) - :star: 1327 :fork_and_knife: 345 - Implementation of per object permissions for Django 1.2+
* [:octocat: django-rules](https://github.com/dfunckt/django-rules) - :star: 376 :fork_and_knife: 29 - A tiny but powerful app providing object-level permissions to Django, without requiring a database.

## Processes

*Libraries for starting and communicating with OS processes.*

* [:octocat: envoy](https://github.com/kennethreitz/envoy) - :star: 1941 :fork_and_knife: 170 - Python [subprocess](https://docs.python.org/2/library/subprocess.html) for Humans.
* [:earth_americas: sarge](http://sarge.readthedocs.io/) - Yet another wrapper for subprocess.
* [:octocat: sh](https://github.com/amoffat/sh) - :star: 3565 :fork_and_knife: 308 - A full-fledged subprocess replacement for Python.
...
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 1101 :fork_and_knife: 115 - Little multi-threaded task queue.
...
* Flask
    * [:octocat: eve](https://github.com/nicolaiarocci/eve) - :star: 3743 :fork_and_knife: 486 - REST API framework powered by Flask, MongoDB and good intentions.
    ...
    * [:octocat: flask-restful](https://github.com/flask-restful/flask-restful) - :star: 2482 :fork_and_knife: 490 - Quickly building REST APIs for Flask.
    * [:octocat: flask-restless](https://github.com/jfinkels/flask-restless) - :star: 737 :fork_and_knife: 237 - Generating RESTful APIs for database models defined with SQLAlchemy.
* Pyramid
...
* Framework agnostic
    ...
    * [:octocat: hug](https://github.com/timothycrosley/hug) - :star: 3958 :fork_and_knife: 194 - A Python3 framework for cleanly exposing APIs over HTTP and the Command Line with automatic documentation and validation.
...
* [:octocat: SimpleJSONRPCServer](https://github.com/joshmarshall/jsonrpclib/) - :star: 297 :fork_and_knife: 110 - This library is an implementation of the JSON-RPC specification.
...
* [:octocat: zeroRPC](https://github.com/0rpc/zerorpc-python) - :star: 1851 :fork_and_knife: 238 - zerorpc is a flexible RPC implementation based on [ZeroMQ](http://zeromq.org/) and [MessagePack](http://msgpack.org/).
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - :star: 1892 :fork_and_knife: 449 - Markov Chain Monte Carlo sampling toolkit.
...
* [:octocat: statsmodels](https://github.com/statsmodels/statsmodels) - :star: 1824 :fork_and_knife: 908 - Statistical modeling and econometrics in Python.
* [:octocat: SymPy](https://github.com/sympy/sympy) - :star: 3543 :fork_and_knife: 1777 - A Python library for symbolic mathematics.
* [:octocat: Zipline](https://github.com/quantopian/zipline) - :star: 4338 :fork_and_knife: 1384 - A Pythonic algorithmic trading library.

## Search

*Libraries and software for indexing and performing search queries on data.*

* [:octocat: django-haystack](https://github.com/django-haystack/django-haystack) - :star: 2113 :fork_and_knife: 962 - Modular search for Django.
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - :star: 1091 :fork_and_knife: 257 - The official high-level Python client for Elasticsearch.
...
* [:octocat: marshmallow](https://github.com/marshmallow-code/marshmallow) - :star: 1459 :fork_and_knife: 179 - marshmallow is an ORM/ODM/framework-agnostic library for converting complex datatypes, such as objects, to and from native Python datatypes.

## Serverless Frameworks

*Frameworks for developing serverless Python code.*

* [:octocat: apex](https://github.com/apex/apex) - :star: 4506 :fork_and_knife: 236 - Build, deploy, and manage [AWS Lambda](https://aws.amazon.com/lambda/) functions with ease.
* [:octocat: python-lambda](https://github.com/nficano/python-lambda) - :star: 314 :fork_and_knife: 47 - A toolkit for developing and deploying Python code in AWS Lambda.
* [:octocat: Zappa](https://github.com/Miserlou/Zappa) - :star: 2725 :fork_and_knife: 244 - A tool for deploying WSGI applications on AWS Lambda and API Gateway.
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - :star: 2291 :fork_and_knife: 335 - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
    ...
    * [:octocat: pyexcel](https://github.com/pyexcel/pyexcel) - :star: 152 :fork_and_knife: 37 - Providing one API for reading, manipulating and writing csv, ods, xls, xlsx and xlsm files.
    ...
    * [:octocat: unoconv](https://github.com/dagwieers/unoconv) - :star: 862 :fork_and_knife: 236 - Convert between any document format supported by LibreOffice/OpenOffice.
    ...
    * [:octocat: xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - :star: 592 :fork_and_knife: 200 - Writing and reading data and formatting information from Excel files.
* PDF
    * [:octocat: PDFMiner](https://github.com/euske/pdfminer) - :star: 1872 :fork_and_knife: 532 - A tool for extracting information from PDF documents.
    * [:octocat: PyPDF2](https://github.com/mstamy2/PyPDF2) - :star: 1213 :fork_and_knife: 373 - A library capable of splitting, merging and transforming PDF pages.
    * [:earth_americas: ReportLab](http://www.reportlab.com/opensource/) - Allowing Rapid creation of rich PDF documents.
* Markdown
    * [:octocat: Mistune](https://github.com/lepture/mistune) - :star: 812 :fork_and_knife: 79 - Fastest and full featured pure Python parsers of Markdown.
    * [:octocat: Python-Markdown](https://github.com/waylan/Python-Markdown) - :star: 996 :fork_and_knife: 273 - A Python implementation of John Grubers Markdown.
* YAML
    * [:earth_americas: PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [:octocat: csvkit](https://github.com/wireservice/csvkit) - :star: 2484 :fork_and_knife: 359 - Utilities for converting to and working with CSV.
* Archive
    * [:octocat: unp](https://github.com/mitsuhiko/unp) - :star: 249 :fork_and_knife: 22 - A command line tool that can unpack archives easily.

## Static Site Generator

*Static site generator is a software that takes some text + templates as input and produces HTML files on the output.*

* [:octocat: Cactus](https://github.com/koenbok/Cactus/) - :star: 2929 :fork_and_knife: 281 - Static site generator for designers.
...
* [:octocat: django-taggit](https://github.com/alex/django-taggit) - :star: 1578 :fork_and_knife: 420 - Simple tagging for Django.
...
* Testing Frameworks
    * [:octocat: hypothesis](https://github.com/HypothesisWorks/hypothesis-python) - :star: 1707 :fork_and_knife: 155 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: nose](https://github.com/nose-devs/nose) - :star: 1037 :fork_and_knife: 318 - A nicer unittest for Python.
    ...
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 1313 :fork_and_knife: 503 - A generic test automation framework.
...
* GUI / Web Testing
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 4617 :fork_and_knife: 648 - Scalable user load testing tool written in Python.
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 744 :fork_and_knife: 106 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    ...
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1228 :fork_and_knife: 124 - A language-agnostic A/B Testing framework.
...
* Mock
    ...
    * [:octocat: freezegun](https://github.com/spulec/freezegun) - :star: 917 :fork_and_knife: 93 - Travel through time by mocking the datetime module.
    ...
    * [:octocat: httpretty](https://github.com/gabrielfalcao/HTTPretty) - :star: 1323 :fork_and_knife: 193 - HTTP request mock tool for Python.
    ...
    * [:octocat: responses](https://github.com/getsentry/responses) - :star: 1407 :fork_and_knife: 136 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 805 :fork_and_knife: 124 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - :star: 1074 :fork_and_knife: 149 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 377 :fork_and_knife: 41 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
...
* Fake Data
    * [:octocat: church](https://github.com/lk-geimfari/church) - :star: 907 :fork_and_knife: 60 - is a Python library that help you generate fake data.
    * [:octocat: fake2db](https://github.com/emirozer/fake2db) - :star: 1709 :fork_and_knife: 76 - Fake database generator.
    * [:octocat: faker](https://github.com/joke2k/faker) - :star: 4362 :fork_and_knife: 490 - A Python package that generates fake data.
    * [:earth_americas: radar](https://pypi.python.org/pypi/radar) - Generate random datetime / time.
* Error Handler
    * [:octocat: FuckIt.py](https://github.com/ajalt/fuckitpy) - :star: 2308 :fork_and_knife: 93 - FuckIt.py uses state-of-the-art technology to make sure your Python code runs whether it has any right to or not.
...
* General
    ...
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 1618 :fork_and_knife: 56 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 2930 :fork_and_knife: 317 - Fuzzy String Matching.
    ...
    * [:octocat: pyfiglet](https://github.com/pwaller/pyfiglet) - :star: 195 :fork_and_knife: 24 - An implementation of figlet written in Python.
    * [:octocat: shortuuid](https://github.com/stochastic-technologies/shortuuid) - :star: 696 :fork_and_knife: 52 - A generator library for concise, unambiguous and URL-safe UUIDs.
    ...
    * [:octocat: xpinyin](https://github.com/lxneng/xpinyin) - :star: 402 :fork_and_knife: 107 - A library to translate Chinese hanzi (??) to pinyin (??).
* Slugify
    * [:octocat: awesome-slugify](https://github.com/dimka665/awesome-slugify) - :star: 321 :fork_and_knife: 18 - A Python slugify library that can preserve unicode.
    ...
    * [:octocat: unicode-slugify](https://github.com/mozilla/unicode-slugify) - :star: 237 :fork_and_knife: 41 - A slugifier that generates unicode slugs with Django as a dependency.
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 1405 :fork_and_knife: 183 - Parsing, formatting, storing and validating international phone numbers.
    ...
    * [:octocat: python-nameparser](https://github.com/derek73/python-nameparser) - :star: 181 :fork_and_knife: 27 - Parsing human names into their individual components.
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 443 :fork_and_knife: 96 - Browser user agent parser.
    * [:octocat: sqlparse](https://github.com/andialbrecht/sqlparse) - :star: 821 :fork_and_knife: 204 - A non-validating SQL parser.
...
* [:octocat: boto3](https://github.com/boto/boto3) - :star: 1782 :fork_and_knife: 343 - Python interface to Amazon Web Services.
* [:octocat: django-wordpress](https://github.com/sunlightlabs/django-wordpress/) - :star: 229 :fork_and_knife: 52 - WordPress models and views for Django.
* [:octocat: facebook-sdk](https://github.com/mobolic/facebook-sdk) - :star: 1865 :fork_and_knife: 708 - Facebook Platform Python SDK.
...
* [:octocat: gmail](https://github.com/charlierguo/gmail) - :star: 1350 :fork_and_knife: 272 - A Pythonic interface for Gmail.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 1362 :fork_and_knife: 637 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 1984 :fork_and_knife: 372 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1276 :fork_and_knife: 314 - A Python wrapper for the Twitter API.
...
* [:octocat: short_url](https://github.com/Alir3z4/python-short_url) - :star: 68 :fork_and_knife: 13 - Python implementation for generating Tiny URL and bit.ly-like URLs.
* [:octocat: webargs](https://github.com/sloria/webargs) - :star: 398 :fork_and_knife: 53 - A friendly library for parsing HTTP request arguments, with built-in support for popular web frameworks, including Flask, Django, Bottle, Tornado, and Pyramid.
...
* [:octocat: Haul](https://github.com/vinta/Haul) - :star: 80 :fork_and_knife: 22 - An Extensible Image Crawler.
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 327 :fork_and_knife: 66 - Convert HTML to Markdown-formatted text.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 4062 :fork_and_knife: 608 - News extraction, article extraction and content curation in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 2277 :fork_and_knife: 559 - HTML Content/Article Extractor.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 1102 :fork_and_knife: 210 - Fast Python port of arc90's readability tool.
...
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 798 :fork_and_knife: 162 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 1812 :fork_and_knife: 175 - Extract text from any document, Word, PowerPoint, PDFs, etc.

## Web Crawling

*Libraries for scraping websites.*

* [:octocat: cola](https://github.com/chineking/cola) - :star: 1055 :fork_and_knife: 484 - A distributed crawling framework.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 1492 :fork_and_knife: 79 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 4762 :fork_and_knife: 714 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 8191 :fork_and_knife: 2155 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 2670 :fork_and_knife: 198 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 4845 :fork_and_knife: 882
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 3457 :fork_and_knife: 560
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/uralbash/awesome-pyramid) - :star: 317 :fork_and_knife: 37
...
* [:octocat: AutobahnPython](https://github.com/crossbario/autobahn-python) - :star: 1340 :fork_and_knife: 412 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
* [:octocat: Crossbar](https://github.com/crossbario/crossbar/) - :star: 1122 :fork_and_knife: 150 - Open-source Unified Application Router (Websocket & WAMP for Python on Autobahn).
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 966 :fork_and_knife: 200 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 759 :fork_and_knife: 192 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 50728 :fork_and_knife: 6170
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 4060 :fork_and_knife: 317
* Python
    * [:octocat: pycrumbs](https://github.com/kirang89/pycrumbs) - :star: 2499 :fork_and_knife: 663
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 305 :fork_and_knife: 64
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 1732 :fork_and_knife: 363
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 500 :fork_and_knife: 109
