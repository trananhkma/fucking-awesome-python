...
* [:octocat: pyenv](https://github.com/yyuu/pyenv) - :star: 4738 :fork_and_knife: 373 - Simple Python version management.
* [:earth_americas: PyRun](https://www.egenix.com/products/python/PyRun/) - A one-file, no-installation-needed version of Python.
* [:octocat: Vex](https://github.com/sashahart/vex) - :star: 291 :fork_and_knife: 17 - Run a command in the named virtualenv.
...
* [:octocat: conda](https://github.com/conda/conda/) - :star: 770 :fork_and_knife: 264 - Cross-platform, Python-agnostic binary package manager.
...
* [:octocat: warehouse](https://github.com/pypa/warehouse) - :star: 611 :fork_and_knife: 132 - Next generation Python Package Repository (PyPI).
...
* [:octocat: PyInstaller](https://github.com/pyinstaller/pyinstaller) - :star: 1847 :fork_and_knife: 446 - Converts Python programs into stand-alone executables (cross-platform).
...
* [:octocat: PlatformIO](https://github.com/ivankravets/platformio) - :star: 1092 :fork_and_knife: 161 - A console tool to build code with different development platforms.
* [:octocat: PyBuilder](https://github.com/pybuilder/pybuilder) - :star: 647 :fork_and_knife: 135 - A continuous build tool written in pure Python.
...
* [:octocat: IPython](https://github.com/ipython/ipython) - :star: 9390 :fork_and_knife: 2754 - A rich toolkit to help you make the most out of using Python interactively.
* [:earth_americas: bpython](http://bpython-interpreter.org) – A fancy interface to the Python interpreter.
* [:octocat: ptpython](https://github.com/jonathanslenders/ptpython) - :star: 1348 :fork_and_knife: 53 - Advanced Python REPL built on top of the [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
* [:octocat: path.py](https://github.com/jaraco/path.py) - :star: 631 :fork_and_knife: 84 - A module wrapper for [os.path](https://docs.python.org/2/library/os.path.html).
...
* [:octocat: python-magic](https://github.com/ahupp/python-magic) - :star: 653 :fork_and_knife: 102 - A Python interface to the libmagic file type identification library.
...
* [:octocat: watchdog](https://github.com/gorakhargosh/watchdog) - :star: 2070 :fork_and_knife: 273 - API and shell utilities to monitor file system events.

## Date and Time

*Libraries for working with dates and times.*

* [:octocat: arrow](https://github.com/crsmithdev/arrow) - :star: 3099 :fork_and_knife: 262 - Better dates & times for Python.
...
* [:octocat: moment](https://github.com/zachwill/moment) - :star: 296 :fork_and_knife: 15 - A Python library for dealing with dates/times. Inspired by [Moment.js](http://momentjs.com/).
...
* General
    * [:octocat: chardet](https://github.com/chardet/chardet) - :star: 534 :fork_and_knife: 80 - Python 2/3 compatible character encoding detector.
    ...
    * [:octocat: ftfy](https://github.com/LuminosoInsight/python-ftfy) - :star: 1319 :fork_and_knife: 49 - Makes Unicode text less broken and more consistent automagically.
    * [:octocat: fuzzywuzzy](https://github.com/seatgeek/fuzzywuzzy) - :star: 2483 :fork_and_knife: 248 - Fuzzy String Matching.
    * [:octocat: Levenshtein](https://github.com/ztane/python-Levenshtein/) - :star: 215 :fork_and_knife: 42 - Fast computation of Levenshtein distance and string similarity.
    ...
    * [:octocat: uniout](https://github.com/moskytw/uniout) - :star: 96 :fork_and_knife: 10 - Print readable chars instead of the escaped string.
    * [:octocat: xpinyin](https://github.com/lxneng/xpinyin) - :star: 335 :fork_and_knife: 92 - A library to translate Chinese hanzi (漢字) to pinyin (拼音).
* Slugify
    * [:octocat: awesome-slugify](https://github.com/dimka665/awesome-slugify) - :star: 282 :fork_and_knife: 17 - A Python slugify library that can preserve unicode.
...
* Parser
    * [:octocat: phonenumbers](https://github.com/daviddrysdale/python-phonenumbers) - :star: 1235 :fork_and_knife: 164 - Parsing, formatting, storing and validating international phone numbers.
    ...
    * [:octocat: python-user-agents](https://github.com/selwin/python-user-agents) - :star: 358 :fork_and_knife: 77 - Browser user agent parser.
...
* General
    * [:octocat: tablib](https://github.com/kennethreitz/tablib) - :star: 1967 :fork_and_knife: 276 - A module for Tabular Datasets in XLS, CSV, JSON, YAML.
* Office
    ...
    * [:octocat: python-docx](https://github.com/python-openxml/python-docx) - :star: 542 :fork_and_knife: 208 - Reads, queries and modifies Microsoft Word 2007/2008 docx files.
    * [:octocat: unoconv](https://github.com/dagwieers/unoconv) - :star: 728 :fork_and_knife: 216 - Convert between any document format supported by LibreOffice/OpenOffice.
    ...
    * [:octocat: xlwt](https://github.com/python-excel/xlwt) / [xlrd](https://github.com/python-excel/xlrd) - :star: 519 :fork_and_knife: 176 - Writing and reading data and formatting information from Excel files.
* PDF
    * [:octocat: PDFMiner](https://github.com/euske/pdfminer) - :star: 1564 :fork_and_knife: 412 - A tool for extracting information from PDF documents.
    * [:octocat: PyPDF2](https://github.com/mstamy2/PyPDF2) - :star: 991 :fork_and_knife: 299 - A library capable of splitting, merging and transforming PDF pages.
    * [:earth_americas: ReportLab](http://www.reportlab.com/opensource/) - Allowing Rapid creation of rich PDF documents.
* Markdown
    * [:octocat: Mistune](https://github.com/lepture/mistune) - :star: 676 :fork_and_knife: 59 - Fastest and full featured pure Python parsers of Markdown.
    * [:octocat: Python-Markdown](https://github.com/waylan/Python-Markdown) - :star: 888 :fork_and_knife: 248 - A Python implementation of John Gruber’s Markdown.
* YAML
    * [:earth_americas: PyYAML](http://pyyaml.org/) - YAML implementations for Python.
* CSV
    * [:octocat: csvkit](https://github.com/onyxfish/csvkit) - :star: 2188 :fork_and_knife: 323 - Utilities for converting to and working with CSV.
* Archive
    * [:octocat: unp](https://github.com/mitsuhiko/unp) - :star: 221 :fork_and_knife: 10 - A command line tool that can unpack archives easily.
...
* [:octocat: jieba](https://github.com/fxsjy/jieba) - :star: 5423 :fork_and_knife: 1719 - Chinese Words Segmentation Utilities.
* [:octocat: langid.py](https://github.com/saffsd/langid.py) - :star: 586 :fork_and_knife: 110 - Stand-alone language identification system.
* [:earth_americas: Pattern](http://www.clips.ua.ac.be/pattern) - A web mining module for the Python.
* [:octocat: SnowNLP](https://github.com/isnowfy/snownlp) - :star: 1369 :fork_and_knife: 398 - A library for processing Chinese text.
...
* [:earth_americas: Sphinx](http://sphinx-doc.org/) - Python Documentation generator.
    * [:octocat: awesome-sphinxdoc](https://github.com/yoloseem/awesome-sphinxdoc) - :star: 174 :fork_and_knife: 13
* [:earth_americas: MkDocs](http://www.mkdocs.org/) - Markdown friendly documentation generator.
* [:octocat: pdoc](https://github.com/BurntSushi/pdoc) - :star: 220 :fork_and_knife: 38 - Epydoc replacement to auto generate API documentation for Python libraries.
...
* Command-line Application Development
    ...
    * [:octocat: clint](https://github.com/kennethreitz/clint) - :star: 2018 :fork_and_knife: 182 - Python Command-line Application Tools.
    ...
    * [:octocat: Gooey](https://github.com/chriskiehl/Gooey) - :star: 4087 :fork_and_knife: 201 - Turn command line programs into a full GUI application with one line
    ...
    * [:octocat: python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit) - :star: 2612 :fork_and_knife: 134 - A Library for building powerful interactive command lines.
* Productivity Tools
    * [:octocat: bashplotlib](https://github.com/glamp/bashplotlib) - :star: 557 :fork_and_knife: 45 - Making basic plots in the terminal. It's a quick way to visualize data without GUI.
    ...
    * [:octocat: cookiecutter](https://github.com/audreyr/cookiecutter) - :star: 3467 :fork_and_knife: 423 - A command-line utility that creates projects from cookiecutters (project templates). E.g. Python package projects, jQuery plugin projects.
    ...
    * [:octocat: httpie](https://github.com/jakubroztocil/httpie) - :star: 24026 :fork_and_knife: 1488 - A command line HTTP client, a user-friendly cURL replacement.
    * [:octocat: PathPicker](https://github.com/facebook/PathPicker) - :star: 2906 :fork_and_knife: 165 - Select files out of bash output.
    * [:octocat: percol](https://github.com/mooz/percol) - :star: 2070 :fork_and_knife: 96 - Adds flavor of interactive selection to the traditional pipe concept on UNIX.
    * [:earth_americas: RainbowStream](http://www.rainbowstream.org/) - Smart and nice Twitter client on terminal.
    * [:octocat: thefuck](https://github.com/nvbn/thefuck) - :star: 20570 :fork_and_knife: 964 - Correcting your previous console command.

## Downloader

*Libraries for downloading.*

* [:octocat: coursera](https://github.com/coursera-dl/coursera) - :star: 4103 :fork_and_knife: 1180 - Script for downloading Coursera.org videos and naming them.
* [:octocat: s3cmd](https://github.com/s3tools/s3cmd) - :star: 1889 :fork_and_knife: 595 - A command line tool for managing Amazon S3 and CloudFront.
* [:octocat: s4cmd](https://github.com/bloomreach/s4cmd) - :star: 420 :fork_and_knife: 84 - Super S3 command line tool, good for higher performance.
* [:octocat: subliminal](https://github.com/Diaoul/subliminal) - :star: 1006 :fork_and_knife: 210 - Library and command line tool to search and download subtitles.
...
* [:octocat: nude.py](https://github.com/hhatto/nude.py) - :star: 370 :fork_and_knife: 52 - Nudity detection.
...
* [:octocat: python-qrcode](https://github.com/lincolnloop/python-qrcode) - :star: 885 :fork_and_knife: 200 - A pure Python QR Code generator.
...
* [:octocat: thumbor](https://github.com/thumbor/thumbor) - :star: 3954 :fork_and_knife: 399 - A smart imaging service. It enables on-demand crop, re-sizing and flipping of images.
* [:octocat: wand](https://github.com/dahlia/wand) - :star: 571 :fork_and_knife: 133 - Python bindings for [MagickWand](http://www.imagemagick.org/script/magick-wand.php), C API for ImageMagick.

## OCR

*Libraries for Optical Character Recognition.*

* [:octocat: pyocr](https://github.com/jflesch/pyocr) - :star: 306 :fork_and_knife: 57 - A wrapper for Tesseract and Cuneiform.
* [:octocat: pytesseract](https://github.com/madmaze/pytesseract) - :star: 462 :fork_and_knife: 99 - Another wrapper for Google Tesseract OCR.
...
* [:octocat: dejavu](https://github.com/worldveil/dejavu) - :star: 2121 :fork_and_knife: 397 - Audio fingerprinting and recognition.
...
* [:octocat: m3u8](https://github.com/globocom/m3u8) - :star: 173 :fork_and_knife: 74 - A module for parsing m3u8 file.
* [:earth_americas: mutagen](https://bitbucket.org/lazka/mutagen) - A Python module to handle audio metadata.
* [:octocat: pydub](https://github.com/jiaaro/pydub) - :star: 1418 :fork_and_knife: 148 - Manipulate audio with a simple and easy high level interface.
* [:octocat: pyechonest](https://github.com/echonest/pyechonest) - :star: 572 :fork_and_knife: 1178 - Python client for the [Echo Nest](http://developer.echonest.com/docs/) API.
...
* [:octocat: tinytag](https://github.com/devsnd/tinytag) - :star: 189 :fork_and_knife: 24 - A library for reading music meta data of MP3, OGG, FLAC and Wave files.
...
* [:octocat: GeoIP](https://github.com/maxmind/geoip-api-python) - :star: 134 :fork_and_knife: 33 - Python API for MaxMind GeoIP Legacy Database.
* [:octocat: geojson](https://github.com/frewsxcv/python-geojson) - :star: 209 :fork_and_knife: 28 - Python bindings and utilities for GeoJSON.
* [:octocat: geopy](https://github.com/geopy/geopy) - :star: 1103 :fork_and_knife: 274 - Python Geocoding Toolbox.
* [:octocat: pygeoip](https://github.com/appliedsec/pygeoip) - :star: 419 :fork_and_knife: 87 - Pure Python GeoIP API.
* [:octocat: django-countries](https://github.com/SmileyChris/django-countries) - :star: 262 :fork_and_knife: 83 - A Django app that provides country choices for use with forms, flag icons static files, and a country field for models.
...
* [:octocat: grequests](https://github.com/kennethreitz/grequests) - :star: 1460 :fork_and_knife: 175 - requests + gevent for asynchronous HTTP requests.
* [:octocat: httplib2](https://github.com/jcgregorio/httplib2) - :star: 362 :fork_and_knife: 190 - Comprehensive HTTP client library.
* [:octocat: treq](https://github.com/dreid/treq) - :star: 277 :fork_and_knife: 73 - Python requests like API built on top of Twisted's HTTP client.
* [:octocat: urllib3](https://github.com/shazow/urllib3) - :star: 1058 :fork_and_knife: 355 - A HTTP library with thread-safe connection pooling, file post support, sanity friendly.
...
* [:octocat: TinyDB](https://github.com/msiemens/tinydb) - :star: 1015 :fork_and_knife: 64 - A tiny, document-oriented database.
...
* Relational Databases
    ...
    * [:octocat: dataset](https://github.com/pudo/dataset) - :star: 2246 :fork_and_knife: 129 - Store Python dicts in a database - works with SQLite, MySQL, and PostgreSQL.
    ...
    * [:octocat: mysqlclient](https://github.com/PyMySQL/mysqlclient-python) - :star: 342 :fork_and_knife: 48 - mysql-python fork supporting Python 3.
    ...
    * [:octocat: PyMySQL](https://github.com/PyMySQL/PyMySQL) - :star: 1768 :fork_and_knife: 405 - Pure Python MySQL driver compatible to mysql-python.
    * [:octocat: queries](https://github.com/gmr/queries) - :star: 144 :fork_and_knife: 13 - A wrapper of the psycopg2 library for interacting with PostgreSQL.
    * [:earth_americas: txpostgres](http://txpostgres.readthedocs.org/) - Twisted based asynchronous driver for PostgreSQL.
* NoSQL Databases
    * [:octocat: cassandra-python-driver](https://github.com/datastax/python-driver) - :star: 512 :fork_and_knife: 246 - Python driver for Cassandra.
    ...
    * [:octocat: redis-py](https://github.com/andymccurdy/redis-py) - :star: 4185 :fork_and_knife: 1052 - The Redis Python Client.
...
* Relational Databases
    ...
    * [:earth_americas: SQLAlchemy](http://www.sqlalchemy.org/) - The Python SQL Toolkit and Object Relational Mapper.
        * [:octocat: awesome-sqlalchemy](https://github.com/dahlia/awesome-sqlalchemy) - :star: 1134 :fork_and_knife: 70
    * [:octocat: peewee](https://github.com/coleifer/peewee) - :star: 2889 :fork_and_knife: 520 - A small, expressive ORM.
    * [:earth_americas: PonyORM](http://ponyorm.com) - ORM that provides a generator-oriented interface to SQL.
* NoSQL Databases
    * [:octocat: django-mongodb-engine](https://github.com/django-nonrel/mongodb-engine) - :star: 644 :fork_and_knife: 188 - Django MongoDB Backend.
    * [:octocat: PynamoDB](https://github.com/jlafon/PynamoDB) - :star: 194 :fork_and_knife: 62 - A Pythonic interface for [Amazon DynamoDB](https://aws.amazon.com/dynamodb/).
    ...
    * [:octocat: redisco](https://github.com/kiddouk/redisco) - :star: 305 :fork_and_knife: 59 - A Python Library for Simple Models and Containers Persisted in Redis.
* Others
...
* [:earth_americas: Django](https://www.djangoproject.com/) - The most popular web framework in Python.
    * [:octocat: awesome-django](https://github.com/rosarior/awesome-django) - :star: 3858 :fork_and_knife: 669
* [:earth_americas: Flask](http://flask.pocoo.org/) - A microframework for Python.
    * [:octocat: awesome-flask](https://github.com/humiaozuzu/awesome-flask) - :star: 2538 :fork_and_knife: 405
* [:earth_americas: Pyramid](http://www.pylonsproject.org/) - A small, fast, down-to-earth, open source Python web framework.
    * [:octocat: awesome-pyramid](https://github.com/ITCase/awesome-pyramid) - :star: 268 :fork_and_knife: 29
...
* [:octocat: django-guardian](https://github.com/lukaszb/django-guardian) - :star: 1142 :fork_and_knife: 315 - Implementation of per object permissions for Django 1.2+
* [:octocat: django-rules](https://github.com/dfunckt/django-rules) - :star: 306 :fork_and_knife: 19 - A tiny but powerful app providing object-level permissions to Django, without requiring a database.
...
* [:octocat: Cartridge](https://github.com/stephenmcd/cartridge) - :star: 464 :fork_and_knife: 227 - A shopping cart app built using the Mezzanine.
* [:earth_americas: shoop](https://www.shoop.io/) - An open source E-Commerce platform based on Django.
* [:octocat: alipay](https://github.com/lxneng/alipay) - :star: 140 :fork_and_knife: 45 - Unofficial Alipay API for Python.
* [:octocat: merchant](https://github.com/agiliq/merchant) - :star: 831 :fork_and_knife: 145 - A Django app to accept payments from various payment processors.
...
* [:octocat: eve](https://github.com/nicolaiarocci/eve) - :star: 3313 :fork_and_knife: 445 - REST API framework powered by Flask, MongoDB and good intentions.
* [:octocat: sandman](https://github.com/jeffknupp/sandman) - :star: 2225 :fork_and_knife: 181 - Automated REST APIs for existing database-driven systems.
...
* [:octocat: ripozo](https://github.com/vertical-knowledge/ripozo) - :star: 155 :fork_and_knife: 19 - Quickly creating REST/HATEOAS/Hypermedia APIs with extensions for Flask and Django.
...
* OAuth
    ...
    * [:octocat: django-allauth](https://github.com/pennersr/django-allauth) - :star: 2407 :fork_and_knife: 876 - Authentication app for Django that "just works."
    * [:octocat: django-oauth-toolkit](https://github.com/evonove/django-oauth-toolkit) - :star: 766 :fork_and_knife: 230 - OAuth2 goodies for the Djangonauts.
    ...
    * [:octocat: Flask-OAuthlib](https://github.com/lepture/flask-oauthlib) - :star: 716 :fork_and_knife: 199 - OAuth 1.0/a, 2.0 implementation of client and provider for Flask.
    * [:octocat: OAuthLib](https://github.com/idan/oauthlib) - :star: 1144 :fork_and_knife: 256 - A generic and thorough implementation of the OAuth request-signing logic.
    * [:octocat: python-oauth2](https://github.com/simplegeo/python-oauth2) - :star: 2421 :fork_and_knife: 948 - A fully tested, abstract interface to creating OAuth clients and servers.
    * [:octocat: python-social-auth](https://github.com/omab/python-social-auth) - :star: 2311 :fork_and_knife: 1001 - An easy-to-setup social authentication mechanism.
    * [:octocat: rauth](https://github.com/litl/rauth) - :star: 1426 :fork_and_knife: 148 - A Python library for OAuth 1.0/a, 2.0, and Ofly.
...
* Others
    ...
    * [:octocat: PyJWT](https://github.com/progrium/pyjwt) - :star: 824 :fork_and_knife: 128 - Implementation of the JSON Web Token draft 01.
...
* [:octocat: Jinja2](https://github.com/mitsuhiko/jinja2) - :star: 3364 :fork_and_knife: 688 - A modern and designer friendly templating language.
...
* [:octocat: huey](https://github.com/coleifer/huey) - :star: 917 :fork_and_knife: 96 - Little multi-threaded task queue.
...
* [:octocat: django-haystack](https://github.com/toastdriven/django-haystack) - :star: 1992 :fork_and_knife: 886 - Modular search for Django.
...
* [:octocat: elasticsearch-dsl-py](https://github.com/elastic/elasticsearch-dsl-py) - :star: 853 :fork_and_knife: 203 - The official high-level Python client for Elasticsearch.
...
* [:octocat: django-activity-stream](https://github.com/justquick/django-activity-stream) - :star: 1025 :fork_and_knife: 310 - Generate generic activity streams from the actions on your site.
* [:octocat: Feedly](https://github.com/tschellenbach/Feedly) - :star: 2165 :fork_and_knife: 269 - A library to build newsfeed and notification systems using Cassandra and Redis.

## Asset Management

*Tools for managing, compressing and minifying website assets.*

* [:octocat: django-compressor](https://github.com/django-compressor/django-compressor) - :star: 1685 :fork_and_knife: 487 - Compresses linked and inline JavaScript or CSS into a single cached file.
...
* [:octocat: jinja-assets-compressor](https://github.com/jaysonsantos/jinja-assets-compressor) - :star: 51 :fork_and_knife: 8 - A Jinja extension to compile and compress your assets.
...
* [:octocat: django-cache-machine](https://github.com/jbalogh/django-cache-machine) - :star: 623 :fork_and_knife: 125 - Automatic caching and invalidation for Django models.
* [:octocat: django-cacheops](https://github.com/Suor/django-cacheops) - :star: 551 :fork_and_knife: 91 - A slick ORM cache with automatic granular event-driven invalidation.
...
* [:octocat: flanker](https://github.com/mailgun/flanker) - :star: 930 :fork_and_knife: 87 - A email address and Mime parsing library.
* [:octocat: imbox](https://github.com/martinrusev/imbox) - :star: 625 :fork_and_knife: 83 - Python IMAP for Humans.
* [:octocat: inbox.py](https://github.com/kennethreitz/inbox.py) - :star: 1221 :fork_and_knife: 78 - Python SMTP Server for Humans.
* [:octocat: inbox](https://github.com/inboxapp/inbox) - :star: 2986 :fork_and_knife: 268 - The open source email toolkit.
* [:octocat: lamson](https://github.com/zedshaw/lamson) - :star: 549 :fork_and_knife: 152 - Pythonic SMTP Application Server.
...
* [:octocat: marrow.mailer](https://github.com/marrow/marrow.mailer) - :star: 104 :fork_and_knife: 25 - High-performance extensible mail delivery framework.
* [:octocat: modoboa](https://github.com/tonioo/modoboa) - :star: 538 :fork_and_knife: 82 - A mail hosting and management platform including a modern and simplified Web UI.
* [:earth_americas: pyzmail](http://www.magiksys.net/pyzmail/) - Compose, send and parse emails.
* [:octocat: Talon](https://github.com/mailgun/talon) - :star: 560 :fork_and_knife: 78 - Mailgun library to extract message quotations and signatures.
...
* [:octocat: furl](https://github.com/gruns/furl) - :star: 917 :fork_and_knife: 61 - A small Python library that makes manipulating URLs simple.
...
* [:octocat: webargs](https://github.com/sloria/webargs) - :star: 331 :fork_and_knife: 44 - A friendly library for parsing HTTP request arguments, with built-in support for popular web frameworks, including Flask, Django, Bottle, Tornado, and Pyramid.
...
* [:octocat: html5lib](https://github.com/html5lib/html5lib-python) - :star: 486 :fork_and_knife: 105 - A standards-compliant library for parsing and serializing HTML documents and fragments.
* [:earth_americas: lxml](http://lxml.de/) - A very fast, easy-to-use and versatile library for handling HTML and XML.
* [:octocat: MarkupSafe](https://github.com/mitsuhiko/markupsafe) - :star: 124 :fork_and_knife: 48 - Implements a XML/HTML/XHTML Markup safe string for Python.
* [:octocat: pyquery](https://github.com/gawel/pyquery) - :star: 971 :fork_and_knife: 93 - A jQuery-like library for parsing HTML.
...
* [:octocat: xmltodict](https://github.com/martinblech/xmltodict) - :star: 2027 :fork_and_knife: 199 - Working with XML feel like you are working with JSON.
...
* [:octocat: cola](https://github.com/chineking/cola) - :star: 942 :fork_and_knife: 453 - A distributed crawling framework.
...
* [:octocat: MechanicalSoup](https://github.com/hickford/MechanicalSoup) - :star: 1366 :fork_and_knife: 70 - A Python library for automating interaction with websites.
* [:octocat: portia](https://github.com/scrapinghub/portia) - :star: 4256 :fork_and_knife: 625 - Visual scraping for Scrapy.
* [:octocat: pyspider](https://github.com/binux/pyspider) - :star: 6728 :fork_and_knife: 1745 - A powerful spider system.
* [:octocat: RoboBrowser](https://github.com/jmcarp/robobrowser) - :star: 2432 :fork_and_knife: 157 - A simple, Pythonic library for browsing the web without a standalone web browser.
...
* [:octocat: html2text](https://github.com/Alir3z4/html2text) - :star: 250 :fork_and_knife: 53 - Convert HTML to Markdown-formatted text.
...
* [:octocat: newspaper](https://github.com/codelucas/newspaper) - :star: 3330 :fork_and_knife: 449 - News extraction, article extraction and content curation in Python.
...
* [:octocat: python-goose](https://github.com/grangier/python-goose) - :star: 1949 :fork_and_knife: 467 - HTML Content/Article Extractor.
* [:octocat: python-readability](https://github.com/buriy/python-readability) - :star: 950 :fork_and_knife: 190 - Fast Python port of arc90's readability tool.
* [:octocat: sanitize](https://github.com/Alir3z4/sanitize) - :star: 19 :fork_and_knife: 1 - Bringing sanity to world of messed-up data.
* [:octocat: sumy](https://github.com/miso-belica/sumy) - :star: 564 :fork_and_knife: 116 - A module for automatic summarization of text documents and HTML pages.
* [:octocat: textract](https://github.com/deanmalmgren/textract) - :star: 1707 :fork_and_knife: 151 - Extract text from any document, Word, PowerPoint, PDFs, etc.
...
* [:octocat: django-bootstrap3](https://github.com/dyve/django-bootstrap3) - :star: 1409 :fork_and_knife: 449 - Bootstrap 3 integration with Django.
...
* [:octocat: django-remote-forms](https://github.com/WiserTogether/django-remote-forms) - :star: 145 :fork_and_knife: 72 - A platform independent Django form serializer.
...
* [:octocat: schema](https://github.com/halst/schema) - :star: 861 :fork_and_knife: 77 - A library for validating Python data structures.
* [:octocat: Schematics](https://github.com/schematics/schematics) - :star: 1583 :fork_and_knife: 201 - Data Structure Validation.
...
* [:octocat: voluptuous](https://github.com/alecthomas/voluptuous) - :star: 605 :fork_and_knife: 92 - A Python data validation library. It is primarily intended for validating data coming into Python as JSON, YAML, etc.
...
* [:octocat: django-taggit](https://github.com/alex/django-taggit) - :star: 1473 :fork_and_knife: 403 - Simple tagging for Django.

## Admin Panels

*Libraries for administrative interfaces.*

* [:octocat: Ajenti](https://github.com/Eugeny/ajenti) - :star: 164 :fork_and_knife: 33 - The admin panel your servers deserve.
* [:earth_americas: django-suit](http://djangosuit.com/) - Alternative Django Admin-Interface (free only for Non-commercial use).
* [:octocat: django-xadmin](https://github.com/sshwsfc/django-xadmin) - :star: 1644 :fork_and_knife: 517 - Drop-in replacement of Django admin comes with lots of goodies.
* [:octocat: flask-admin](https://github.com/mrjoes/flask-admin) - :star: 51 :fork_and_knife: 24 - Simple and extensible administrative interface framework for Flask.
* [:octocat: flower](https://github.com/mher/flower) - :star: 1752 :fork_and_knife: 337 - Real-time monitor and web admin for Celery.
* [:earth_americas: Grappelli](http://grappelliproject.com) – A jazzy skin for the Django Admin-Interface.
* [:octocat: Wooey](https://github.com/wooey/wooey) - :star: 644 :fork_and_knife: 55 - A Django app which creates automatic web UIs for Python scripts.
...
* [:octocat: envoy](https://github.com/kennethreitz/envoy) - :star: 1696 :fork_and_knife: 109 - Python [subprocess](https://docs.python.org/2/library/subprocess.html) for Humans™.
* [:earth_americas: sarge](http://sarge.readthedocs.org/) - Yet another wrapper for subprocess.
* [:octocat: sh](https://github.com/amoffat/sh) - :star: 3383 :fork_and_knife: 282 - A full-fledged subprocess replacement for Python.
...
* [:octocat: gevent](http://www.gevent.org/) - :star: 640 :fork_and_knife: 118 - A coroutine-based Python networking library that uses [greenlet](https://github.com/python-greenlet/greenlet).
...
* [:octocat: pulsar](https://github.com/quantmind/pulsar) - :star: 1262 :fork_and_knife: 91 - Event-driven concurrent framework for Python.
* [:octocat: diesel](https://github.com/jamwt/diesel) - :star: 534 :fork_and_knife: 52 - Greenlet-based event I/O Framework for Python.
...
* [:octocat: AutobahnPython](https://github.com/tavendo/AutobahnPython) - :star: 1147 :fork_and_knife: 374 - WebSocket & WAMP for Python on Twisted and [asyncio](https://docs.python.org/3/library/asyncio.html).
...
* [:octocat: django-socketio](https://github.com/stephenmcd/django-socketio) - :star: 896 :fork_and_knife: 180 - WebSockets for Django.
* [:octocat: WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) - :star: 683 :fork_and_knife: 167 - WebSocket client and server library for Python 2 and 3 as well as PyPy.
...
* [:octocat: zeroRPC](https://github.com/dotcloud/zerorpc-python) - :star: 1715 :fork_and_knife: 204 - zerorpc is a flexible RPC implementation based on [ZeroMQ](http://zeromq.org/) and [MessagePack](http://msgpack.org/).
...
* [:octocat: hashids](https://github.com/davidaurelio/hashids-python) - :star: 436 :fork_and_knife: 38 - Implementation of [hashids](http://hashids.org) in Python.
...
* [:octocat: enaml](https://github.com/nucleic/enaml) - :star: 457 :fork_and_knife: 61 - Creating beautiful user-interfaces with Declaratic Syntax like QML.
...
* [:octocat: Toga](https://github.com/pybee/toga) - :star: 787 :fork_and_knife: 59 - A Python native, OS native GUI toolkit.
...
* Testing Frameworks
    ...
    * [:octocat: hypothesis](https://github.com/DRMacIver/hypothesis) - :star: 1325 :fork_and_knife: 124 - Hypothesis is an advanced Quickcheck style property based testing library.
    ...
    * [:octocat: PyAutoGUI](https://github.com/asweigart/pyautogui) - :star: 503 :fork_and_knife: 74 - PyAutoGUI is a cross-platform GUI automation Python module for human beings.
    ...
    * [:octocat: Robot Framework](https://github.com/robotframework/robotframework) - :star: 971 :fork_and_knife: 368 - A generic test automation framework.
* Web Testing
    ...
    * [:octocat: locust](https://github.com/locustio/locust) - :star: 3676 :fork_and_knife: 530 - Scalable user load testing tool written in Python.
    * [:octocat: sixpack](https://github.com/seatgeek/sixpack) - :star: 1085 :fork_and_knife: 108 - A language-agnostic A/B Testing framework.
...
* Mock
    ...
    * [:octocat: responses](https://github.com/dropbox/responses) - :star: 1243 :fork_and_knife: 112 - A utility library for mocking out the requests Python library.
    * [:octocat: VCR.py](https://github.com/kevin1024/vcrpy) - :star: 697 :fork_and_knife: 102 - Record and replay HTTP interactions on your tests.
* Object Factories
    * [:octocat: factory_boy](https://github.com/rbarrois/factory_boy) - :star: 922 :fork_and_knife: 124 - A test fixtures replacement for Python.
    * [:octocat: mixer](https://github.com/klen/mixer) - :star: 311 :fork_and_knife: 34 - Another fixtures replacement. Supported Django, Flask, SQLAlchemy, Peewee and etc.
    * [:octocat: model_mommy](https://github.com/vandersonmota/model_mommy) - :star: 577 :fork_and_knife: 132 - Creating random fixtures for testing in Django.
* Code Coverage
...
* Code Analysis
    ...
    * [:octocat: pycallgraph](https://github.com/gak/pycallgraph) - :star: 637 :fork_and_knife: 104 - A library that visualises the flow (call graph) of your Python application.
    * [:octocat: pysonar2](https://github.com/yinwang0/pysonar2) - :star: 2140 :fork_and_knife: 569 - A type inferencer and indexer for Python.
* Linter
...
* Debugger
    ...
    * [:octocat: pyringe](https://github.com/google/pyringe) - :star: 1358 :fork_and_knife: 48 - Debugger capable of attaching to and injecting code into Python processes.
    * [:octocat: wdb](https://github.com/Kozea/wdb) - :star: 893 :fork_and_knife: 49 - An improbable web debugger through WebSockets.
    ...
    * [:octocat: django-debug-toolbar](https://github.com/django-debug-toolbar/django-debug-toolbar) - :star: 3640 :fork_and_knife: 678 - Display various debug information about the current request/response.
    ...
    * [:octocat: flask-debugtoolbar](https://github.com/mgood/flask-debugtoolbar) - :star: 465 :fork_and_knife: 74 - A port of the django-debug-toolbar to flask.
* Profiler
    * [:octocat: line_profiler](https://github.com/rkern/line_profiler) - :star: 836 :fork_and_knife: 58 - Line-by-line profiling.
    * [:octocat: memory_profiler](https://github.com/fabianp/memory_profiler) - :star: 778 :fork_and_knife: 102 - Monitor Memory usage of Python code.
    * [:octocat: profiling](https://github.com/what-studio/profiling) - :star: 2404 :fork_and_knife: 84 - An interactive Python profiler.
* Others
    * [:octocat: pyelftools](https://github.com/eliben/pyelftools) - :star: 325 :fork_and_knife: 117 - A pure-Python library for parsing and analyzing ELF files and DWARF debugging information.
    * [:octocat: python-statsd](https://github.com/WoLpH/python-statsd) - :star: 85 :fork_and_knife: 36 - Python Client for the [statsd](https://github.com/etsy/statsd/) server.
...
* [:octocat: bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) - :star: 312 :fork_and_knife: 165 - A toolkit providing best-practice pipelines for fully automated high throughput sequencing analysis.
* [:octocat: bccb](https://github.com/chapmanb/bcbb) - :star: 306 :fork_and_knife: 153 - Collection of useful code related to biological analysis.
...
* [:octocat: Open Mining](https://github.com/avelino/mining) - :star: 581 :fork_and_knife: 94 - Business Intelligence (BI) in Python (Pandas web interface)
...
* [:octocat: PyMC](https://github.com/pymc-devs/pymc3) - :star: 1519 :fork_and_knife: 338 - Markov Chain Monte Carlo sampling toolkit.
...
* [:octocat: statsmodels](https://github.com/statsmodels/statsmodels) - :star: 1493 :fork_and_knife: 739 - Statistical modeling and econometrics in Python.
* [:octocat: SymPy](https://github.com/sympy/sympy) - :star: 2929 :fork_and_knife: 1479 - A Python library for symbolic mathematics.
* [:octocat: zipline](https://github.com/quantopian/zipline) - :star: 3327 :fork_and_knife: 1034 - A Pythonic algorithmic trading library.
...
* [:octocat: bokeh](https://github.com/ContinuumIO/bokeh) - :star: 4307 :fork_and_knife: 920 - Interactive Web Plotting for Python.
* [:octocat: ggplot](https://github.com/yhat/ggplot) - :star: 2554 :fork_and_knife: 338 - Same API as ggplot2 for R.
...
* [:octocat: vincent](https://github.com/wrobstory/vincent) - :star: 1881 :fork_and_knife: 198 - A Python to Vega translator.
...
* [:octocat: Crab](https://github.com/muricoca/crab) - :star: 695 :fork_and_knife: 261 - A ﬂexible, fast recommender engine.
* [:octocat: gensim](https://github.com/piskvorky/gensim) - :star: 2642 :fork_and_knife: 963 - Topic Modelling for Humans.
...
* [:octocat: NuPIC](https://github.com/numenta/nupic) - :star: 4221 :fork_and_knife: 1192 - Numenta Platform for Intelligent Computing.
* [:octocat: pattern](https://github.com/clips/pattern) - :star: 4540 :fork_and_knife: 795 - Web mining module for Python.
* [:octocat: PyBrain](https://github.com/pybrain/pybrain) - :star: 1841 :fork_and_knife: 576 - Another Python Machine Learning Library.
* [:octocat: Pylearn2](https://github.com/lisa-lab/pylearn2) - :star: 2109 :fork_and_knife: 866 - A Machine Learning library based on [Theano](https://github.com/Theano/Theano).
* [:octocat: python-recsys](https://github.com/ocelma/python-recsys) - :star: 588 :fork_and_knife: 258 - A Python library for implementing a Recommender System.
...
* [:octocat: dpark](https://github.com/douban/dpark) - :star: 1784 :fork_and_knife: 420 - Python clone of Spark, a MapReduce alike framework in Python.
...
* [:octocat: luigi](https://github.com/spotify/luigi) - :star: 4793 :fork_and_knife: 923 - A module that helps you build complex pipelines of batch jobs.
* [:octocat: mrjob](https://github.com/Yelp/mrjob) - :star: 1834 :fork_and_knife: 459 - Run MapReduce jobs on Hadoop or Amazon Web Services.
* [:earth_americas: PySpark](http://spark.apache.org/docs/latest/programming-guide.html) - The Spark Python API.
* [:octocat: streamparse](https://github.com/Parsely/streamparse) - :star: 997 :fork_and_knife: 142 - Run Python code against real-time streams of data. Integrates with [Apache Storm](https://storm.incubator.apache.org/).
...
* [:octocat: fn.py](https://github.com/kachayev/fn.py) - :star: 1953 :fork_and_knife: 124 - Functional programming in Python: implementation of missing features to enjoy FP.
* [:octocat: funcy](https://github.com/Suor/funcy) - :star: 1294 :fork_and_knife: 65 - A fancy and practical functional tools.
* [:octocat: Toolz](https://github.com/pytoolz/toolz) - :star: 1125 :fork_and_knife: 91 - A collection of functional utilities for iterators, functions, and dictionaries.
...
* [:octocat: boto](https://github.com/boto/boto) - :star: 5510 :fork_and_knife: 2016 - Python interface to Amazon Web Services.
* [:octocat: django-wordpress](https://github.com/sunlightlabs/django-wordpress/) - :star: 212 :fork_and_knife: 51 - WordPress models and views for Django.
* [:octocat: facebook-sdk](https://github.com/pythonforfacebook/facebook-sdk) - :star: 1686 :fork_and_knife: 641 - Facebook Platform Python SDK.
* [:octocat: facepy](https://github.com/jgorset/facepy) - :star: 485 :fork_and_knife: 143 - Facepy makes it really easy to interact with Facebook's Graph API
* [:octocat: gmail](https://github.com/charlierguo/gmail) - :star: 1270 :fork_and_knife: 220 - A Pythonic interface for Gmail.
* [:octocat: google-api-python-client](https://github.com/google/google-api-python-client) - :star: 995 :fork_and_knife: 431 - Google APIs Client Library for Python.
* [:octocat: gspread](https://github.com/burnash/gspread) - :star: 1728 :fork_and_knife: 325 - Google Spreadsheets Python API.
* [:octocat: twython](https://github.com/ryanmcgrath/twython) - :star: 1182 :fork_and_knife: 308 - A Python wrapper for the Twitter API.

## DevOps Tools

*Software and libraries for DevOps.*

* [:octocat: Ansible](https://github.com/ansible/ansible) - :star: 17398 :fork_and_knife: 5252 - A radically simple IT automation platform.
* [:octocat: SaltStack](https://github.com/saltstack/salt) - :star: 6633 :fork_and_knife: 2967 - Infrastructure automation and management system.
...
* [:octocat: Fabtools](https://github.com/ronnix/fabtools) - :star: 1011 :fork_and_knife: 203 - Tools for writing awesome Fabric files.
...
* [:octocat: honcho](https://github.com/nickstenning/honcho) - :star: 781 :fork_and_knife: 90 - A Python port of [Foreman](https://github.com/ddollar/foreman), a tool for managing Procfile-based applications.
* [:earth_americas: OpenStack](http://www.openstack.org/) - Open source software for building private and public clouds.
* [:octocat: pexpect](https://github.com/pexpect/pexpect) - :star: 608 :fork_and_knife: 161 - Controlling interactive programs in a pseudo-terminal like GNU expect.
...
* [:octocat: psutil](https://github.com/giampaolo/psutil) - :star: 1652 :fork_and_knife: 272 - A cross-platform process and system utilities module.
* [:octocat: supervisor](https://github.com/Supervisor/supervisor) - :star: 2556 :fork_and_knife: 530 - Supervisor process control system for UNIX.
...
* [:octocat: Plan](https://github.com/fengsp/plan) - :star: 894 :fork_and_knife: 63 - Writing crontab file in Python like a charm.
* [:octocat: schedule](https://github.com/dbader/schedule) - :star: 2235 :fork_and_knife: 224 - Python job scheduling for humans.
...
* [:octocat: Pyston](https://github.com/dropbox/pyston) - :star: 3773 :fork_and_knife: 263 - A Python implementation built using LLVM and modern JIT techniques with the goal of achieving good performance.
...
* [:octocat: PythonNet](https://github.com/pythonnet/pythonnet) - :star: 196 :fork_and_knife: 71 - Python Integration with the .NET Common Language Runtime (CLR).
...
* [:octocat: PyUserInput](https://github.com/SavinaRoja/PyUserInput) - :star: 439 :fork_and_knife: 103 - A module for cross-platform control of the mouse and keyboard.
...
* [:octocat: blinker](https://github.com/jek/blinker) - :star: 349 :fork_and_knife: 43 - A fast Python in-process signal/event dispatching system.
* [:octocat: itsdangerous](https://github.com/mitsuhiko/itsdangerous) - :star: 916 :fork_and_knife: 80 - Various helpers to pass trusted data to untrusted environments.
* [:octocat: pluginbase](https://github.com/mitsuhiko/pluginbase) - :star: 381 :fork_and_knife: 29 - A simple but flexible plugin system for Python.
...
* [:octocat: algorithms](https://github.com/nryoung/algorithms) - :star: 1510 :fork_and_knife: 395 - A module of algorithms for Python.
* [:octocat: python-patterns](https://github.com/faif/python-patterns) - :star: 8642 :fork_and_knife: 2016 - A collection of design patterns in Python.
...
* Emacs
    * [:octocat: Elpy](https://github.com/jorgenschaefer/elpy) - :star: 742 :fork_and_knife: 107 - Emacs Python Development Environment.
* Sublime Text
    ...
    * [:octocat: Anaconda](https://github.com/DamnWidget/anaconda) - :star: 1093 :fork_and_knife: 115 - Anaconda turns your Sublime Text 3 in a full featured Python development IDE.
* Vim
    * [:octocat: YouCompleteMe](https://github.com/Valloric/YouCompleteMe) - :star: 11054 :fork_and_knife: 1280 - Includes [Jedi](https://github.com/davidhalter/jedi)-based completion engine for Python.
    * [:octocat: Jedi-vim](https://github.com/davidhalter/jedi-vim) - :star: 2373 :fork_and_knife: 214 - Vim bindings for the Jedi auto-completion library for Python.
    * [:octocat: Python-mode](https://github.com/klen/python-mode) - :star: 3038 :fork_and_knife: 630 - An all in one plugin for turning Vim into a Python IDE.
* Visual Studio
    * [:octocat: PTVS](https://github.com/Microsoft/PTVS) - :star: 1112 :fork_and_knife: 288 - Python Tools for Visual Studio.
...
* [:octocat: Spyder](https://github.com/spyder-ide/spyder) - :star: 1129 :fork_and_knife: 282 - Open Source Python IDE.
...
* Python
    ...
    * [:octocat: python-github-projects](https://github.com/checkcheckzz/python-github-projects) - :star: 218 :fork_and_knife: 39
    * [:octocat: python_reference](https://github.com/rasbt/python_reference) - :star: 1589 :fork_and_knife: 309
    * [:octocat: pythonidae](https://github.com/svaksha/pythonidae) - :star: 387 :fork_and_knife: 74
* Monty
    * [:octocat: awesome](https://github.com/sindresorhus/awesome) - :star: 37000 :fork_and_knife: 4168
    * [:octocat: lists](https://github.com/jnv/lists) - :star: 3834 :fork_and_knife: 272
